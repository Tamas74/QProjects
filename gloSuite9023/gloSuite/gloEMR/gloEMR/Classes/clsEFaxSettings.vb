Public Class clsEFaxSettings : Implements IDisposable  ''slr implement iDisposable
    ...
    Protected Overridable Sub Dispose(ByVal disposing As Boolean)
        If Not Me.disposedValue Then
            If disposing Then
                ...
                fax_recipient_number = Nothing
                tiff_image_flag = Nothing
                billing_code = Nothing
                from_name = Nothing
                resolution = Nothing
                fax_recipient_name = Nothing
                document_content_type = Nothing
                document_encoding_type = Nothing
                document_extension = Nothing
                BinaryData = Nothing
                BinaryDataforCoverPage = Nothing
            End If
