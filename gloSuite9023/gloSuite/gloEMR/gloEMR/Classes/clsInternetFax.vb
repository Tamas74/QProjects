...
#Region "EFax Settings Variables"
    Private _EFaxSettings As clsEFaxSettings
    ...
    Public Function efaxdocument() As Boolean
        ...
        Try
            If GenerateXML() Then
                ...
                odoc.Load(Application.StartupPath & "\SampleXML.xml")
...
#Region "Methods for File Conversions"
    ...
    Private Sub GenerateDatafromBinaryStream(ByVal ZipContent As Byte(), ByVal sfilename As String)
        Try
            Dim strfilename As String = Application.StartupPath & "\" & sfilename
    ...
    Public Function GenerateXML() As Boolean
        ...
        Dim strfilepath As String = Application.StartupPath & "\SampleXML.xml"
