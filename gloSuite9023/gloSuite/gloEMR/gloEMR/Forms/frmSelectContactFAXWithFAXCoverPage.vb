...
#Region " Windows Form Designer generated code "
    ...
    Protected Overloads Overrides Sub Dispose(ByVal disposing As Boolean)
        If disposing Then
            ...
            Catch
            End Try
            Dim dtpContextMenu As ContextMenu() = {cmnuAddFaxTo, cmnuDeleteFaxTo}
            Try
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.pnlCommand.BackgroundImage = Global.gloEMR.My.Resources.Resources.Img_Blue2007
        ...
        Me.lblContactPerson.Size = New System.Drawing.Size(437, 23)
        ...
        Me.lblFAXNo.Location = New System.Drawing.Point(556, 1)
        Me.lblFAXNo.Name = "lblFAXNo"
        Me.lblFAXNo.Size = New System.Drawing.Size(56, 23)
        ...
        Me.mskFaxNo.Margin = New System.Windows.Forms.Padding(4)
        ...
        Me.btnUpdateFAXNo1.BackgroundImage = Global.gloEMR.My.Resources.Resources.Img_Button
        ...
        Me.optHighPriority.Location = New System.Drawing.Point(237, 1)
        Me.optHighPriority.Name = "optHighPriority"
        Me.optHighPriority.Size = New System.Drawing.Size(156, 23)
        ...
        Me.optNormalPriority.Location = New System.Drawing.Point(106, 1)
        Me.optNormalPriority.Name = "optNormalPriority"
        Me.optNormalPriority.Size = New System.Drawing.Size(131, 23)
        ...
        Me.Label5.Location = New System.Drawing.Point(393, 1)
        ...
        Me.Label21.Location = New System.Drawing.Point(1, 24)
        Me.Label21.Name = "Label21"
        Me.Label21.Size = New System.Drawing.Size(759, 0)
        ...
        Me.pnl_txtSearch.Location = New System.Drawing.Point(71, 1)
        ...
        Me.Label61.Size = New System.Drawing.Size(214, 3)
        ...
        Me.lblSearch.Size = New System.Drawing.Size(70, 22)
        ...
        Me.tlsp_SelectContactFAXWithFAXCoverPage.BackgroundImage = Global.gloEMR.My.Resources.Resources.Img_Toolstrip
...
#End Region
    ...
    Public Shared PatientID As Long
    ...
    Private fntNormalPriority As Font = gloGlobal.clsgloFont.gFont_BOLD 'As New Font("Tahoma", 9, FontStyle.Bold)
    Private fntHighPriority As Font = gloGlobal.clsgloFont.gFont 'New Font("Tahoma", 9, FontStyle.Regular)
    Private _IsFirstReferralLetter As Boolean = False
    Private WithEvents _PatientStrip As gloUC_PatientStrip = Nothing

    Public Property IsFirstReferralLetter() As Boolean
        Get
            Return _IsFirstReferralLetter
        End Get
        Set(ByVal value As Boolean)
            _IsFirstReferralLetter = value
        End Set
    End Property
...
#End Region
    ...
    Private Sub frmSelectContactFAXWithFAXCoverPage_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        UpdateLog("**************** frmSelectContactFAXWithFAXCoverPage_Load Started**********************")
        btnUp1.Visible = True
        ...
        Try
            ...
            'sarika 13th nov 07
            If Not IsNothing(gstrFAXContacts) Then
            ...
            If trvFaxTo.Nodes.Count = 0 Then
                ...
                '22-Apr-13 Aniket: Resolving Memory Leak Issues
                ' rootnode.Dispose() 'SLR: 7/3/2014 Should not be disposed since it will be referenced in tree node..
            ...
            If trvContact.Nodes.Item(0).GetNodeCount(False) > 0 Then
                ...
                '22-Apr-13 Aniket: Resolving Memory Leak Issues
                'mynode.Dispose() 'SLR: 7/3/2014 Should not be disposed since it will be referenced in tree node..
            ...
            '' GLO2011-0012907 :  When selecting save and close on notes getting an error
            '' If Cover Page is turn on then Fill template in Combo Box.
            If gblnFAXCoverPage = True And _IsFirstReferralLetter = False Then
        ...
        Catch ex As Exception
            ...
            ex = Nothing
        End Try
        UpdateLog("**************** frmSelectContactFAXWithFAXCoverPage_Load End**********************")
    End Sub
    ...
    Private Sub FillFaxTemplates()
        ...
        Try
            ...
            '22-Apr-13 Aniket: Resolving Memory Leak Issues
            dtFillTemplates = objWord.FillTemplates(enumTemplateFlag.Fax)
    ...
    Private Sub BindGrid()
        ...
        Try
            ...
            If (IsNothing(ContactDBLayer.DsDataview) = False) Then
                If SelectedNodekey = 1 Or SelectedNodekey = 2 Or SelectedNodekey = 3 Or SelectedNodekey = 4 Or SelectedNodekey = 5 Or SelectedNodekey = 40 Or SelectedNodekey = 41 Or SelectedNodekey = 42 Then    'Check which tree node is selected Using tag stored in Key variable
                    If (ContactDBLayer.DsDataview.Table.Columns.Contains("Name")) Then
                ...
                Else
                    If SelectedNodekey = 0 Or SelectedNodekey = 6 Or SelectedNodekey = 43 Or SelectedNodekey = 44 Or SelectedNodekey = 45 Then
                        If (ContactDBLayer.DsDataview.Table.Columns.Contains("LastName")) Then
                    ...
                    Else
                        If (RowIndex < 0) Then
                            If (ReferralId <> 0) Then
                                ...
                                '                            dtReferral = dt.Clone() 'SLR: 7/3/2014 Not used after cloned,
        ...
        Finally
            Dim ColIndex As Integer = C1Contacts.Cols.IndexOf("nContactID")
            If (ColIndex >= 0) Then
                C1Contacts.Cols(ColIndex).Visible = False
            End If
            C1Contacts.Redraw = True
            C1Contacts.HighLight = C1.Win.C1FlexGrid.HighLightEnum.Always
            C1Contacts.AllowSorting = C1.Win.C1FlexGrid.AllowSortingEnum.None
            '22-Apr-13 Aniket: Resolving Memory Leak Issues
            'SLR: I think dt is referenced as defaultview and databind and Should not be dispoesd?
    ...
    Private Sub FillTreeView()
        ...
        'SLR: 3/7/2014 : Node should not be disposed since it will be referenced in treeview
        ...
        If Not (_blnIsFromBatchreferral) Then
    ...
    Private Sub trvContact_AfterSelect(ByVal sender As System.Object, ByVal e As System.Windows.Forms.TreeViewEventArgs) Handles trvContact.AfterSelect
        Try
            ...
            Dim mynode As myTreeNode
            'Try
            '    If (IsNothing(C1Contacts.ContextMenu) = False) Then
            '        C1Contacts.ContextMenu.Dispose()
            ...
            If Not IsNothing(trvContact.SelectedNode) Then
                ...
                'SLR: 7/3/2014: it is only reference:
    ...
    Private Sub OkCoverPageRevised()
        ...
        Else
            ...
            For i As Integer = 0 To trvFaxTo.Nodes(0).Nodes.Count - 1
                ...
                ''Added on 20141118- To Resolve issue #75511-gloEMR: Fax- Application sends fax without fax number
                If (node.FaxTo = "") Then
                    MessageBox.Show("Please enter the FAX No", gstrMessageBoxCaption, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                    Dim rowIndex As Int64
                    rowIndex = C1Contacts.FindRow(node.Key, 0, 0, False, True, False)
                    C1Contacts.Select(rowIndex, 0, True)
                    mskFaxNo.Focus()
                    Exit Sub
                End If
                GenerateFaxCoverPage(node.FaxTo, node.FaxName, gstrFAXType)
    ...
    Public Sub LoadFAXCoverPage(Optional ByVal blnFirstReferralLetter As Boolean = True)
        ...
        If gblnFAXCoverPage AndAlso blnFirstReferralLetter = False Then
            ''Start'GLO2011-0012282 gloEMR 6.0.2.2 - FAX REFERRAL & COMPLETE GOES TO WRONG CONTACT
            If Not String.IsNullOrEmpty(gstrFAXCoverPage) Then
                If Not IsNothing(oCurDoc) Then
                    Try
                        oCurDoc.Close()
                    Catch exCurDoc As Exception
    ...
    Private Sub ClearFormFields()
        ...
        Catch ex2 As Exception
            gloAuditTrail.gloAuditTrail.ExceptionLog(gloAuditTrail.ActivityModule.Contact, gloAuditTrail.ActivityCategory.None, gloAuditTrail.ActivityType.None, ex2.ToString(), gloAuditTrail.ActivityOutCome.Failure)
            ex2 = Nothing
        End Try
        'End Try
                ...
                If Not objTemplate.Rows(0)(0) Is Nothing Then
                    ...
                    If ((dsoFAXPreview.DocumentName = Nothing) OrElse (dsoFAXPreview.DocumentName = "")) OrElse (dsoFAXPreview.Tag <> cmbTemplate.SelectedValue) Then
                        ...
                        If Not IsNothing(oCurDoc) Then
                            ...
                            End Try
                        End If
                        Dim strError As String = gloWord.LoadAndCloseWord.OpenDSO(dsoFAXPreview, strFAXCoverPage, oCurDoc, oWordApp)
                        If (strError <> String.Empty) Then
                            gloAuditTrail.gloAuditTrail.ExceptionLog(gloAuditTrail.ActivityModule.Contact, gloAuditTrail.ActivityCategory.None, gloAuditTrail.ActivityType.None, strError, gloAuditTrail.ActivityOutCome.Failure)
                    ...
                    'Incident # 00061828 Protection pane comes up every time.
                    'Integrating from 8061. Bug# 96709
                    If oCurDoc.ProtectionType <> Microsoft.Office.Interop.Word.WdProtectionType.wdNoProtection Then
                        ...
                        oWordApp.TaskPanes(Wd.WdTaskPanes.wdTaskPaneDocumentProtection).Visible = True
                    End If
                    objCriteria.Dispose()
                    objCriteria = Nothing
                    objWord = Nothing
    ...
    Private Sub optHighPriority_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles optHighPriority.CheckedChanged
        If optHighPriority.Checked = True Then
            optHighPriority.Font = fntNormalPriority
            optNormalPriority.Font = fntHighPriority
        Else
            optHighPriority.Font = fntHighPriority
                    ...
                    If r.FormFields IsNot Nothing AndAlso r.FormFields.Count >= 1 Then
                                            ...
                                            For Each orfield As Wd.FormField In frow.Range.FormFields
                                                If orfield.StatusText = f.StatusText Then
                                                    If orfield.Name <> f.Name Then
                                                        ...
                                                        '16-Jul-14 Aniket: Moving the following If Block as CheckBox type was not checked
                                                        If (orfield.Type = Wd.WdFieldType.wdFieldFormCheckBox) And (f.Type = Wd.WdFieldType.wdFieldFormCheckBox) Then
                        ...
                        If (IsNothing(f) = False) Then
                            If f.Type = Wd.WdFieldType.wdFieldFormCheckBox Then
                                ...
                                'SLR: 6/27/2014: Check for type again?
                                '16-Jul-14 Aniket: Moving the following If Block as CheckBox type was not checked
                                If f.CheckBox.Value = False Then
    ...
    Public Sub FaxRefContents(ByVal sFaxno As String, ByVal strRefName As String, ByVal m_ContactId As Int64)
        ...
        Try
            ...
            Dim tempDOC As Wd.Document = Nothing
            '22-Apr-13 Aniket: Resolving Memory Leak Issues
                        ...
                        If strFileName <> "" Then
                            ...
                            If strNotesFile <> "" Then
                                If File.Exists(strNotesFile) Then
                                    ...
                                    tempDOC.ActiveWindow.SetFocus()
                                    tempDOC.ActiveWindow.Selection.EndKey(Wd.WdUnits.wdStory)
                                    tempDOC.Application.Selection.InsertBreak(Type:=Wd.WdBreakType.wdPageBreak)
                                    tempDOC.Application.Selection.InsertFile(strNotesFile)
                            ...
                            Dim _sFileName As String = myLoadWord.SaveCurrentWord(tempDOC, gloSettings.FolderSettings.AppTempFolderPath)
                            myLoadWord.CloseWordOnly(tempDOC)
                            ...
                            If strResult = "Success" Then
                                ...
                                ''22-Apr-13 Aniket: Resolving Memory Leak Issues
                                'Dim objMainDoc As Wd.Document = tempDOC
                                'wdTemp.Open(_sFileName)
                                'objMainDoc = wdTemp.ActiveDocument

                                'SLR: commented on 7/27 gstrfaxCollection = FAXContactsCollection
                                ...
                                If objPrintFAX.FAXDocument(myLoadWord, _sFileName, CStr(m_PatientId), gstrFAXContactPerson, gstrFAXContactPersonFAXNo, gstrLoginName, System.DateTime.Now, selectTemplateName, clsPrintFAX.enmFAXType.ReferralLetter, Not blnFinish, blnFAXPrinterHasToSet, blnDSODefaultPrinterHasToSet) = False Then
                                    ''Fax Module Changes.
    ...
    Private Function CreateSelectedNotes(ByVal strFilename As String, ByRef myLoadWord As gloWord.LoadAndCloseWord) As String
        ...
        Try
            Dim oNewDoc As Wd.Document = myLoadWord.LoadWordApplication(strFilename)
            ...
            Try
                ...
                oNewDoc.Bookmarks.DefaultSorting = Wd.WdBookmarkSortBy.wdSortByLocation
                ...
                For i As Int32 = 1 To oNewDoc.Range.Bookmarks.Count
    ...
    Private Sub SelectBetweenBookmarks(ByRef oTempDoc As Wd.Document, ByRef oCurNewDoc As Wd.Document, ByVal strBM1 As Integer, ByVal strBM2 As Integer)
        Try
            ' Global.gloWord.gloWord.GetClipboardData()
            Dim r As Wd.Range = oCurNewDoc.Range(strBM1, strBM2)
            If (IsNothing(r) = False) Then
                ...
                oCurNewDoc.ActiveWindow.SetFocus()
                r = Nothing
            End If
            '  Clipboard.Clear()
            'Global.gloWord.gloWord.SetClipboardData()
    ...
    Function Formatfax(ByVal FaxNo As String) As String
        ...
        'SLR: 7/3/2014 - I don't know the purpose of oDB here and hence commented
