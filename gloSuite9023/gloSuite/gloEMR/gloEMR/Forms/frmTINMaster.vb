...
#End Region
    ...
    Private Sub btnAddProvider_Click(sender As Object, e As EventArgs) Handles btnAddProvider.Click
        Try
            oListControl = New gloListControl.gloListControl(_databaseconnectionstring, gloListControl.gloListControlType.Providers, True, True, Me.Width)
