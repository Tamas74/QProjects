Public Class frmViewGoal
    ...
    Private Sub frmViewGoal_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub frmViewGoal_FormClosed(sender As System.Object, e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        Try
    ...
    Private Sub DesignGrid()
        Try
            ...
            C1_CarePlan.Cols("nGoalId").Visible = False
            C1_CarePlan.Cols("sGoalName").Caption = "Name"
            C1_CarePlan.Cols("sGoalLoin").Caption = "LOINC"
            C1_CarePlan.Cols("sGoalValue").Caption = "Value"
            C1_CarePlan.Cols("sGoalUnit").Caption = "Unit"
            C1_CarePlan.Cols("sGoalAuthor").Caption = "Goal From"
            C1_CarePlan.Cols("dtGoalRecordedDate").Caption = "Created Date"   ''added for 8022 prd changes
            C1_CarePlan.Cols("dtGoalRecordedDate").Format = "MM/dd/yyyy h:mm tt"
            C1_CarePlan.Cols("sGoalNotes").Caption = "Notes"

            Dim wdth As Integer = Screen.PrimaryScreen.WorkingArea.Width - 40
            C1_CarePlan.Cols("sGoalName").Width = wdth * 0.16
            C1_CarePlan.Cols("sGoalAuthor").Width = wdth * 0.1
            C1_CarePlan.Cols("sGoalLoin").Width = wdth * 0.2
            C1_CarePlan.Cols("sGoalValue").Width = wdth * 0.1
            C1_CarePlan.Cols("sGoalUnit").Width = wdth * 0.1
            C1_CarePlan.Cols("sGoalNotes").Width = wdth * 0.24
            C1_CarePlan.Cols("dtGoalRecordedDate").Width = wdth * 0.1
            ...
            C1_CarePlan.Cols("sGoalName").AllowEditing = False
            C1_CarePlan.Cols("sGoalAuthor").AllowEditing = False
            C1_CarePlan.Cols("sGoalLoin").AllowEditing = False
            C1_CarePlan.Cols("sGoalValue").AllowEditing = False
            C1_CarePlan.Cols("sGoalUnit").AllowEditing = False
            C1_CarePlan.Cols("sGoalNotes").AllowEditing = False
            C1_CarePlan.Cols("dtGoalRecordedDate").AllowEditing = False
        Catch ex As Exception
            MessageBox.Show(ex.ToString, gstrMessageBoxCaption, MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Private Sub ts_btnAdd_Click(sender As System.Object, e As System.EventArgs) Handles ts_btnAdd.Click
        Try
            Dim frm As New frmPatientGoal(_nPatientId, GenerateVisitID(Now.Date, _nPatientId))
