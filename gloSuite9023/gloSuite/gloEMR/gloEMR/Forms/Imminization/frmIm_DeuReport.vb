...
#End Region
    ...
    Private Sub frmIm_DueReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            '_strSQL = " select im_item_id,im_item_name from IM_MST "
            ' '' FIll Immunization master
            'odb.Connect(GetConnectionString)
            'odt = odb.ReadQueryDataTable(_strSQL)

            'With chkMedicationList
            '    .DataSource = odt
            '    .DisplayMember = odt.Columns("im_item_name").ColumnName.ToString 'Medication description
            '    .ValueMember = odt.Columns("im_item_id").ColumnName
            ...
            ' call initialise grid and its properties
            'Call fillgrid()
    ...
    Private Sub PrintSSRSReport(ReportName As String, ParameterName As String, ParameterValue As String)
        ...
        Try
            ...
            clsPrntRpt.PrintReport(ReportName, ParameterName, ParameterValue, gblnDefaultPrinter, "")
    ...
    Private Sub tblbtn_Print_32_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tblbtn_Print_32.Click
        ...
        If _RptName = "RptImmunizationDue" Then
            If ReportViewer1.CurrentStatus.CanPrint = True Then
