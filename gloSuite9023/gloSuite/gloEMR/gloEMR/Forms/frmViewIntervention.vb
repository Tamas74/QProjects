Public Class frmViewIntervention
    ...
    Private Sub frmViewIntervention_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub frmViewIntervention_FormClosed(sender As System.Object, e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        Try
    ...
    Private Sub DesignGrid()
        Try
            ...
            C1_CarePlan.Cols("nInterventionId").Visible = False
            C1_CarePlan.Cols("sInterventionName").Caption = "Name"
            C1_CarePlan.Cols("sInterventionType").Caption = "Intervention Type"
            C1_CarePlan.Cols("sInterventionNotes").Caption = "Notes"
            C1_CarePlan.Cols("dtInterventionRecordedDate").Caption = "Created Date"   ''added for 8022 prd changes
            C1_CarePlan.Cols("dtInterventionRecordedDate").Format = "MM/dd/yyyy h:mm tt"
            C1_CarePlan.Cols("sUsername").Caption = "User"

            Dim wdth As Integer = Screen.PrimaryScreen.WorkingArea.Width - 40
            C1_CarePlan.Cols("sInterventionName").Width = wdth * 0.2
            C1_CarePlan.Cols("sInterventionType").Width = wdth * 0.15
            C1_CarePlan.Cols("sInterventionNotes").Width = wdth * 0.35
            C1_CarePlan.Cols("dtInterventionRecordedDate").Width = wdth * 0.15
            ...
            C1_CarePlan.Cols("sInterventionName").AllowEditing = False
            C1_CarePlan.Cols("sInterventionType").AllowEditing = False
            C1_CarePlan.Cols("sInterventionNotes").AllowEditing = False
            C1_CarePlan.Cols("dtInterventionRecordedDate").AllowEditing = False
    ...
    Private Sub ts_btnAdd_Click(sender As System.Object, e As System.EventArgs) Handles ts_btnAdd.Click
        Try
            Dim frm As New frmPatientIntervention(_nPatientId, GenerateVisitID(Now.Date, _nPatientId))
