...
Public Class FilterRow
    ...
    Public Sub New(ByVal flex As C1FlexGrid)
        ...
        Try
            If (_flex.Styles.Contains("Filter")) Then
                _style = _flex.Styles("Filter")
            Else
    ...
    Public Sub Clear()
        ...
        Dim col As Integer
        If Not IsNothing(_flex.Cols) Then
    ...
    Public Sub Dispose()
        If (IsNothing(_flex) = False) Then
            Try
                ...
                RemoveHandler _flex.KeyDown, AddressOf _flex_KeyDown
                RemoveHandler _flex.BeforeMouseDown, AddressOf _flex_BeforeMouseDown
                RemoveHandler _flex.RowColChange, AddressOf _flex_RowColChange
                RemoveHandler _flex.AfterEdit, AddressOf _flex_AfterEdit
                If (_flex.Styles.Contains("Filter")) Then
                    _flex.Styles.Remove("Filter")
                End If
