...
Public Class rptPatientConsent
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gloEMR.rptPatientConsent.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPatientConsent
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPatientConsent = New rptPatientConsent
        rpt.Site = Me.Site
        Return rpt
    End Function
