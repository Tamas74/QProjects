...
Public Class RptPatientInsurance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gloEMR.RptPatientInsurance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptPatientInsurance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPatientInsurance = New RptPatientInsurance
        rpt.Site = Me.Site
        Return rpt
    End Function
