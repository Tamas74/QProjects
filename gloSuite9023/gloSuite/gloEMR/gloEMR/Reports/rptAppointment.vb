...
Public Class rptAppointment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gloEMR.rptAppointment.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ProviderID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptAppointment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAppointment = New rptAppointment
        rpt.Site = Me.Site
        Return rpt
    End Function
