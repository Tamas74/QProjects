...
Public Class rptPatientDemographics
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gloEMR.rptPatientDemographics.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_nPatientid() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptPatientDemographics
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPatientDemographics = New rptPatientDemographics
        rpt.Site = Me.Site
        Return rpt
    End Function
