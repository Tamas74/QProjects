...
Namespace eRxServiceProd
    ...
    Partial Public Class eRxMessage
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("https://gloophit.net/eRx/DirectoryDownloadLocal", RequestNamespace:="https://gloophit.net/eRx/", ResponseNamespace:="https://gloophit.net/eRx/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
