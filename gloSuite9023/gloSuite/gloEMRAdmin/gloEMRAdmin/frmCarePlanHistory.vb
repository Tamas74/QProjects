Public Class frmCarePlanHistory
    ...
    Private Sub LoadHistory()
        Try
            dsHistory = Nothing
            Dim oclsAudit As clsAuditHistory = New clsAuditHistory()
            dsHistory = oclsAudit.GetCarePlanHistory_V2(_nId, _sModule)
            oclsAudit = Nothing
    ...
    Private Sub DesignHealthConcernGrid()
        Try
            ...
            C1_CarePlanHistory.Cols("sHealthConcernName").Width = wdth * 0.16
            ...
            C1_CarePlanHistory.Cols("dtHealthConcernStartDate").Width = wdth * 0.06
            C1_CarePlanHistory.Cols("dtHealthConcernEndDate").Width = wdth * 0.06
            C1_CarePlanHistory.Cols("sHealthConcernNotes").Width = wdth * 0.17
    ...
    Private Sub DesigGoalGrid()
        Try
            ...
            Dim wdth As Integer = Screen.PrimaryScreen.WorkingArea.Width - 40
            C1_CarePlanHistory.Cols("sGoalName").Width = wdth * 0.15
            C1_CarePlanHistory.Cols("sGoalLoin").Width = wdth * 0.15
            ...
            C1_CarePlanHistory.Cols("sGoalNotes").Width = wdth * 0.15
            C1_CarePlanHistory.Cols("dtGoalDate").Width = wdth * 0.07
            C1_CarePlanHistory.Cols("dtGoalTargetDate").Width = wdth * 0.07
    ...
    Private Sub DesignOutcomeGrid()
        Try
            ...
            C1_CarePlanHistory.Cols("sOutcomeNotes").Width = wdth * 0.2
            C1_CarePlanHistory.Cols("svalue").Width = wdth * 0.05
            C1_CarePlanHistory.Cols("sunit").Width = wdth * 0.05
            C1_CarePlanHistory.Cols("dtRecordedDate").Width = wdth * 0.15
            C1_CarePlanHistory.Cols("sUsername").Width = wdth * 0.1
            C1_CarePlanHistory.Cols("dtOutcomeDate").Width = wdth * 0.1
            C1_CarePlanHistory.Cols("RowState").Width = wdth * 0.1
