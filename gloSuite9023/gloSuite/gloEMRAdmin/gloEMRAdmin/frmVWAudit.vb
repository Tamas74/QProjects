...
#Region "Attributes and Properties"
    ...
    'User Rights Audit Columns
    Dim Col_ModifiedByUser As Integer = 1
    Dim Col_User As Integer = 2
    Dim Col_WindowsLoginName As Integer = 3
    Dim Col_PasswordUpdated As Integer = 4
    Dim Col_ActivityTytpe As Integer = 5
    Dim Col_ISAdministrator As Integer = 6
    Dim Col_IsAuditTrail As Integer = 7
    Dim Col_IsAccessDenide As Integer = 8
    Dim Col_IsSecurityuser As Integer = 9
    Dim Col_IspatientChartAccess As Integer = 10
    Dim Col_ValidUpto As Integer = 11
    Dim Col_EmergencyPassUpdated As Integer = 12
    Dim Col_RightsAdded As Integer = 13
    Dim COl_RightsRemoved As Integer = 14
    Dim Col_AuditRightsAdded As Integer = 15
    Dim Col_AuditRightsremoved As Integer = 16
    'Dim Col_CQMCategory As Integer = 17
    'Dim Col_UDI As Integer = 18
    'Dim Col_ConcernStatus As Integer = 19
    'Dim Col_ResolvedEndDate As Integer = 20
    'Dim Col_AllergySeverity As Integer = 21
    'Dim Col_AllergyIntelorenceCode As Integer = 22
...
#Region "Form Initialization"
        ...
        Try
            ...
            Select Case _sActivityCategory
                ...
                Case "Exam"
                    ...
                    Me.bIsExam = True
                Case "Admin"
                    FillUserRightsHist(_nTransactionID, _sActivityType)
                Case "CCD"
                    If _sCategory = "Reconciliation" Then
                        If _sDescription.Contains("Medication") Then
                            FillMedication(_nTransactionID, _sActivityType)
                        ElseIf _sDescription.Contains("Problem") Then
                            FillProblemList(_nTransactionID, _sActivityType)
                        ElseIf _sDescription.Contains("Allergy") Then
                            FillHistory(_nTransactionID, _sActivityType)
                        End If
                    End If
                Case "PatientEducation"
                    FillPatientEducationAudit(_nTransactionID, _sActivityType)
                Case "SocialPsychologicalBehavioralobservations"
                    FillSPB(_nTransactionID)
    ...
    Public Sub New(ByVal nTransactionID As Int64, ByVal sActivityType As String, ByVal sActivityCategory As String, Optional ByVal scategory As String = "", Optional ByVal sDescription As String = "")
    ...
    Public Sub New(ByVal nTransactionID As Int64, ByVal sActivityType As String, ByVal sActivityCategory As String, ByVal AuditTrailId As Int64, Optional ByVal scategory As String = "", Optional ByVal sDescription As String = "")
        _nTransactionID = nTransactionID
        _sActivityType = sActivityType
        _sActivityCategory = sActivityCategory
        _sCategory = scategory
        _sDescription = sDescription
        _nAuditTrailID = AuditTrailId
        InitializeComponent()
    End Sub
#End Region
    ...
    Private Sub c1Audit_DoubleClick(sender As Object, e As System.EventArgs) Handles c1Audit.DoubleClick
        ...
        Try
            ...
            If nPatientExamsAuditID > 0 And nPatientExamsAuditID > 0 Then
                objDatabaseLayer = New gloDatabaseLayer.DBLayer(gloEMRAdmin.mdlGeneral.GetConnectionString())
...
#Region "Grid Filling Procedures"
        ...
        Try
            ...
            If Not IsNothing(dt) Then
                If dt.Rows.Count > 0 Then
                    ...
                    c1Audit.Cols("ICD9").Caption = "Diagnosis(ICD9/ICD10)"
    ...
    Public Sub fillPatientAudit(ByVal nPatientID As Int64, ByVal nAuditTrailId As Int64)
        ...
        If Not IsNothing(dtPatientAudit) Then
            If dtPatientAudit.Rows.Count > 0 Then
                ...
                c1PatientAudit.Cols("sLoginName").Caption = "LoginName"
            ...
            If Not IsNothing(dt) Then
                If dt.Rows.Count > 0 Then
                    ...
                    With c1Audit
                        ...
                        .SetData(0, 10, "CQM Category")
                        .SetData(0, 11, "UDI")
                        .SetData(0, 12, "Concern Status")
                        .SetData(0, 13, "Resolved/End Date")
                        .SetData(0, 14, "Allergy Severity")
                        .SetData(0, 15, "Allergy Intelorence Code")
                    ...
                    For Each drHistory As DataRow In dt.Rows
                        ...
                        FillGrid(strActivityDate, strUserAction, strCategory, strhistory, strComment, strActivity, strUserName, strFullName, strRection_Status, strActive, strReaction, strCQMCategory, strUDI, strConcernStatus, strResolvedEndDate, strAllergySeverity, strAllergyIntelorenceCode)
                    Next
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub FillGrid(ByVal strActivityDate As String, ByVal strUserAction As String, ByVal strCategory As String, ByVal strhistory As String, ByVal strComment As String, ByVal strActivity As String, ByVal strUserName As String, ByVal strFullName As String, ByVal strRection_Status As String, ByVal strActive As String, ByVal strReaction As String, ByVal strCQMCategory As String, ByVal strUDI As String, ByVal strConcernStatus As String, ByVal strResolvedEndDate As String, ByVal strAllergySeverity As String, ByVal strAllergyIntelorenceCode As String)
        Try
            ...
            With c1Audit
                ...
                .SetData(i, 10, strCQMCategory)
                .SetData(i, 11, strUDI)
                .SetData(i, 12, strConcernStatus)
                .SetData(i, 13, strResolvedEndDate)
                .SetData(i, 14, strAllergySeverity)
                .SetData(i, 15, strAllergyIntelorenceCode)
                ...
                ElseIf InStr(strCategory.ToString.ToUpper, "SMOKING", CompareMethod.Text) = 1 Then ''added for bugid 110313 
                    ...
                    dtSmoking.Dispose()
                    dtSmoking = Nothing
                ElseIf strCategory.Contains("Family") Or strCategory = "Fam" Then     ''added for bugid 110313 
    ...
    Public Sub FillPrescription(ByVal nTransactionID As Int64, ByVal sActivityType As String)
        ...
        Try
            ...
            With c1Audit
                ...
                .SetData(0, 16, "Prescriber Notes")
                .SetData(0, 17, "Reason to Override Drug Interaction")
                .SetData(0, 18, "Start Date")
                .SetData(0, 19, "Administered")
                .SetData(0, 20, "Order Not CPOE")
                .SetData(0, 21, "Chief Complaints")
                .SetData(0, 22, "End Date")
                ...
                .Cols(16).Width = _width * 0.15
                .Cols(17).Width = _width * 0.23
                .Cols(18).Width = _width * 0.1

                .Cols(19).Width = _width * 0.1
                .Cols(20).Width = _width * 0.12
                .Cols(21).Width = _width * 0.2
                .Cols(22).Width = _width * 0.1
                ...
                .Cols(21).TextAlign = TextAlignEnum.LeftCenter
                .Cols(22).TextAlign = TextAlignEnum.LeftCenter
                ...
                If IsNothing(dt) = False Then
                    For i As Int16 = 0 To dt.Rows.Count - 1
                        ...
                        str = ""
                        str = dt.Rows(i)("sPrescriberNotes")
                        .SetData(r.Index, 16, str.Replace(Environment.NewLine, " "))
                        str = ""
                        str = dt.Rows(i)("sReasonToOverrideDI")
                        .SetData(r.Index, 17, str.Replace(Environment.NewLine, " "))
                        .SetData(r.Index, 18, dt.Rows(i)("dtStartDate"))

                        .SetData(r.Index, 19, dt.Rows(i)("IsMedicationAdministered"))
                        .SetData(r.Index, 20, dt.Rows(i)("IsCPOEOrder"))
                        .SetData(r.Index, 21, dt.Rows(i)("sChiefComplaints"))
                        .SetData(r.Index, 22, dt.Rows(i)("dtEndDate"))
                        r = Nothing
                    Next
                End If
            End With
    ...
    End Sub
    Public Sub FillSPB(ByVal nTransactionID As Int64)
        oclsAudit = New clsAuditHistory()
        dt = New DataTable
        Try
            dt = oclsAudit.GetSPBHistory(nTransactionID)
            With c1Audit
                ...
                .Cols.Count = 8
                .Rows.Count = 1
                .SetData(0, 0, "Que. Loinc Code")
                .SetData(0, 1, "Domain Name")
                .SetData(0, 2, "Question")
                .SetData(0, 3, "After Rec. Ans.")
                .SetData(0, 4, "After Ans. Code")
                .SetData(0, 5, "Patient Directions")
                .SetData(0, 6, "Before Rec. Ans")
                .SetData(0, 7, "Before Ans. Code") '
                ...
                .Cols(0).Width = _width * 0.0
                .Cols(1).Width = _width * 0.2
                .Cols(2).Width = _width * 0.35
                .Cols(3).Width = _width * 0.15
                .Cols(4).Width = _width * 0
                .Cols(5).Width = _width * 0
                .Cols(6).Width = _width * 0.1
                .Cols(7).Width = _width * 0
                ...
                If IsNothing(dt) = False Then
                    For i As Int16 = 0 To dt.Rows.Count - 1
                        ...
                        r = .Rows.Add()
                        r.Height = 20
                        .SetData(r.Index, 0, dt.Rows(i)("sQuestionLoincCode"))
                        .SetData(r.Index, 1, dt.Rows(i)("sDomainName"))
                        .SetData(r.Index, 2, dt.Rows(i)("sQuestion"))
                        .SetData(r.Index, 3, dt.Rows(i)("DisplayText"))
                        .SetData(r.Index, 4, dt.Rows(i)("RecordAns"))
                        .SetData(r.Index, 5, dt.Rows(i)("sInputType"))
                        .SetData(r.Index, 6, dt.Rows(i)("OldDisplayText"))
                        .SetData(r.Index, 7, dt.Rows(i)("OldRecordedAns"))
                        r = Nothing
                    Next
                End If
            End With
        ...
        End Try
    End Sub
    Public Sub FillUserRightsHist(ByVal ntransactionID As Int64, ByVal actiontype As String)
        oclsAudit = New clsAuditHistory()
        dt = New DataTable
        Try
            dt = oclsAudit.ShowUserRightsAudit(ntransactionID, actiontype)
            If Not IsNothing(dt) Then
                '  If dt.Rows.Count > 0 Then
                ...
                With c1Audit
                    ...
                    If c1Audit.Rows.Count > 1 Then
                        ...
                        cStyle.Trimming = System.Drawing.StringTrimming.EllipsisCharacter
                    End If
                End With
                c1Audit.DataSource = dt.DefaultView
                c1Audit.DrawMode = C1.Win.C1FlexGrid.DrawModeEnum.OwnerDraw
                c1Audit.AllowSorting = False
                c1Audit.Cols(Col_PasswordUpdated).DataType = GetType(System.Boolean)
                c1Audit.Cols(Col_EmergencyPassUpdated).DataType = GetType(System.Boolean)
                c1Audit.Cols(Col_ActivityDate).DataType = GetType(String)
                c1Audit.Cols(Col_ActivityDate).Format = "MM/dd/yyyy hh:mm tt"
                c1Audit.Cols(Col_ActivityDate).Width = 135
                c1Audit.Cols(Col_ModifiedByUser).Width = 115
                c1Audit.Cols(Col_IspatientChartAccess).Width = 120
                c1Audit.Cols(Col_RightsAdded).Width = 150
                c1Audit.Cols(Col_ActivityTytpe).Width = 90
                c1Audit.Cols(Col_ISAdministrator).Width = 80
                c1Audit.Cols(Col_EmergencyPassUpdated).Width = 200
                c1Audit.Cols(Col_PasswordUpdated).Width = 150
                c1Audit.Cols(Col_AuditRightsAdded).Width = 200
                c1Audit.Cols(Col_WindowsLoginName).Width = 150
                c1Audit.Cols(COl_RightsRemoved).Width = 150
                c1Audit.Cols(Col_AuditRightsremoved).Width = 150
...
#End Region
    ...
    Private Sub c1Audit_MouseMove(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles c1Audit.MouseMove
        Try
