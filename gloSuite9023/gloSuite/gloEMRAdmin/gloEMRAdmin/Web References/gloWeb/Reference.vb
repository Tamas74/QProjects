...
Namespace gloWeb
    ...
    Partial Public Class Webs
        ...
        Private GetObjectIdFromUrlOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.gloEMRAdmin.My.MySettings.Default.gloEMRAdmin_gloWeb_Webs
        ...
        '''<remarks/>
        Public Event GetObjectIdFromUrlCompleted As GetObjectIdFromUrlCompletedEventHandler
        ...
        Public Function GetObjectIdFromUrl(ByVal objectUrl As String) As System.Xml.XmlNode
            Dim results() As Object = Me.Invoke("GetObjectIdFromUrl", New Object() {objectUrl})
            Return CType(results(0),System.Xml.XmlNode)
        End Function
        
        '''<remarks/>
        Public Overloads Sub GetObjectIdFromUrlAsync(ByVal objectUrl As String)
            Me.GetObjectIdFromUrlAsync(objectUrl, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub GetObjectIdFromUrlAsync(ByVal objectUrl As String, ByVal userState As Object)
            If (Me.GetObjectIdFromUrlOperationCompleted Is Nothing) Then
                Me.GetObjectIdFromUrlOperationCompleted = AddressOf Me.OnGetObjectIdFromUrlOperationCompleted
            End If
            Me.InvokeAsync("GetObjectIdFromUrl", New Object() {objectUrl}, Me.GetObjectIdFromUrlOperationCompleted, userState)
        End Sub
        
        Private Sub OnGetObjectIdFromUrlOperationCompleted(ByVal arg As Object)
            If (Not (Me.GetObjectIdFromUrlCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent GetObjectIdFromUrlCompleted(Me, New GetObjectIdFromUrlCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1")>  _
    Public Delegate Sub GetObjectIdFromUrlCompletedEventHandler(ByVal sender As Object, ByVal e As GetObjectIdFromUrlCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.1"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class GetObjectIdFromUrlCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
