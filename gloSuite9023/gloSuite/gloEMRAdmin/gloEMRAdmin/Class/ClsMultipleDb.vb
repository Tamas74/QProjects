...
#Region "To fill the Database"
    ...
    Public Function saveDataBaseCredentials(ByVal oDatabase As ClsMultipleDb) As Int64
        ...
        Dim oDbLayer As New gloDatabaseLayer.DBLayer(gloEMRAdmin.mdlGeneral.GetConnectionString(gstrServicesServerName, gstrServicesDBName, gbServicesIsSQLAUTHEN, gstrServicesUserID, gstrServicesPassWord))
        ...
        If gstrSQLServerName = Nothing Or gstrServicesServerName = Nothing Then
