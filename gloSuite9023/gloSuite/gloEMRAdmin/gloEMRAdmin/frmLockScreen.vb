...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.pnlLogin.Location = New System.Drawing.Point(234, 196)
        ...
        Me.btnOK.FlatAppearance.BorderColor = System.Drawing.Color.FromArgb(CType(CType(110, Byte), Integer), CType(CType(134, Byte), Integer), CType(CType(162, Byte), Integer))
        ...
        Me.panel1.Size = New System.Drawing.Size(89, 89)
        ...
        Me.ClientSize = New System.Drawing.Size(921, 734)
...
#End Region
    ...
    Private Sub frmLockScreen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Me.SuspendLayout()
            Dim obj As gloUIControlLibrary.WPFUserControl.gloEMRAdminLockScreen = New gloUIControlLibrary.WPFUserControl.gloEMRAdminLockScreen()
    ...
    Private Function CheckLogin() As Boolean
        ...
        If gblnAdmin = False Then
            ...
            If objLogin.IsAccessPermission(txtUserName.Text, True) = False Then
                MessageBox.Show("Access Denied." & vbCrLf & txtUserName.Text & " user has no rights to access gloEMR Admin application.", gstrMessageBoxCaption, MessageBoxButtons.OK, MessageBoxIcon.Error)
                txtUserName.Focus()
                objLogin = Nothing
                AccessFlag = True
                Return False
    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        ...
        Try
                        ...
                        If NoofAttempts >= gintNoOfAttempts Then
                            ...
                            If blnIsAdministrator = False Then
                                ...
                                If SetAccessDeniedFlag() = True Then
                                    objAudit.CreateLog(clsAudit.enmActivityType.SecurityAdmin, "User's access to gloEMR admin has been denied since, he could not enter correct credentials and exceeded the number of LockOut attempts on LockScreen. ", gstrLoginName, gstrClientMachineName, , , clsAudit.enmOutcome.Failure)
            ...
            Else
                ...
                MessageBox.Show("Your access is denied . Please contact the administrator", "gloEMR Admin", MessageBoxButtons.OK, MessageBoxIcon.Information)
                objAudit.CreateLog(clsAudit.enmActivityType.SecurityAdmin, "User with no access to gloEMR admin attempted to login.", gstrLoginName, gstrClientMachineName, , , clsAudit.enmOutcome.Failure)
                '  Exit Sub
                End
            End If
            objAudit = Nothing
    ...
    Public Function SetAccessDeniedFlag() As Boolean
        ...
        Try
            ...
            Else
                MessageBox.Show("You must enter the  Username.", "gloEMR Admin", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
