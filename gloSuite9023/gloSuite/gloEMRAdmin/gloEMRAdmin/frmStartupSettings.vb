...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cmbDatabase.Location = New System.Drawing.Point(164, 161)
    ...
    Private Sub cmbSQLServer_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbSQLServer.Leave
        Try
            If Trim(cmbSQLServer.Text) = "" Then
                ...
                Exit Sub
            End If
            ''Code commented by Sandip Darade 20100127 we dont fill the database now
        ...
        Try
            ...
            If (gstrAdminFor = "gloEMR") Then
                ...
                If gstrSQLPasswordEMR <> "" Then
                    ...
                    'Replaced constEncryptDecryptKey_Services by constEncryptDecryptKey :Mayuri:20091029
                    'To make Encryption and Decryption Key unique in both EMR-Admin and EMR 
                    'regKey.SetValue("SQLPasswordEMR", oEncryption.EncryptToBase64String(gstrSQLPasswordEMR, constEncryptDecryptKey_Services))
                ...
                Dim objArchiveSettings As New clsSettings
                Dim dtSaveSettings As New DataTable
                ...
                dtSaveSettings.Rows.Add("ArchiveDatabaseName", gstrArchiveDatabaseName, "Archive Database Name", gnClinicID, 0)

                objArchiveSettings.SaveEmrSettings(dtSaveSettings, Nothing)

                If IsNothing(dtSaveSettings) = False Then
                    dtSaveSettings.Dispose()
                    dtSaveSettings = Nothing
                End If

                objArchiveSettings = Nothing
    ...
    Private Sub frmStartupSettings_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        Try
            If blnButtonClick = False And blnOpenFromMainForm = False Then
                ...
                If MessageBox.Show("You can not log in to gloEMR System without configuring startup settings." & vbCrLf & "Are you sure you want to exit?", gstrMessageBoxCaption, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.No Then
                    e.Cancel = True
                Else
                    End
                End If
