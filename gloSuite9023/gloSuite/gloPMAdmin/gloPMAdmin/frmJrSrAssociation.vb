...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.trvJrDOC.Font = New System.Drawing.Font("Tahoma", 9.0!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(0, Byte))
        ...
        Me.Label1.Text = "Junior Senior Doctor Association"
...
#End Region
        ...
        Try
            ...
            With trvJrDOC
                ...
                If IsNothing(dt) = False Then
                    ...
                    Else
                        MessageBox.Show("No Senior Doctor information available", gstrMessageBoxCaption, MessageBoxButtons.OK, MessageBoxIcon.Information)
                        Me.Close()
                        Exit Sub
                    End If
                    '******* 26 th Oct 2007 
            ...
            With trvAssociation
                ...
                If IsNothing(dt) = False Then
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        '******and closes the dialog
                    Else
                        MessageBox.Show("No Junior Doctor information available", gstrMessageBoxCaption, MessageBoxButtons.OK, MessageBoxIcon.Information)
                        Me.Close()
                        Exit Sub
                    End If
                    '******* 26 th Oct 2007 
    ...
    Public Function GetSrDoctors() As DataTable
        ...
        Try
            ...
            _sqlstr = "select sFirstName + ' ' + sMiddleName + ' ' + sLastName as Name,nProviderID from Provider_MST where nProviderType=0"
    ...
    Public Function GetJrSrDocAssociation(ByVal id As Long) As DataTable
        ...
        Try
            ...
            _sqlstr = " SELECT  Provider_MST.sFirstName + ' ' + Provider_MST.sMiddleName + ' ' + Provider_MST.sLastName AS Name, Provider_MST.nProviderID " _
    ...
    Public Function GetJrDoctors() As DataTable
        ...
        Try
            ...
            _sqlstr = "select sFirstName + ' ' + sMiddleName + ' ' + sLastName as Name,nProviderID from Provider_MST where nProviderType=1"
            da = New SqlDataAdapter(_sqlstr, conn)
            da.Fill(dt)
