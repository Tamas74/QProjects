...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.dgUsers = New gloPMAdmin.clsDataGrid
        ...
        Me.btnSelectAll.Location = New System.Drawing.Point(209, 37)
    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOK.Click
        Try
            ...
            If clUserRights.Count = 0 Then
                MessageBox.Show("Select minimum one rights", gstrMessageBoxCaption, MessageBoxButtons.OK, MessageBoxIcon.Information)
                trvRights.Focus()
                Me.Cursor = Cursors.Default
                Exit Sub
            End If
