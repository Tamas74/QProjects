...
Public Class frmClinicNew
    ...
    Public Sub New()
        ...
        oAddressContolPL = New gloAddress.gloAddressControl(gloPMAdmin.mdlGeneral.GetConnectionString())
    ...
    Private Sub frmClinic_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            oAddressContol.txtZip.Size = New Size(43, 22)
            oAddressContol.txtAreaCode.Visible = True
            oAddressContol.txtArea.Visible = True
...
#Region "Commented Code in BtnOK_Click"
...
#End Region
    ...
    Private Sub btnOK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles tlsbtnSave.Click
        Try
            ...
            If (oAddressContol.txtAreaCode.TextLength > 0 And oAddressContol.txtAreaCode.TextLength < 4) Then
                If (MessageBox.Show("Area code information is incomplete. Do you want to continue with this information?", gstrMessageBoxCaption, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.No) Then
                    oAddressContol.txtAreaCode.Select()
                    oAddressContol.txtAreaCode.Focus()
                    Exit Sub
                End If
            End If
            ...
            With objClinic
                ...
                .AreaCode = oAddressContol.txtAreaCode.Text
            ...
            If objClinic.CheckColumnExists() = True Then
                ...
                gstrClinicExternalCode = txtAUSUsername.Text.Trim
            End If
            '----
            objClinic = Nothing
            '-----------
    ...
    Private Sub c1ClinicIDs_SetupEditor(ByVal sender As System.Object, ByVal e As C1.Win.C1FlexGrid.RowColEventArgs)
    ...
    Private Sub c1ClinicIDs_StartEdit(ByVal sender As System.Object, ByVal e As C1.Win.C1FlexGrid.RowColEventArgs)
        c1ClinicIDs.Editor = CType(c1ClinicIDs.Editor, TextBox)
    End Sub

    Private Sub c1ClinicIDs_MouseMove(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs)
        gloC1FlexStyle.ShowToolTipForLineBreak(C1SuperTooltip1, DirectCast(sender, C1.Win.C1FlexGrid.C1FlexGrid), e.Location)
    End Sub

    Private Sub txtPhoneNo_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtPhoneNo.Validating
        ' RemoveHandler txtPhoneNo.Validating, AddressOf txtPhoneNo_Validating
        txtPhoneNo.AllowValidate = True
        If Not (txtPhoneNo.IsValidated) Then
            txtPhoneNo.AllowValidate = False
            TabControl1.SelectedIndex = 0
            txtPhoneNo.Focus()
        End If
        ' AddHandler txtPhoneNo.Validating, AddressOf txtPhoneNo_Validating
    End Sub
    ...
    Private Sub txtFax_Validating(ByVal sender As System.Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtFax.Validating
        txtFax.AllowValidate = True
        If Not txtFax.IsValidated Then
            txtFax.AllowValidate = False
            TabControl1.SelectedIndex = 0
    ...
    'Private Sub txtPhoneNo_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtPhoneNo.Leave
    '    txtPhoneNo.AllowValidate = True
    '    If Not (txtPhoneNo.IsValidated) Then
    '        TabControl1.SelectedIndex = 0
    '        txtPhoneNo.AllowValidate = False
    ...
    Private Sub txtContactPersonPhoneNo_ErrorMessageInvoked(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtContactPersonPhoneNo.ErrorMessageInvoked
        ValidationFailed = True
    End Sub

    Private Sub txtContactPersonMobileNo_ErrorMessageInvoked(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtContactPersonMobileNo.ErrorMessageInvoked
        ValidationFailed = True
    End Sub

    Private Sub txtContactPersonFax_ErrorMessageInvoked(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtContactPersonFax.ErrorMessageInvoked
        ValidationFailed = True
    End Sub
