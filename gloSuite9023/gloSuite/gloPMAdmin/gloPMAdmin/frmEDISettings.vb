...
#End Region
    ...
    Private Sub FillValidationFields()
        ...
        Try
            ...
            trvFields.Nodes(2).Nodes.Add("Billing Provider Company Tax ID")
            ...
            '20100416 Urgent Outage 5031
            trvFields.Nodes(6).Nodes.Add("Plan Type")
            ...
            '20100416 Urgent Outage 5031
            trvFields.Nodes(8).Nodes.Add("Secondary Plan Type")
            ...
            '20100416 Urgent Outage 5031
            trvFields.Nodes(9).Nodes.Add("Tertiary Plan Type")
            ...
            '20100416 Urgent Outage 5031
            trvFields.Nodes.Add("Rendering Provider")
            trvFields.Nodes(11).Nodes.Add("Rendering Provider First Name")
            trvFields.Nodes(11).Nodes.Add("Rendering Provider Last Name")
            trvFields.Nodes(11).Nodes.Add("Rendering Provider NPI")
            trvFields.Nodes(11).Nodes.Add("Rendering Provider Taxonomy Code")
...
#End Region
    ...
    'Adding "Select  ALL" and "DeSelect All" option functionality. 
    Private Sub chkSelectAll_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkSelectAll.CheckedChanged
        Dim _currentTreeNode As TreeNode
        trvFields.BeginUpdate()
        For Each _currentTreeNode In trvFields.Nodes
            _currentTreeNode.Checked = CBool((chkSelectAll.Checked))
            If (_currentTreeNode.Nodes.Count > 0) Then
                For _Index As Integer = 0 To _currentTreeNode.Nodes.Count - 1
                    _currentTreeNode.Nodes(_Index).Checked = CBool((chkSelectAll.Checked))
                Next
            End If
        Next
        trvFields.EndUpdate()
