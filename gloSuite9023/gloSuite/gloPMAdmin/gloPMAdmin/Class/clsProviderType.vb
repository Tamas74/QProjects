...
#Region "   Public Methods and Functions"
    ...
    Public Function DeleteProviderType(ByVal ProviderType As String) As Boolean
        Try
            ...
            Dim obj As New gloDatabaseLayer.DBLayer(gloPMAdmin.mdlGeneral.GetConnectionString())
            obj.Connect(False)
            obj.Execute_Query(" DELETE AB_Resource_ProviderType WHERE sProviderType= '" & ProviderType.Replace("'", "''") & "'")
            obj.Dispose()
