...
Public Class BitmapRegion
    ...
    Public Shared Sub CreateControlRegion(control As Control, bitmap As Bitmap)
    ...
    Private Shared Function CalculateControlGraphicsPath(bitmap As Bitmap) As GraphicsPath
