            ...
            Try
                ...
                If _DocumentID <> 0 Then
                    If _IsPublisher = True Then
                        oDB.Connect(gloPMAdmin.mdlgloDMS.GetConnectionString_DMS(Supporting.ConnectionType.Publisher))
                    Else
                        oDB.Connect(gloPMAdmin.mdlgloDMS.GetConnectionString_DMS(Supporting.ConnectionType.Subscriber))
                    End If
                    'Document ID
        ...
        Public Class Supporting
            ...
            Public ReadOnly Property NewDocumentFileNameOrID(ByVal PatientID As Long, ByVal GetDocID As Boolean, ByVal PublisherSubscriber As gloStream.Supporting.ConnectionType) As String
                Get
                    ...
                    Dim oDB As New gloStream.gloDataBase.gloDataBase
                    oDB.Connect(gloPMAdmin.mdlgloDMS.GetConnectionString_DMS(PublisherSubscriber))
