...
#Region " Private Variables "
    ...
    Private _ClearingHouseType As String = ""
    Private _sEligibilityUserName As String = ""
    Private _sEligibilityPassword As String = ""
    Private _sEligibilityURL As String = ""
    Private _bISEbnableBatchEligibilty As Boolean = False
    Private _sRealTimeClaimUserName As String = ""
    Private _sRealTimeClaimPassword As String = ""
    Private _sRealTimeClaimURL As String = ""
    Private _bISEnableRealTimeClaimStatus As Boolean = False
...
#Region "Properties"
    ...
    Public Property ISEbnableBatchEligibilty() As Boolean
        Get
            Return _bISEbnableBatchEligibilty
        End Get
        Set(ByVal value As Boolean)
            _bISEbnableBatchEligibilty = value
        End Set
    End Property
    ...
    Public Property ClearingHouseType() As Int64
        Get
            Return _ClearingHouseType
        End Get
        Set(ByVal value As Int64)
            _ClearingHouseType = value
        End Set
    End Property
    ...
    ''added new property for StatementFileExtension.
    Private _sStatementFileExtension As String
    Public Property StatementFileExtension() As String
        Get
            Return _sStatementFileExtension
        End Get
        Set(ByVal value As String)
            _sStatementFileExtension = value
        End Set
    End Property
    ''7022Items: ISA Segment change Lymphedema Clearing house claim Changes(ISA)
    Private _sSenderInterchangeIDQualifier As String
    Public Property SenderInterchangeIDQualifier() As String
        Get
            Return _sSenderInterchangeIDQualifier
        End Get
        Set(ByVal value As String)
            _sSenderInterchangeIDQualifier = value
        End Set
    End Property
    ''7022Items: ISA Segment change Lymphedema Clearing house claim Changes(ISA)
    Private _sReceiverInterchangeIDQualifier As String
    Public Property ReceiverInterchangeIDQualifier() As String
        Get
            Return _sReceiverInterchangeIDQualifier
        End Get
        Set(ByVal value As String)
            _sReceiverInterchangeIDQualifier = value
        End Set
    End Property
...
#Region "Properties for deteil table fields"
    ...
    Public Property EligibilityUserName() As String
        Get
            Return _sEligibilityUserName
        End Get
        Set(ByVal value As String)
            _sEligibilityUserName = value
        End Set
    End Property

    Public Property EligibilityPassword() As String
        Get
            Return _sEligibilityPassword
        End Get
        Set(ByVal value As String)
            _sEligibilityPassword = value
        End Set
    End Property

    Public Property EligibilityURL() As String

        Get
            Return _sEligibilityURL
        End Get
        Set(ByVal value As String)
            _sEligibilityURL = value
        End Set
    End Property

    Public Property RealTimeClaimUserName() As String
        Get
            Return _sRealTimeClaimUserName
        End Get
        Set(ByVal value As String)
            _sRealTimeClaimUserName = value
        End Set
    End Property

    Public Property RealTimeClaimPassword() As String
        Get
            Return _sRealTimeClaimPassword
        End Get
        Set(ByVal value As String)
            _sRealTimeClaimPassword = value
        End Set
    End Property

    Public Property RealTimeClaimURL() As String

        Get
            Return _sRealTimeClaimURL
        End Get
        Set(ByVal value As String)
            _sRealTimeClaimURL = value
        End Set
    End Property

    Public Property ISEnableRealTimeClaimStatus() As Boolean
        Get
            Return _bISEnableRealTimeClaimStatus
        End Get
        Set(ByVal value As Boolean)
            _bISEnableRealTimeClaimStatus = value
        End Set
    End Property
...
#End Region
        ...
        Public Function Add(ByVal oClearingHouse As ClearingHouse) As Long
            ...
            oDBParameters.Add("@nClearingHouseType", oClearingHouse.ClearingHouseType, System.Data.ParameterDirection.Input, System.Data.SqlDbType.Int)
            oDBParameters.Add("@bIsDefault", oClearingHouse.IsDefault, System.Data.ParameterDirection.Input, System.Data.SqlDbType.Bit)
            ''7022Items:.STA extension for GatewayEDI statements
            ''pass value to SP BL_INUP_ClearingHouseMST to save StatementFileExtension to database.
            oDBParameters.Add("@sStatementFileExtension", oClearingHouse.StatementFileExtension, System.Data.ParameterDirection.Input, System.Data.SqlDbType.VarChar)

            ''7022Items: ISA Segment change Lymphedema Clearing house claim Changes(ISA)
            oDBParameters.Add("@sReceiverIDQualifier", oClearingHouse.ReceiverInterchangeIDQualifier, System.Data.ParameterDirection.Input, System.Data.SqlDbType.VarChar)
            oDBParameters.Add("@sSenderIDQualifier", oClearingHouse.SenderInterchangeIDQualifier, System.Data.ParameterDirection.Input, System.Data.SqlDbType.VarChar)
            ...
            oDBParameters.Add("@nClinicID", oClearingHouse.ClinicID, System.Data.ParameterDirection.Input, System.Data.SqlDbType.BigInt)
            oDBParameters.Add("@sEligibilityUserName", oClearingHouse.EligibilityUserName, System.Data.ParameterDirection.Input, System.Data.SqlDbType.VarChar)
            oDBParameters.Add("@sEligibilityPassword", oClearingHouse.EligibilityPassword, System.Data.ParameterDirection.Input, System.Data.SqlDbType.VarChar)
            oDBParameters.Add("@sEligibilityUrl", oClearingHouse.EligibilityURL, System.Data.ParameterDirection.Input, System.Data.SqlDbType.VarChar)
            oDBParameters.Add("@bEnableBatchEligibility", oClearingHouse.ISEbnableBatchEligibilty, System.Data.ParameterDirection.Input, System.Data.SqlDbType.Bit)
            oDBParameters.Add("@sRealTimeClaimUserName", oClearingHouse.RealTimeClaimUserName, System.Data.ParameterDirection.Input, System.Data.SqlDbType.VarChar)
            oDBParameters.Add("@sRealTimeClaimPassword", oClearingHouse.RealTimeClaimPassword, System.Data.ParameterDirection.Input, System.Data.SqlDbType.VarChar)
            oDBParameters.Add("@sRealTimeClaimUrl", oClearingHouse.RealTimeClaimURL, System.Data.ParameterDirection.Input, System.Data.SqlDbType.VarChar)
            oDBParameters.Add("@bEnableRealTimeClaimStatus", oClearingHouse.ISEnableRealTimeClaimStatus, System.Data.ParameterDirection.Input, System.Data.SqlDbType.Bit)
        ...
        Public Function GetClearingHouse(ByVal ClearingHouseID As Int64) As ClearingHouse
            ...
            Try
                ...
                oDB.Connect(False)
            ''7022Items:.STA extension for GatewayEDI statements
            ''Add column to get value for StatementFileExtension from database.
            ''7022Items: ISA Segment change Lymphedema Clearing house claim Changes(ISA)
            _sqlQuery = "SELECT ISNULL(nClearingHouseID,0) AS nClearingHouseID,ISNULL(sClearingHouseCode,'') AS sClearingHouseName,ISNULL(sReceiverID,'') AS sReceiverID,ISNULL(sReceiverName,'') AS sReceiverName,ISNULL(sSubmitterID,'') AS sSubmitterID, " _
                        ...
                        & " ISNULL(bIsISA,'') AS bIsISA,ISNULL(bIsDefault,'') AS bIsDefault,ISNULL(nClearingHouseType,'') AS nClearingHouseType,ISNULL(sStatementFileExtension,'') AS sStatementFileExtension,ISNULL(sReceiverIDQualifier,'') AS sReceiverIDQualifier,ISNULL(sSenderIDQualifier,'') AS sSenderIDQualifier FROM BL_ClearingHouse_MST WHERE nClearingHouseID = " & ClearingHouseID & " " 'AND nClinicID = 1"
                ...
                oClearingHouse.IsDefault = Convert.ToString(dtClearing.Rows(0)("bIsDefault"))
                oClearingHouse.ClearingHouseType = Convert.ToString(dtClearing.Rows(0)("nClearingHouseType"))
                ''7022Items:.STA extension for GatewayEDI statements
                ''Get value from database to property.
                oClearingHouse.StatementFileExtension = Convert.ToString(dtClearing.Rows(0)("sStatementFileExtension"))

                ''7022Items: ISA Segment change Lymphedema Clearing house claim Changes(ISA)
                oClearingHouse.ReceiverInterchangeIDQualifier = Convert.ToString(dtClearing.Rows(0)("sReceiverIDQualifier"))
                oClearingHouse.SenderInterchangeIDQualifier = Convert.ToString(dtClearing.Rows(0)("sSenderIDQualifier"))
                End If
            ...
            & " ISNULL(sGen_Statements,'') AS sGen_Statements,ISNULL(sGen_WorkedTrans,'') AS sGen_WorkedTrans,ISNULL(nFolderCategory,0) AS nFolderCategory," _
            & " ISNULL(sEligibilityUserName,'') as sEligibilityUserName,ISNULL(sEligibilityPassword,'') as sEligibilityPassword,ISNULL(sEligibilityUrl,'') as sEligibilityUrl,ISNULL(bEnableBatchEligibilty,0) AS bEnableBatchEligibilty  ," _
            & " ISNULL(sRealTimeClaimUserName,'') as sRealTimeClaimUserName,ISNULL(sRealTimeClaimPassword,'') as sRealTimeClaimPassword,ISNULL(sRealTimeClaimUrl,'') as sRealTimeClaimUrl,ISNULL(bEnableRealTimeClaimStatus,0) as bEnableRealTimeClaimStatus " _
            & " FROM BL_ClearingHouse_DTL WHERE nClearingHouseID = " & ClearingHouseID & " " 'AND nClinicID = 1 "
                ...
                oClearingHouse.EligibilityUserName = Convert.ToString(dtClearingDetail.Rows(0)("sEligibilityUserName"))
                oClearingHouse.EligibilityPassword = Convert.ToString(dtClearingDetail.Rows(0)("sEligibilityPassword"))
                oClearingHouse.EligibilityURL = Convert.ToString(dtClearingDetail.Rows(0)("sEligibilityUrl"))
                oClearingHouse.ISEbnableBatchEligibilty = Convert.ToBoolean(dtClearingDetail.Rows(0)("bEnableBatchEligibilty"))
                oClearingHouse.RealTimeClaimUserName = Convert.ToString(dtClearingDetail.Rows(0)("sRealTimeClaimUserName"))
                oClearingHouse.RealTimeClaimPassword = Convert.ToString(dtClearingDetail.Rows(0)("sRealTimeClaimPassword"))
                oClearingHouse.RealTimeClaimURL = Convert.ToString(dtClearingDetail.Rows(0)("sRealTimeClaimUrl"))
                oClearingHouse.ISEnableRealTimeClaimStatus = Convert.ToString(dtClearingDetail.Rows(0)("bEnableRealTimeClaimStatus"))
    ...
    Public Function IsClearingHouseTypeExists(ByVal nClearingHouseType As Int32) As Boolean
        Dim oDB As New gloDatabaseLayer.DBLayer(_databaseconnectionstring)
        Dim _result As Boolean = False
        ...
        Try
            ...
            _sqlQuery = "Select Count(ISNULL(nClearingHouseID,0)) as nClearingHouseID FROM BL_ClearingHouse_MST  WHERE ISNULL(nClearingHouseType,0)  = " & nClearingHouseType & " "
    ...
    Public Sub SetDefaultSettingforBatchEligibility(ByVal ClearingHouseID As Long)
        ...
        Try
            ...
            _sqlQuery = "UPDATE EligibilityBatchSetting SET nClearingHouseID=" & ClearingHouseID & ",tSendNextDaysAptTime='16:00:00',tCheckForResponseTime='02:00:00',tTerminateDayOfAfterTime='09:00:00',dtCreateDateTime=dbo.gloGetDate(),dtModifiedDateTime=dbo.gloGetDate()"
