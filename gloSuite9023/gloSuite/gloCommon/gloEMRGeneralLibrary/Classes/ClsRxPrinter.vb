...
#Region "Private properties"
        ...
        Private _ColumnBounds As New RxColumnBounds
...
#Region "_GridPrintDocument events"
        ...
        Private Sub _GridPrintDocument_PrintPage(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles _GridPrintDocument.PrintPage
            ...
            If _CurrentPageDown = 1 And _CurrentPageAcross = 1 Then
                ...
                '_Rowheight = _Rowheight * 2.6
                _Rowheight = _Rowheight * 4
                ...
                If Not _DataGrid.DataSource Is Nothing Then
                    ...
                    For nColumn = 0 To ColumnCount - 1
                        ...
                        Dim NextColumn As New RxColumnBound
                        If nColumn = 0 Then
...
#Region "Private methods"
        ...
        Private Sub PrintGridLine(ByVal e As System.Drawing.Printing.PrintPageEventArgs, ByVal RowNumber As Integer)
            ...
            Else
                ...
                Top = _PageContentRectangle.Top + (RowFromTop * ((_CellGutter * 2) + _Rowheight)) + (_CellGutter * 2) + 16
        ...
        Private Sub PrintGridHeaderLine(ByVal e As System.Drawing.Printing.PrintPageEventArgs)
            ...
            'Dim Bottom As Double = Top + _RowHieght + (2 * _CellGutter)
            Dim Bottom As Double = Top + 16 + (2 * _CellGutter)
            'Dim Bottom As Double = Top + (2 * _CellGutter)
...
#End Region
        ...
        Private Sub _GridPrintDocument_EndPrint(ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintEventArgs) Handles _GridPrintDocument.EndPrint

        End Sub
    End Class
#End Region

#Region "RxColumnBound"
    Public Class RxColumnBound
...
#End Region
    ...
    End Class
#End Region
#Region "RxColumnBounds"
    '\\ Type safe collection of "RxColumnBound" objects
    Public Class RxColumnBounds
...
#Region "ArrayList overrides"
        Public Overloads Function Add(ByVal RxColumnBound As RxColumnBound) As Integer
            If RxColumnBound.Left + RxColumnBound.Width > _RightExtents Then
                _RightExtents = RxColumnBound.Left + RxColumnBound.Width
            End If
            RxColumnBound.Page = _CurrentPage
            Return MyBase.Add(RxColumnBound)
        End Function
        ...
        Default Public Shadows Property Item(ByVal Index As Integer) As RxColumnBound
            Get
                Return CType(MyBase.Item(Index), RxColumnBound)
            End Get
            Set(ByVal Value As RxColumnBound)
