...
namespace gloBilling
{
    ...
    public partial class frmWorkerCompFormViewer : Form
    {
        ...
        public long VisitId;
        public string strSetFormDataPath = "";
     //   public double dblVScrollPos = 0;
        ...
        public frmWorkerCompFormViewer(Int64 patientid, Int64 transactionID, Int64 transactionmasterID, string _databaseconnectionstring, Int64 formID)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                dtProperties = GetAllPropertiesInfo(objC4);
                if (objConn != null)
                {
                ...
                oParam.Value = (int)WorkersCompFormTypes.C4;
                ...
                if (dsWorkersCompForms != null && dsWorkersCompForms.Tables.Count > 0)
                {
                    ...
                    {
                        SetDataToC4Object(dsWorkersCompForms.Tables["WorkersCompForms_DTL"], ref objC4);
                        bIsNewForm = false;
                    }
                }
                ...
                if (bIsNewForm)
                {
                    ...
                    ObjWorkerComp.SetC4PrdefinedInfo(dsInfo, ref objC4, true, true);
        ...
        public void LoadForWorkerCompViewer()
        {
            try
            {
                ...
                _pdfdoc = new PDFDoc(global::gloBilling.Properties.Resources.C4_Tab_ImageSign, global::gloBilling.Properties.Resources.C4_Tab_ImageSign.Length);
                ...
                if (objC4.C4DoctorInformation.ProviderSignImage != null && objC4.C4DoctorInformation.ProviderSignImage.Length>0)
                {
                ...
                lblPatientName.Text = objC4.C4PatientInformation.PatientFullName;
        ...
        private void frmWorkerCompFormViewer_Load(object sender, EventArgs e)
        {
        ...
        private void SetFormFieldsDataClaimOnly(ref PDFDoc FormPdfDoc)
        {
            ...
            try
            {
                ...
                propinfo = null;
                propinfo = objC4.C4DoctorInformation.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4DoctorInformation);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4BillingInformation.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4BillingInformation);
                    }
                }

                propinfo = null;
                
                SetData(FormPdfDoc, objC4.C4Footer.GetType().GetProperty("AuthorizedProviderName"), objC4.C4Footer);
                SetData(FormPdfDoc, objC4.C4Footer.GetType().GetProperty("AuthorizedProviderSpeciality"), objC4.C4Footer);

                SetData(FormPdfDoc, objC4.C4PatientInformation.GetType().GetProperty("Carrier_CaseNo"), objC4.C4PatientInformation);
                SetData(FormPdfDoc, objC4.C4PatientInformation.GetType().GetProperty("WCB_CaseNo"), objC4.C4PatientInformation);

                SetData(FormPdfDoc, objC4.C4ExamInformation.GetType().GetProperty("DateOfExam"), objC4.C4ExamInformation);

                SetData(FormPdfDoc, objC4.C4PatientInformation.GetType().GetProperty("DateOfInjuryDD"), objC4.C4PatientInformation);
                SetData(FormPdfDoc, objC4.C4PatientInformation.GetType().GetProperty("DateOfInjuryMM"), objC4.C4PatientInformation);
                SetData(FormPdfDoc, objC4.C4PatientInformation.GetType().GetProperty("DateOfInjuryYY"), objC4.C4PatientInformation);

                SetData(FormPdfDoc, objC4.C4HeaderInformation.GetType().GetProperty("DateOfInjuryDDPage2"), objC4.C4HeaderInformation);
                SetData(FormPdfDoc, objC4.C4HeaderInformation.GetType().GetProperty("DateOfInjuryMMPage2"), objC4.C4HeaderInformation);
                SetData(FormPdfDoc, objC4.C4HeaderInformation.GetType().GetProperty("DateOfInjuryYYYYPage2"), objC4.C4HeaderInformation);

                SetData(FormPdfDoc, objC4.C4HeaderInformation.GetType().GetProperty("DateOfInjuryDDPage3"), objC4.C4HeaderInformation);
                SetData(FormPdfDoc, objC4.C4HeaderInformation.GetType().GetProperty("DateOfInjuryMMPage3"), objC4.C4HeaderInformation);
                SetData(FormPdfDoc, objC4.C4HeaderInformation.GetType().GetProperty("DateOfInjuryYYYYPage3"), objC4.C4HeaderInformation);

                SetData(FormPdfDoc, objC4.C4HeaderInformation.GetType().GetProperty("DateOfInjuryDDPage4"), objC4.C4HeaderInformation);
                SetData(FormPdfDoc, objC4.C4HeaderInformation.GetType().GetProperty("DateOfInjuryMMPage4"), objC4.C4HeaderInformation);
                SetData(FormPdfDoc, objC4.C4HeaderInformation.GetType().GetProperty("DateOfInjuryYYYYPage4"), objC4.C4HeaderInformation);
        ...
        private void SetFormFieldsData(ref PDFDoc FormPdfDoc)
        {
            ...
            try
            {
               ...
               // FormPdfDoc.InitSecurityHandler();
                ...
                propinfo = objC4.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4PatientInformation.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4PatientInformation);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4EmployerInformation.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4EmployerInformation);
                    }
                }
                ...
                propinfo = null;
                propinfo = objC4.C4HistoryInformation.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4HistoryInformation);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4ExamInformation.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4ExamInformation);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4ExamInformation.C4ExamInfoComplains.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4ExamInformation.C4ExamInfoComplains);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4ExamInformation.C4ExamInfoNatureOfInjury.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4ExamInformation.C4ExamInfoNatureOfInjury);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4ExamInformation.C4ExamInfoPhysicalExamination.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4ExamInformation.C4ExamInfoPhysicalExamination);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4DoctorsOpinions.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4DoctorsOpinions);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4PlanOfCares.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4PlanOfCares);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4PlanOfCares.C4PlanOfCareTests.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4PlanOfCares.C4PlanOfCareTests);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4PlanOfCares.C4PlanOfCareReferrals.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4PlanOfCares.C4PlanOfCareReferrals);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4PlanOfCares.C4PlanOfCareAssistiveDevices.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4PlanOfCares.C4PlanOfCareAssistiveDevices);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4PlanOfCares.C4PlanOfCareFollowUpAppt.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4PlanOfCares.C4PlanOfCareFollowUpAppt);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4WorkStatuses.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4WorkStatuses);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4WorkStatuses.C4WorkStatusWorkLimitations.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4WorkStatuses.C4WorkStatusWorkLimitations);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4HeaderInformation.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4HeaderInformation);
                    }
                }

                propinfo = null;
                propinfo = objC4.C4Footer.GetType().GetProperties();

                if (propinfo != null && propinfo.Length > 0)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        SetData(FormPdfDoc, prop, objC4.C4Footer);
                    }
                }
        ...
        private bool SetData(PDFDoc oDoc, PropertyInfo prop, object objClass)
        {
            ...
            try
            {
                ...
                sField = objC4.GetAttributeDisplayName(prop);
        ...
        {
            gloAuditTrail.gloAuditTrail.CreateAuditLog(gloAuditTrail.ActivityModule.NYWCForms, gloAuditTrail.ActivityCategory.NYWCForms, gloAuditTrail.ActivityType.Close, "C-4 Form Closed.", PatientId, iFormID, 0, gloAuditTrail.ActivityOutCome.Success, (_messageBoxCaption == "gloPM" ? gloAuditTrail.SoftwareComponent.gloPM : gloAuditTrail.SoftwareComponent.gloEMR));
            this.Close();
        }
        ...
        private void tsb_Print_Click(object sender, EventArgs e)
        {
            try
            {
                if (iFormID <= 0)
                {
                    MessageBox.Show("C-4 Form you are trying to print is not yet saved." + System.Environment.NewLine + "Form will be saved automatically before printing.", _messageBoxCaption, MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                //if (iFormID <= 0)
                //{
                //    gloAuditTrail.gloAuditTrail.CreateAuditLog(gloAuditTrail.ActivityModule.NYWCForms, gloAuditTrail.ActivityCategory.NYWCForms, gloAuditTrail.ActivityType.Print, "C-4 Form printed without Saving in system.", PatientId, iFormID, 0, gloAuditTrail.ActivityOutCome.Success, (_messageBoxCaption == "gloPM" ? gloAuditTrail.SoftwareComponent.gloPM : gloAuditTrail.SoftwareComponent.gloEMR));
                //}
                //else
                //{
                    gloAuditTrail.gloAuditTrail.CreateAuditLog(gloAuditTrail.ActivityModule.NYWCForms, gloAuditTrail.ActivityCategory.NYWCForms, gloAuditTrail.ActivityType.Print, "C-4 Form printed from system.", PatientId, iFormID, 0, gloAuditTrail.ActivityOutCome.Success, (_messageBoxCaption == "gloPM" ? gloAuditTrail.SoftwareComponent.gloPM : gloAuditTrail.SoftwareComponent.gloEMR));
                //}
     ...
     //   pdftron.PDF.Rect rect = null;
        ...
        //}
        private void SetDataToC4Object(DataTable dtData, ref C4 objC4)
        {
            ...
            try
            {
                foreach (DataRow drRow in dtData.Rows)
                {
                    ...
                    prop = objC4.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        if (!string.IsNullOrEmpty(System.Convert.ToString(oValue)))
                        {
                            ...
                            prop.SetValue(objC4, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4PatientInformation.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4PatientInformation, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4EmployerInformation.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4EmployerInformation, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4DoctorInformation.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                            ...
                            {
                                oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                                prop.SetValue(objC4.C4DoctorInformation, oValue, null);
                            }

                        continue;
                    }

                    prop = objC4.C4BillingInformation.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4BillingInformation, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4HistoryInformation.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4HistoryInformation, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4ExamInformation.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4ExamInformation, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4ExamInformation.C4ExamInfoComplains.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4ExamInformation.C4ExamInfoComplains, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4ExamInformation.C4ExamInfoNatureOfInjury.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4ExamInformation.C4ExamInfoNatureOfInjury, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4ExamInformation.C4ExamInfoPhysicalExamination.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4ExamInformation.C4ExamInfoPhysicalExamination, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4DoctorsOpinions.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4DoctorsOpinions, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4PlanOfCares.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4PlanOfCares, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4PlanOfCares.C4PlanOfCareTests.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4PlanOfCares.C4PlanOfCareTests, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4PlanOfCares.C4PlanOfCareReferrals.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4PlanOfCares.C4PlanOfCareReferrals, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4PlanOfCares.C4PlanOfCareAssistiveDevices.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4PlanOfCares.C4PlanOfCareAssistiveDevices, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4PlanOfCares.C4PlanOfCareFollowUpAppt.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4PlanOfCares.C4PlanOfCareFollowUpAppt, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4WorkStatuses.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4WorkStatuses, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4WorkStatuses.C4WorkStatusWorkLimitations.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4WorkStatuses.C4WorkStatusWorkLimitations, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4HeaderInformation.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4HeaderInformation, oValue, null);
                        }

                        continue;
                    }

                    prop = objC4.C4Footer.GetType().GetProperty(System.Convert.ToString(drRow["FieldName"]));
                    ...
                    if (prop != null)
                    {
                        ...
                        {
                            oValue = System.Convert.ChangeType(oValue, prop.PropertyType);
                            prop.SetValue(objC4.C4Footer, oValue, null);
                        }
        ...
        private Boolean SetDataToDBAdapter()
        {
            ...
            try
            {
                ...
                if (dsWorkersCompForms.Tables["WorkersCompForms_MST"].Rows.Count <= 0)
                {
                    ...
                    drRow["FormType"] = (int)WorkersCompFormTypes.C4;
                ...
                for (itr = FormPdfDoc.GetFieldIterator(); itr.HasNext(); itr.Next())
                {
                    ...
                    switch (type)
                    {
                        case Field.Type.e_button:
                            ...
                            {
                                drRow[0]["FormFieldValueImage"] = ObjWorkerComp.GetProviderSignImage(field,ref FormPdfDoc,4,_messageBoxCaption);
                            }
        ...
        private DataTable GetAllPropertiesInfo(C4 objC4)
        {
            ...
            try
            {
                ...
                propinfo = objC4.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4);

                propinfo = null;
                propinfo = objC4.C4PatientInformation.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4PatientInformation);

                propinfo = null;
                propinfo = objC4.C4EmployerInformation.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4EmployerInformation);

                propinfo = null;
                propinfo = objC4.C4DoctorInformation.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4DoctorInformation);

                propinfo = null;
                propinfo = objC4.C4BillingInformation.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4BillingInformation);

                propinfo = null;
                propinfo = objC4.C4HistoryInformation.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4HistoryInformation);

                propinfo = null;
                propinfo = objC4.C4ExamInformation.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4ExamInformation);

                propinfo = null;
                propinfo = objC4.C4ExamInformation.C4ExamInfoComplains.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4ExamInformation.C4ExamInfoComplains);

                propinfo = null;
                propinfo = objC4.C4ExamInformation.C4ExamInfoNatureOfInjury.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4ExamInformation.C4ExamInfoNatureOfInjury);

                propinfo = null;
                propinfo = objC4.C4ExamInformation.C4ExamInfoPhysicalExamination.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4ExamInformation.C4ExamInfoPhysicalExamination);

                propinfo = null;
                propinfo = objC4.C4DoctorsOpinions.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4DoctorsOpinions);

                propinfo = null;
                propinfo = objC4.C4PlanOfCares.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4PlanOfCares);

                propinfo = null;
                propinfo = objC4.C4PlanOfCares.C4PlanOfCareTests.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4PlanOfCares.C4PlanOfCareTests);

                propinfo = null;
                propinfo = objC4.C4PlanOfCares.C4PlanOfCareReferrals.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4PlanOfCares.C4PlanOfCareReferrals);

                propinfo = null;
                propinfo = objC4.C4PlanOfCares.C4PlanOfCareAssistiveDevices.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4PlanOfCares.C4PlanOfCareAssistiveDevices);

                propinfo = null;
                propinfo = objC4.C4PlanOfCares.C4PlanOfCareFollowUpAppt.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4PlanOfCares.C4PlanOfCareFollowUpAppt);

                propinfo = null;
                propinfo = objC4.C4WorkStatuses.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4WorkStatuses);

                propinfo = null;
                propinfo = objC4.C4WorkStatuses.C4WorkStatusWorkLimitations.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4WorkStatuses.C4WorkStatusWorkLimitations);

                propinfo = null;
                propinfo = objC4.C4HeaderInformation.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4HeaderInformation);

                propinfo = null;
                propinfo = objC4.C4Footer.GetType().GetProperties();
                PopulatePropertiesData(ref dtProp, propinfo, objC4.C4Footer);
        ...
        private void PopulatePropertiesData(ref DataTable dtProp, PropertyInfo[] propinfo, object obj)
        {
            ...
            try
            {
                if (propinfo != null)
                {
                    foreach (PropertyInfo prop in propinfo)
                    {
                        string sDisplayName = objC4.GetAttributeDisplayName(prop);
                ...
                if (bIsSuccess)
                {
                   ...
                   // gloAuditTrail.gloAuditTrail.CreateAuditLog(gloAuditTrail.ActivityModule.NYWCForms, gloAuditTrail.ActivityCategory.NYWCForms, gloAuditTrail.ActivityType.Save, "C4 Form saved with Claim '" + lblClaimNo.Text + "'.", PatientId, iFormID, 0, gloAuditTrail.ActivityOutCome.Success, (_messageBoxCaption == "gloPM" ? gloAuditTrail.SoftwareComponent.gloPM : gloAuditTrail.SoftwareComponent.gloEMR));
                    gloAuditTrail.gloAuditTrail.CreateAuditLog(gloAuditTrail.ActivityModule.NYWCForms, gloAuditTrail.ActivityCategory.NYWCForms,
                                                         ...
                                                         (lblClaimNo.Text.Trim().Length > 0) ? "C-4 Form saved with claim '" + lblClaimNo.Text + "'." : "C-4 Form saved without claim association.",
        ...
        //private byte[] GetProviderSignImage(Field field,ref PDFDoc FormPdfDoc)
        //{
        ...
        //        if (field.IsAnnot())
        //        {
        //            Page page = FormPdfDoc.GetPage(4);
        ...
        private void btnSearchPatientClaim_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (IsValidClaimNumber())
                {
                    ...
                    ObjWorkerComp.SetC4PrdefinedInfo(dsInfo, ref objC4, true, false);
                   
                    PDFDoc FreshPdfdoc = new PDFDoc(global::gloBilling.Properties.Resources.C4_Tab_ImageSign, global::gloBilling.Properties.Resources.C4_Tab_ImageSign.Length);
                    try
                    {
                        FreshPdfdoc.InitSecurityHandler();
                    }
                    ...
                    //dblVScrollPos = _pdfview.GetVScrollPos();
                   
                    // SetFormFieldsData(ref FreshPdfdoc);
                    ...
                    gloAuditTrail.gloAuditTrail.CreateAuditLog(gloAuditTrail.ActivityModule.NYWCForms, gloAuditTrail.ActivityCategory.NYWCForms, gloAuditTrail.ActivityType.Modify, "Claim modified on C-4 Form with new value '" + lblClaimNo.Text + "'.", PatientId, iFormID, 0, gloAuditTrail.ActivityOutCome.Success, (_messageBoxCaption == "gloPM" ? gloAuditTrail.SoftwareComponent.gloPM : gloAuditTrail.SoftwareComponent.gloEMR));
                }
            }
            catch (Exception ex)
            {
        ...
        private void LoadPDFSign(ref PDFDoc SignPdfdoc)
        {
            try
            {
                string fname = ObjWorkerComp.SignPDFImage(ref SignPdfdoc, objC4.C4DoctorInformation.ProviderSignImage, "form1[0].P4[0].Authorized-Physician-Signature[0]", 4);
        ...
        private void frmWorkerCompFormViewer_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void frmWorkerCompFormViewer_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
                if (_pdfview != null)
