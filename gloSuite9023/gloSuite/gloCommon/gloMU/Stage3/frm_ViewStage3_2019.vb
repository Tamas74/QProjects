...
Public Class frm_ViewStage3_2019
...
#End Region
    ...
    Private Sub frmViewMUDashboard_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            CustomGridStyle()
            dv = objclsMeasures.FillMUMeasures_Stage3(2019)
    ...
    Private Sub AddMeasure()
        Try
            Dim objfrmMeasures As New gloMU.frm_Stage3_2019()
            ' Dim ID As Int64

            With objfrmMeasures
                .Text = "MU Stage 3 2019"
                .mycaller = Me
    ...
    Private Sub UpdateMeasure()
        ...
        Dim objfrmMU As frm_Stage3_2019
        ...
        Try
            If C1MUDashboard.Row >= 1 Then
                ...
                End If
                ''''''''''''''''''''''
                objfrmMU = New frm_Stage3_2019(ID)
        ...
        Try
            ...
            If C1MUDashboard.Row >= 1 Then
                ...
                If MessageBox.Show("Do you want to delete selected Report?", _MessageBoxCaption, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.Yes Then
                    objclsMeasures.DeleteMeasures_Stage3(ID, 2019)
                    txtSearch.ResetText()
                    ...
                    C1MUDashboard.DataSource = objclsMeasures.FillMUMeasures_Stage3(2019)
    ...
    Private Sub On_frmMU_Closed(ByVal sender As Object, ByVal e As FormClosedEventArgs)
        Dim frm As gloMU.frm_Stage3_2019 = Nothing

        Try
            frm = DirectCast(sender, gloMU.frm_Stage3_2019)
        Catch ex As Exception
