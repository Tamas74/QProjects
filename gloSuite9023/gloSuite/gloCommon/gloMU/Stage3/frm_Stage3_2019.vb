...
Public Class frm_Stage3_2019
    ...
    Private ROW_EPrescription As Integer = 2


    'Private ROW_ClinicalDecisionSupportRule As Integer = 3
    Private ROW_ClinicalDecisionSupport As Integer = 3
    Private ROW_ClinicalDecisionDrugInteractionCheck As Integer = 4

    'Private ROW_CPOEMedicationLabRad As Integer = 6
    Private ROW_CPOEMedication As Integer = 5
    Private ROW_Laboratory As Integer = 6
    Private ROW_Radiology As Integer = 7


    Private ROW_PatientElectronicAccess_Measure1 As Integer = 8
    Private ROW_PatientSpecificEducation As Integer = 9

    Private ROW_PatientElectronicAccess_Measure2 As Integer = 10
    Private ROW_SecureElectronicMessaging As Integer = 11
    Private ROW_PatientGeneratedHealthData As Integer = 12



    Private ROW_SummaryOfCare As Integer = 13
    Private ROW_PatientRequeustOrAccept As Integer = 14
    Private ROW_MedicalReconcilation As Integer = 15


    Private ROW_ImmunizationRegistry As Integer = 16
    Private ROW_SyndromicServilance As Integer = 17
    Private ROW_SpecializedRegistryReporting As Integer = 18
    ...
    Public mycaller As frm_ViewStage3_2019
    ...
    Private Sub SetGridStyle()
        Try
            ...
            C1QualityMeasures.Rows.Count = 19
    ...
    Private Sub FillMeasures()
        ...
        Try
            ...
            C1QualityMeasures.SetData(ROW_CPOEMedication, COL_Objective, "Computerized Provider Order Entry")
            ...
            C1QualityMeasures.SetData(ROW_PatientElectronicAccess_Measure1, COL_Objective, "Patient Electronic Access to Health Information")
            ...
            'Set the checkboxes
            For intCoreMeasures As Integer = ROW_ProtectElectronicHealthInformation To ROW_SpecializedRegistryReporting   'ROW_ProtectElectronicHealthInformation
            ...
            C1QualityMeasures.SetData(ROW_ClinicalDecisionSupport, COL_Objective, "Clinical Decision Support")
            C1QualityMeasures.SetData(ROW_ClinicalDecisionSupport, COL_Measure, "Clinical Decision Support Rule")
                ...
                If dt.Rows.Count > 0 Then
                    For i = 1 To C1QualityMeasures.Rows.Count - 1
                        ...
                        ElseIf (i = ROW_SecureElectronicMessaging Or i = ROW_PatientElectronicAccess_Measure2) Then
                            ...
                            '    C1QualityMeasures.SetCellImage(i, COL_rptFlag2, Nothing)
                            'End If
                        ElseIf i = ROW_ClinicalDecisionDrugInteractionCheck Then
                            'If i = ROW_ClinicalDecisionDrugInteractionCheck Or i = ROW_DrugFormularyCheck Then
                            If Convert.ToString(dt.Rows(dtrwno)(3)) = "1" Then
                                C1QualityMeasures.SetData(i, COL_calNumerator, "Enabled")
                            Else
    ...
    Private Sub PrintReport()
        ...
        Try
            ...
            If SaveReport() Then
                ...
                clsPrntRpt.PrintReport("rptMUStage3_2019", "ReportID,User", nReportId & "," & _LoginName, gblnDefaultPrinter, "")
