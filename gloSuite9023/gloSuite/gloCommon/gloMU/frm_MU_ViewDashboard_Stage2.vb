...
Public Class frm_MU_ViewDashboard_Stage2
...
#End Region
    ...
    Private Sub frmViewMUDashboard_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            CustomGridStyle()
            dv = objclsMeasures.FillMUMeasures_Stage2()
    ...
    Private Sub AddMeasure()
        Try
            Dim objfrmMeasures As New gloMU.frm_MU_Dashboard_Stage2()
            ' Dim ID As Int64

            With objfrmMeasures
                .Text = "Meaningful Use 2014 Stage 2"
                .mycaller = Me
    ...
    Private Sub UpdateMeasure()
        ...
        Dim objfrmMU As frm_MU_Dashboard_Stage2
        ...
        Try
            ...
            If C1MUDashboard.Row >= 1 Then
                ...
                End If
                ''''''''''''''''''''''
                objfrmMU = New frm_MU_Dashboard_Stage2(ID)

                With objfrmMU
                    .Text = "Modify Meaningful Use Stage 2 2014+"
                    '.MdiParent = Me.ParentForm
                    .mycaller = Me
                    .MdiParent = Me.MdiParent
                    .Show()
        ...
        Try
            ...
            If C1MUDashboard.Row >= 1 Then
                ...
                If MessageBox.Show("Do you want to delete selected Report?", _MessageBoxCaption, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.Yes Then
                    objclsMeasures.DeleteMeasures_Stage2(ID)
                    txtSearch.ResetText()
                    ...
                    ''
                    C1MUDashboard.Enabled = False
                    C1MUDashboard.DataSource = objclsMeasures.FillMUMeasures_Stage2()
                    C1MUDashboard.Enabled = True
                    CustomGridStyle()
                    'If grdMUDashboard.VisibleRowCount > 0 Then
                    ''    grdMUDashboard.CurrentRowIndex = 0
