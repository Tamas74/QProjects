...
Public Class frm_MU_ViewDashboard_Stage2_Modified
...
#End Region
    ...
    Private Sub frmViewMUDashboard_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            CustomGridStyle()
            dv = objclsMeasures.FillMUMeasures_Stage2_Modified()
    ...
    Private Sub AddMeasure()
        Try
            Dim objfrmMeasures As New gloMU.frm_MU_Dashboard_Stage2_Modified()
            ' Dim ID As Int64

            With objfrmMeasures
                .Text = "Stage 2 Modified 2015+"
                .mycaller = Me
    ...
    Private Sub UpdateMeasure()
        ...
        Dim objfrmMU As frm_MU_Dashboard_Stage2_Modified
        ...
        Try
            If C1MUDashboard.Row >= 1 Then
                ...
                End If
                ''''''''''''''''''''''
                objfrmMU = New frm_MU_Dashboard_Stage2_Modified(ID)
        ...
        Try
            ...
            If C1MUDashboard.Row >= 1 Then
                ...
                If MessageBox.Show("Do you want to delete selected Report?", _MessageBoxCaption, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.Yes Then
                    objclsMeasures.DeleteMeasures_Stage2_Modified(ID)
                    txtSearch.ResetText()
                    ...
                    C1MUDashboard.DataSource = objclsMeasures.FillMUMeasures_Stage2_Modified()
