...
Public Class frm_View_MIPS_2019
...
#End Region
    ...
    Private Sub frmViewMUDashboard_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            CustomGridStyle()
            dv = objclsMeasures.FillMIPSACIMeasures(2019)
    ...
    Private Sub AddMeasure()
        Try
            Dim objfrmMeasures As New gloMU.frm_MIPS_PI_2019()
            ' Dim ID As Int64

            With objfrmMeasures
                .Text = "2019 MIPS PI Dashboard"
                .mycaller = Me
    ...
    Private Sub UpdateMeasure()
        ...
        Dim objfrmMU As frm_MIPS_PI_2019
        ...
        Try
            If C1MUDashboard.Row >= 1 Then
                ...
                End If
                ''''''''''''''''''''''
                objfrmMU = New frm_MIPS_PI_2019(ID)
        ...
        Try
            ...
            If C1MUDashboard.Row >= 1 Then
                ...
                If MessageBox.Show("Do you want to delete selected Report?", _MessageBoxCaption, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.Yes Then
                    objclsMeasures.DeleteMeasuresMIPSACI(ID, 2019)
                    txtSearch.ResetText()
                    ...
                    C1MUDashboard.DataSource = objclsMeasures.FillMIPSACIMeasures(2019)
    ...
    Private Sub C1MUDashboard_MouseMove(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles C1MUDashboard.MouseMove
