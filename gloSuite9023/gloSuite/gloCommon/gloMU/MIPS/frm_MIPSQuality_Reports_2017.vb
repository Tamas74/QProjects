...
Public Class frm_MIPSQuality_Reports_2017
    ...
    Private ROW_NQF_CMSID22_2014 As Integer = 64 '66
    Private ROW_NQF_CMSID56_2014 As Integer = 67 '69
    Private ROW_NQF_CMSID66_2014 As Integer = 70 '72
    Private ROW_NQF_CMSID90_2014 As Integer = 73 '75
    Private ROW_NQF_CMSID125_2014 As Integer = 76 '78
    ...
    Private Sub frm_MIPSQuality_Reports_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If PatientID <> 0 Then
                ...
                lblPatientDetails.Text = "Showing Quality Dashboard data for the Patient: " & strPatientDetails
    ...
    Private Sub GetReportingPeriod(ProviderID As Long, ByRef StartDate As Date, ByRef EndDate As Date)
        ...
        Try
            ...
            If dsMain.Tables(0).Rows.Count = 0 Then
                StartDate = New Date(DateTime.Now.Year - 2, 1, 1)
                EndDate = New Date(DateTime.Now.Year - 2, 12, 31)
            Else
    ...
    Private Sub FillGridCQM2014()
        ...
        C1QualityMeasures.Rows.Add(77) '79
        ...
        C1QualityMeasures.SetData(ROW_NQF0062_2014 + 2, COL_Measure_Name_2014, "CMS134/NQF 0062: Diabetes: Medical Attention for Nephropathy")
        ...
        C1QualityMeasures.SetData(ROW_NQF0064_2014, COL_CoreMeasure_2014, "CMS163: Diabetes: Low Density Lipoprotein (LDL-C) Control (< 100 mg/dL)")
        ...
        C1QualityMeasures.SetData(ROW_NQF0064_2014 + 2, COL_Measure_Name_2014, "CMS163, Population 1, Numerator 1: Had LDL‐C lab test")
        ...
        C1QualityMeasures.SetData(ROW_NQF0064_2014 + 3, COL_Measure_Name_2014, "CMS163: Diabetes: Low Density Lipoprotein (LDL-C) Control (< 100 mg/dL)")
        ...
        C1QualityMeasures.SetData(ROW_NQF0068_2014 + 2, COL_Measure_Name_2014, "CMS164/NQF 0068: Ischemic Vascular Disease (IVD): Use of Aspirin or Another Antiplatelet")
        ...
        C1QualityMeasures.SetData(ROW_NQF_CMSID90_2014 + 2, COL_Measure_Name_2014, "CMS90: Functional Status Assessments for Congestive Heart Failure")
        ...
        If PatientID <> 0 Then
            ...
            For intCQMCount As Integer = 0 To C1QualityMeasures.Rows.Count - 1
                ...
                If IsNumeric(C1QualityMeasures.GetData(intCQMCount, COL_Denomenator_2014)) = True AndAlso IsNumeric(C1QualityMeasures.GetData(intCQMCount, COL_Numeratot_2014)) = True AndAlso C1QualityMeasures.GetData(intCQMCount, COL_Denomenator_2014) >= 1 AndAlso C1QualityMeasures.GetData(intCQMCount, COL_Numeratot_2014) >= 1 Then
                    ...
                    For bytCount As Integer = 0 To bytRowCount - 1
                        C1QualityMeasures.Rows(intCQMCount + (bytCount * -1)).Visible = True
                    Next
                    ...
                    If intCQMCount = ROW_NQF0421_2014 + 4 Then '65 Then
                        ...
                        Else
                            If IsNumeric(C1QualityMeasures.GetData(intCQMCount, COL_Denomenator_2014)) = True AndAlso C1QualityMeasures.GetData(intCQMCount, COL_Denomenator_2014) = 0 AndAlso C1QualityMeasures.GetData(intCQMCount - 2, COL_Denomenator_2014) = 0 Then
                                For bytCount As Integer = 0 To bytRowCount - 1
                                    C1QualityMeasures.Rows(intCQMCount + (bytCount * -1)).Visible = False
                                Next
                            End If
                        End If
                    End If
    ...
    Private Sub SelectAll()
        ...
        For intCQMCount As Integer = 0 To C1QualityMeasures.Rows.Count - 1
            ...
            If C1QualityMeasures.Rows(intCQMCount).Visible = True Then
                'If intCQMCount = ROW_NQF0064_2014 Then
...
#Region "RetriveDataFromMultipleServer"
    ...
    Public Function RetriveData_RxNormDIB_QRDAIII(ByVal SPName As String, Optional ByVal HistoryItemList As String = "", Optional ByVal CQM2014 As Boolean = False, Optional ByVal ResultTVP1 As DataTable = Nothing, Optional PatientID As Int64 = 0) As DataSet
...
#Region "Cell Button Click Event"
    ...
    Private Sub C1QualityMeasures_BeforeEdit(ByVal sender As Object, ByVal e As C1.Win.C1FlexGrid.RowColEventArgs) Handles C1QualityMeasures.BeforeEdit
        If e.Col = COL_Check Then
            'If e.Row = ROW_NQF0064_2014 Then
            '    e.Cancel = True
            'Else
            Dim checkval As C1.Win.C1FlexGrid.CheckEnum
...
#End Region
        ...
        If (GenerateMessagefor2014()) Then
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_NQF0002_MU2_2017")
                ...
                dsData = RetriveData_RxNormDIB_QRDAIII("MU_NQF0002_MU2_2017", "", True, resultTVP1, PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0018_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Dim resultTVP1 As DataTable = Nothing
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_NQF0028_MU2_2017")
                    If Not IsNothing(resultSet) Then
                        If Not IsNothing(resultSet.MarketedProductIdSet1) Then
                            resultTVP1 = cls_DAL_MU_Detail_Report.ConvertToDataTable(resultSet.MarketedProductIdSet1)
                        End If
                    End If
                End Using
                dsData = RetriveData_RxNormDIB_QRDAIII("MU_NQF0028_MU2_2017", "", True, resultTVP1, PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0031_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0032_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_NQF0033_MU2_2017")
                    If Not IsNothing(resultSet) Then
                        If Not IsNothing(resultSet.MarketedProductIdSet1) Then
                            resultTVP1 = cls_DAL_MU_Detail_Report.ConvertToDataTable(resultSet.MarketedProductIdSet1)
                        End If
                ...
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0033_MU2_2017", "", True, False, resultTVP1, resultTVP2, PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0034_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0038_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0041_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Dim resultTVP1 As DataTable = Nothing
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_CMSID22_MU2_2017")
                    If Not IsNothing(resultSet) Then
                        If Not IsNothing(resultSet.MarketedProductIdSet1) Then
                            resultTVP1 = cls_DAL_MU_Detail_Report.ConvertToDataTable(resultSet.MarketedProductIdSet1)
                        End If
                    End If
                End Using
                dsData = CalculatePercent_ds_ORDAIII("MU_CMSID22_MU2_2017", "", True, False, resultTVP1, , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0043_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0052_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0055_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0056_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0059_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Dim resultTVP1 As DataTable = Nothing
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_NQF0062_MU2_2017")
                    If Not IsNothing(resultSet) Then
                        If Not IsNothing(resultSet.MarketedProductIdSet1) Then
                            resultTVP1 = cls_DAL_MU_Detail_Report.ConvertToDataTable(resultSet.MarketedProductIdSet1)
                        End If
                    End If
                End Using
                dsData = RetriveData_RxNormDIB_QRDAIII("MU_NQF0062_MU2_2017", "", True, resultTVP1, PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0064_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_NQF0068_MU2_2017")
                    If Not IsNothing(resultSet) Then
                        If Not IsNothing(resultSet.MarketedProductIdSet1) Then
                            resultTVP1 = cls_DAL_MU_Detail_Report.ConvertToDataTable(resultSet.MarketedProductIdSet1)
                        End If
                    ...
                    End If
                End Using
                'dsData = RetriveData_RxNormDIB_QRDAIII("MU_NQF0068_MU2_2017", "", True, resultTVP1, PatientID)
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0068_MU2_2017", "", True, False, resultTVP1, resultTVP2, PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0101_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Dim resultTVP2 As DataTable = Nothing
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_NQF0421_MU2_2017")
                    If Not IsNothing(resultSet) Then
                        If Not IsNothing(resultSet.MarketedProductIdSet1) Then
                            resultTVP1 = cls_DAL_MU_Detail_Report.ConvertToDataTable(resultSet.MarketedProductIdSet1)
                        End If
                ...
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0421_MU2_2017", "", True, False, resultTVP1, resultTVP2, PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_CMSID125_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_CMSID66_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_CMSID56_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Dim resultTVP2 As DataTable = Nothing
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_NQF00418_MU2_2017")
                    If Not IsNothing(resultSet) Then
                        If Not IsNothing(resultSet.MarketedProductIdSet1) Then
                            resultTVP1 = cls_DAL_MU_Detail_Report.ConvertToDataTable(resultSet.MarketedProductIdSet1)
                        End If
                    ...
                    End If
                End Using
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF00418_MU2_2017", "", True, False, resultTVP1, resultTVP2, PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0419_MU2_2017", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_CMSID90_MU2_2017", "", True, , , , PatientID)
    ...
    Private Sub GenerateReport()
        ...
        Try
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = RetriveDataFromMultipleServer_ds("MU_NQF0002_MU2")
                If IsNothing(dsData.Tables("Count")) = False Then
    ...
    Private Sub tsp_QRDAIII_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles tsp_QRDAIII.Click
        ...
        Try
            If dtpicStartDate.Value.Year = 2017 AndAlso dtpicEndDate.Value.Year = 2017 Then
                If IsReportGenerated() Then
                    SaveFileDialogXML.FileName = Nothing
                    SaveFileDialogXML.Filter = "XML Files (*.xml)|*.xml|XSL Files (*.xsl)|*.xsl|All files(*.*)|*.*"
                ...
                End If
            Else
                MessageBox.Show("Please select the 2017 Reporting Period.", _MessageBoxCaption, MessageBoxButtons.OK, MessageBoxIcon.Warning)
            End If
        Catch ex As Exception
    ...
    Private Sub tsp_ExportQRDAI_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsp_ExportQRDAI.Click
                        ...
                        If strFilePath <> "" Then
                            ...
                            If Not IsNothing(dtDistinct) AndAlso dtDistinct.Rows.Count > 0 Then
                                For i As Integer = 0 To dtDistinct.Rows.Count - 1
                                    ...
                                    gloCDAWriter._IsFromoldVersion = True
        ...
        Catch ex As Exception
            MessageBox.Show(ex.ToString, _MessageBoxCaption, MessageBoxButtons.OK, MessageBoxIcon.Error)
        Finally
            gloCDAWriter._IsFromoldVersion = False
            If Not IsNothing(oCDADataExtraction) Then
                oCDADataExtraction.Dispose()
                oCDADataExtraction = Nothing
            End If
    ...
    Private Function GetQRDAIData(ByVal dtMeasureList As DataTable, ByVal dtPatientList As DataTable, dtMeasurementStartDate As Date, dtMeasurementEndDate As Date) As DataTable
        ...
        Try
            ...
            Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                ...
                Dim _cqmMeasure As String = "MU2_GenerateQRDAI_V2_2017"
            ...
            oDB.Retrive("MU2_GenerateQRDAI_V2_2017", oParameters, dt)
