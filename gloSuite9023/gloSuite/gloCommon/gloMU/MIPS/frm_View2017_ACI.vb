...
#End Region
    ...
    Private Sub frmViewMUDashboard_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            CustomGridStyle()
            dv = objclsMeasures.Fill2017ACIMeasures()
    ...
    Private Sub AddMeasure()
        Try
            Dim objfrmMeasures As New gloMU.frm_2017_ACI()
            ' Dim ID As Int64

            With objfrmMeasures
                .Text = "PI TRANSITION Dashboard"
                .mycaller = Me
            ...
            'objfrmMeasures.StartPosition = FormStartPosition.CenterParent
            'objfrmMeasures.ShowDialog(IIf(IsNothing(objfrmMeasures.Parent), Me, objfrmMeasures.Parent))
            'If Not IsNothing(objfrmMeasures) Then
            '    objfrmMeasures.Dispose()
            '    objfrmMeasures = Nothing
            'End If
    ...
    Private Sub UpdateMeasure()
        ...
        Try
            If C1MUDashboard.Row >= 1 Then
                ...
                ' objfrmMU.StartPosition = FormStartPosition.CenterParent
                'objfrmMU.WindowState = FormWindowState.Maximized
                'objfrmMU.ShowDialog(IIf(IsNothing(objfrmMU.Parent), Me, objfrmMU.Parent))
                'If Not IsNothing(objfrmMU) Then
                '    objfrmMU.Dispose()
                '    objfrmMU = Nothing
                'End If
        ...
        Try
            ...
            If C1MUDashboard.Row >= 1 Then
                ...
                If MessageBox.Show("Do you want to delete selected Report?", _MessageBoxCaption, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = DialogResult.Yes Then
                    objclsMeasures.DeleteMeasures2017ACI(ID)
                    txtSearch.ResetText()
                    ...
                    C1MUDashboard.DataSource = objclsMeasures.Fill2017ACIMeasures()
    ...
    Private Sub On_frmMU_Closed(ByVal sender As Object, ByVal e As FormClosedEventArgs)
        Dim frm As gloMU.frm_MU_Dashboard_Stage2 = Nothing

        Try
            frm = DirectCast(sender, gloMU.frm_MU_Dashboard_Stage2)
        Catch ex As Exception
