...
Public Class frm_MIPSQuality_Reports_2019
    ...
    'Private ROW_NQF0031_2014 As Integer = ROW_NQF0031_2014 + 3 '10
    Private ROW_NQF0032_2014 As Integer = ROW_NQF0028_2014 + 7 '13
    Private ROW_NQF0033_2014 As Integer = ROW_NQF0032_2014 + 3 '16
    Private ROW_NQF0034_2014 As Integer = ROW_NQF0033_2014 + 3 '19
    Private ROW_NQF0038_2014 As Integer = ROW_NQF0034_2014 + 3 '22
    Private ROW_NQF0041_2014 As Integer = ROW_NQF0038_2014 + 3 '25
    Private ROW_NQF0043_2014 As Integer = ROW_NQF0041_2014 + 3 '28

    Private ROW_NQF0055_2014 As Integer = ROW_NQF0043_2014 + 3 '25
    'Private ROW_NQF0056_2014 As Integer = ROW_NQF0055_2014 + 3 '28
    Private ROW_NQF0059_2014 As Integer = ROW_NQF0055_2014 + 3 '31
    Private ROW_NQF0062_2014 As Integer = ROW_NQF0059_2014 + 3 '34    
    'Private ROW_NQF0068_2014 As Integer = ROW_NQF0062_2014 + 3 '40
    Private ROW_NQF0101_2014 As Integer = ROW_NQF0062_2014 + 3 '43
    Private ROW_NQF0418_2014 As Integer = ROW_NQF0101_2014 + 3 '46
    Private ROW_NQF0419_2014 As Integer = ROW_NQF0418_2014 + 3 '49
    Private ROW_NQF0421_2014 As Integer = ROW_NQF0419_2014 + 3 '52 Multiple IPP

    Private ROW_NQF_CMSID22_2014 As Integer = ROW_NQF0421_2014 + 3 '66
    Private ROW_NQF_CMSID56_2014 As Integer = ROW_NQF_CMSID22_2014 + 3 '69
    Private ROW_NQF_CMSID66_2014 As Integer = ROW_NQF_CMSID56_2014 + 3 '72
    Private ROW_NQF_CMSID90_2014 As Integer = ROW_NQF_CMSID66_2014 + 3 '75
    Private ROW_NQF_CMSID125_2014 As Integer = ROW_NQF_CMSID90_2014 + 3 '78
    ...
    Dim sReportingYear As String = "2019"
    ...
    Private Sub GetReportingPeriod(ProviderID As Long, ByRef StartDate As Date, ByRef EndDate As Date)
        ...
        Try
            ...
            If dsMain.Tables(0).Rows.Count = 0 Then
                StartDate = New Date(DateTime.Now.Year, 1, 1)
                EndDate = New Date(DateTime.Now.Year, 12, 31)
            Else
    ...
    Private Sub FillGridCQM2014()
        ...
        C1QualityMeasures.Rows.Add(66) '79
        ...
        C1QualityMeasures.SetData(ROW_NQF0043_2014, COL_CoreMeasure_2014, "CMS127: Pneumonia Vaccination Status for Older Adults")
        ...
        ''NQF0056  as this is removed in 2019
        ...
        C1QualityMeasures.SetData(ROW_NQF_CMSID22_2014 + 1, COL_CoreMeasure_2014, Space(3) & "Population 1: All patients aged 18 years and older at the beginning of the measurement period with at least one eligible encounter during the measurement period.")
        ...
        C1QualityMeasures.SetData(ROW_NQF_CMSID56_2014 + 1, COL_CoreMeasure_2014, Space(3) & "Population 1: Patients 19 years of age and older who had a primary total hip arthroplasty (THA) in the year prior to the measurement period and who had an outpatient encounter during the measurement period.")
        ...
        C1QualityMeasures.SetData(ROW_NQF_CMSID66_2014 + 1, COL_CoreMeasure_2014, Space(3) & "Population 1: Patients 19 years of age and older who had a primary total knee arthroplasty (TKA) in the year prior to the measurement period and who had an outpatient encounter during the measurement period.")
...
#Region "RetriveDataFromMultipleServer"
    ...
    Public Function RetriveData_RxNormDIB_QRDAIII(ByVal SPName As String, Optional ByVal HistoryItemList As String = "", Optional ByVal CQM2014 As Boolean = False, Optional ByVal ResultTVP1 As DataTable = Nothing, Optional PatientID As Int64 = 0) As DataSet
        ...
        Try
            ...
            If SPName = "MU_NQF0028_MU2_2019" Then
                populationCount = 3
            Else
                populationCount = 1
            End If
                    ...
                    If dt.Rows.Count > 0 Then
                        ...
                        For k = 0 To dt.Rows.Count - 1
                            ...
                            Else
                                ...
                                If CQM2014 = True Then
                                    deno = Convert.ToInt64(dt.Rows(0)("Denominator")) - Convert.ToInt64(dt.Rows(0)("Exclusion")) - Convert.ToInt64(dt.Rows(0)("Exception"))  ''denominator-exclusion
                                End If
                                If deno = 0 Then
                                    dt.Rows(0)("CQMPercentage") = "N/A"
                                Else
...
#End Region
        ...
        If (GenerateMessagefor2014()) Then
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_NQF0002_MU2_2019")
                ...
                dsData = RetriveData_RxNormDIB_QRDAIII("MU_NQF0002_MU2_2019", "", True, resultTVP1, PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0018_MU2_2019", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Dim resultTVP1 As DataTable = Nothing
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_NQF0028_MU2_2019")
                    If Not IsNothing(resultSet) Then
                        If Not IsNothing(resultSet.MarketedProductIdSet1) Then
                            resultTVP1 = cls_DAL_MU_Detail_Report.ConvertToDataTable(resultSet.MarketedProductIdSet1)
                        End If
                    End If
                End Using
                dsData = RetriveData_RxNormDIB_QRDAIII("MU_NQF0028_MU2_2019", "", True, resultTVP1, PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0032_MU2_2019", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_NQF0033_MU2_2019")
                    If Not IsNothing(resultSet) Then
                        If Not IsNothing(resultSet.MarketedProductIdSet1) Then
                            resultTVP1 = cls_DAL_MU_Detail_Report.ConvertToDataTable(resultSet.MarketedProductIdSet1)
                        End If
                ...
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0033_MU2_2019", "", True, False, resultTVP1, resultTVP2, PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0034_MU2_2019", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0038_MU2_2019", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0041_MU2_2019", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    ...
                    End If
                End Using
                dsData = CalculatePercent_ds_ORDAIII("MU_CMSID22_MU2_2019", "", True, False, resultTVP1, , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0043_MU2_2019", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0055_MU2_2019", "", True, , , , PatientID)
            ...
            '    Application.DoEvents()
            '    dsData = Nothing
            '    dsData = CalculatePercent_ds_ORDAIII("MU_NQF0056_MU2_2019", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0059_MU2_2019", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Dim resultTVP1 As DataTable = Nothing
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_NQF0062_MU2_2019")
                    If Not IsNothing(resultSet) Then
                        If Not IsNothing(resultSet.MarketedProductIdSet1) Then
                            resultTVP1 = cls_DAL_MU_Detail_Report.ConvertToDataTable(resultSet.MarketedProductIdSet1)
                        End If
                    End If
                End Using
                dsData = RetriveData_RxNormDIB_QRDAIII("MU_NQF0062_MU2_2019", "", True, resultTVP1, PatientID)
            ...
            '    Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
            '        resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_NQF0068_MU2_2019")
            '        If Not IsNothing(resultSet) Then
            '            If Not IsNothing(resultSet.MarketedProductIdSet1) Then
            '                resultTVP1 = cls_DAL_MU_Detail_Report.ConvertToDataTable(resultSet.MarketedProductIdSet1)
            '            End If
            ...
            '    dsData = CalculatePercent_ds_ORDAIII("MU_NQF0068_MU2_2019", "", True, False, resultTVP1, resultTVP2, PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0101_MU2_2019", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Dim resultTVP2 As DataTable = Nothing
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_NQF0421_MU2_2019")
                    If Not IsNothing(resultSet) Then
                        If Not IsNothing(resultSet.MarketedProductIdSet1) Then
                            resultTVP1 = cls_DAL_MU_Detail_Report.ConvertToDataTable(resultSet.MarketedProductIdSet1)
                        End If
                ...
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0421_MU2_2019", "", True, False, resultTVP1, resultTVP2, PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_CMSID125_MU2_2019", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_CMSID66_MU2_2019", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_CMSID56_MU2_2019", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Dim resultTVP2 As DataTable = Nothing
                Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                    resultSet = ogloGSHelper.CQMServiceCallGSDD("MU_NQF00418_MU2_2019")
                    If Not IsNothing(resultSet) Then
                        If Not IsNothing(resultSet.MarketedProductIdSet1) Then
                            resultTVP1 = cls_DAL_MU_Detail_Report.ConvertToDataTable(resultSet.MarketedProductIdSet1)
                        End If
                    ...
                    End If
                End Using
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF00418_MU2_2019", "", True, False, resultTVP1, resultTVP2, PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_NQF0419_MU2_2019", "", True, , , , PatientID)
            ...
            If checkval = C1.Win.C1FlexGrid.CheckEnum.Checked Then
                ...
                Application.DoEvents()
                dsData = Nothing
                dsData = CalculatePercent_ds_ORDAIII("MU_CMSID90_MU2_2019", "", True, , , , PatientID)
    ...
    Private Sub tsp_QRDAIII_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles tsp_QRDAIII.Click
        ...
        mPatient = oPatient
        Try
            If dtpicStartDate.Value.Year = 2019 AndAlso dtpicEndDate.Value.Year = 2019 Then
                Dim dtProviders As DataTable
                ...
                If IsReportGenerated() Then
                    ...
                    If Not IsNothing(mPatient.PatientProviders) AndAlso mPatient.PatientProviders.Count > 0 Then
                        ...
                        'loop to check if each provider hastax identification number or not.

                        For Each row As DataRow In dtProviders.Rows

                            If DirectCast(mPatient.PatientProviders.Item(icnt), gloCCDLibrary.PatientProvider).ProvTaxID = "" Then
                ...
                End If
            Else
                MessageBox.Show("Please select the 2019 Reporting Period.", _MessageBoxCaption, MessageBoxButtons.OK, MessageBoxIcon.Warning)
            End If
        Catch ex As Exception
                        ...
                        If strFilePath <> "" Then
                            ...
                            If Not IsNothing(dtDistinct) AndAlso dtDistinct.Rows.Count > 0 Then
                                For i As Integer = 0 To dtDistinct.Rows.Count - 1
                                    ...
                                    mStrXMLfile = oCDADataExtraction.GenerateQRDAIInformation(dtDistinct.Rows(i)("nPatientID"), _UserID, dtpicStartDate.Value.ToString(), dtpicEndDate.Value.ToString(), dtCount, dvQRDA1Data.ToTable, strFilePath, False, _ReportingYear:=sReportingYear)
    ...
    Private Function GetQRDAIData(ByVal dtMeasureList As DataTable, ByVal dtPatientList As DataTable, dtMeasurementStartDate As Date, dtMeasurementEndDate As Date) As DataTable
        ...
        Try
            ...
            Using ogloGSHelper As New gloGlobal.DIB.gloGSHelper(gloEMRGeneralLibrary.gloGeneral.clsgeneral.sDIBServiceURL)
                ...
                Dim _cqmMeasure As String = "MU2_GenerateQRDAI_V2_2019"
            ...
            oDB.Retrive("MU2_GenerateQRDAI_V2_2019", oParameters, dt)
            ...
            Dim ocls_general As New cls_MU_General
            ocls_general.UpdateLog("MU2_GenerateQRDAI_V2_2019")
            ocls_general = Nothing
