...
Public Class cls_MU_Measures_Stage3
    ...
    Public Function FillMUMeasures()
        ...
        Try
            ...
            oDB.Retrive("MU_FillMeasures_MST_Stage3", dt)
            oDB.Disconnect()
    ...
    '        oDB.Connect(False)
    '        oDB.Retrive("MU_FillMeasures_MST_Stage3", dt)  ''MU_FillMeasures_MST_Stage1
    '        oDB.Disconnect()
    ...
    Public Function FillMUMeasures_Stage3(Optional ByVal ReportingYear As Integer = 0)
        ...
        Try
            ...
            oDB.Retrive("MU_FillMeasures_MST_Stage3", oParameters, dt)  ''MU_FillMeasures_MST_Stage2
            oDB.Disconnect()
    ...
    '27-Aug-13 Aniket: Creation of a new Dashboard for Stage 2
    Public Sub DeleteMeasures_Stage3(ByVal nReportID As Long, Optional ByVal ReportingYear As Integer = 0)
        ...
        Try
            ...
            oDB.Execute("MU_DeleteMeasures_Stage3", oParameters) ''MU_DeleteMeasures_Stage2
            oDB.Disconnect()
