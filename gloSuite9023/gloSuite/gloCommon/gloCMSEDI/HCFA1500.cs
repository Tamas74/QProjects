...
namespace gloCMSEDI
{
    ...
    public partial class HCFA1500 : UserControl
    {
        ...
        public HCFA1500(String DatabaseConnectionString)
        {
...
*/
        ...
        /// <summary>
        /// Created By Pankaj Bedse 04012010 (for Filling the Readonly Panel)
        /// </summary>
        /// <param name="ServiceLinesCount"></param>
        public void FillReadOnlyPanelForm(int ServiceLinesCount)
        {
            // --------------------------------------------------------------------------
            // Code added by pankaj Bedse on 12012010
            // To clear all the content of previous transaction, before filling
            ClearForm(pnlMainFormLabel);
            // --------------------------------------------------------------------------
            
            //Comment From MAHESH Nawal 20100110 To test Checkin
            // Payer Name & Address
            ...
            if ((dtpPatientDOB.Checked) && (dtpPatientDOB.Enabled))
            {
                ...
                lblPatientDOB_YY.Text = dtPatientDOB.ToString("yy");
            }
            else
            {
            ...
            // Block 8
            if (chkPatientStatus_Single.Checked) { lblPatientStatus_Single.Text = "X"; } else { lblPatientStatus_Single.Text = string.Empty; }
            if (chkPatientStatus_Married.Checked) { lblPatientStatus_Married.Text = "X"; } else { lblPatientStatus_Married.Text = string.Empty; }
            if (chkPatientStatus_Other.Checked) { lblPatientStatus_Other.Text = "X"; } else { lblPatientStatus_Other.Text = string.Empty; }
            if (chkPatientStatus_Employed.Checked) { lblPatientStatus_Employed.Text = "X"; } else { lblPatientStatus_Employed.Text = string.Empty; }
            if (chkPatientStatus_FullTimeStudent.Checked) { lblPatientStatus_FullTimeStudent.Text = "X"; } else { lblPatientStatus_FullTimeStudent.Text = string.Empty; }
            if (chkPatientStatus_PartTimeStudent.Checked) { lblPatientStatus_PartTimeStudent.Text = "X"; } else { lblPatientStatus_PartTimeStudent.Text = string.Empty; }
            ...
            // 9.b
            if ((dtpOtherInsuredDOB.Checked) && (dtpOtherInsuredDOB.Enabled))
            {
                DateTime dtOtherInsuredDOB = (DateTime)Convert.ToDateTime(dtpOtherInsuredDOB.Value);
                lblOtherInsuredDOB_MM.Text = dtOtherInsuredDOB.ToString("MM");
                lblOtherInsuredDOB_DD.Text = dtOtherInsuredDOB.ToString("dd");
                lblOtherInsuredDOB_YY.Text = dtOtherInsuredDOB.ToString("yy");
            }
            else
            {
                lblOtherInsuredDOB_MM.Text = string.Empty;
                lblOtherInsuredDOB_DD.Text = string.Empty;
                lblOtherInsuredDOB_YY.Text = string.Empty;
            }
            if (chkOtherInsuredSex_Male.Checked) { lblOtherInsuredSex_Male.Text = "X"; } else { lblOtherInsuredSex_Male.Text = string.Empty; }
            if (chkOtherInsuredSex_Female.Checked) { lblOtherInsuredSex_Female.Text = "X"; } else { lblOtherInsuredSex_Female.Text = string.Empty; }
            // 9.c
            ...
            if ((dtpInsuredsDOB.Checked) && (dtpInsuredsDOB.Enabled))
            {
                ...
                lblInsuredsDOB_YY.Text = dtInsuredDOB.ToString("yy");
            }
            else
            {
            ...
            if ((dtpPatientSignDate.Checked) && (dtpPatientSignDate.Enabled))
            {
                ...
                lblPatientSignDate_MM.Text = dtPatientSignDate.ToString("MM/dd/yyyy");
            ...
            if ((dtpDateOfCurrentIllness.Checked) && (dtpDateOfCurrentIllness.Enabled))
            {
                ...
                lblDateOfCurrentIllness_YY.Text = dtDateOfCurrentIllness.ToString("yy");
            }
            else
            {
            ...
            if ((dtpSimilarIllnessFirstDate.Checked) && (dtpSimilarIllnessFirstDate.Enabled))
            {
                ...
                lblSimilarIllnessFirstDate_YY.Text = dtSimilarIllnessFirstDate.ToString("yy");
            }
            else
            {
            ...
            if ((dtpUnableToWorkFrom.Checked) && (dtpUnableToWorkFrom.Enabled))
            {
                ...
                lblUnableToWorkFrom_YY.Text = dtUnableToWorkFromDate.ToString("yy");
            }
            else
            {
            ...
            if ((dtpUnableToWorkTill.Checked) && (dtpUnableToWorkTill.Enabled))
            {
                ...
                lblUnableToWorkTill_YY.Text = dtUnableToWorkToDate.ToString("yy");
            }
            else
            {
            ...
            if ((dtpHospitalisationFrom.Checked) && (dtpHospitalisationFrom.Enabled))
            {
                ...
                lblHospitalisationFrom_YY.Text = dtHospitalisationFromDate.ToString("yy");
            }
            else
            {
            ...
            if ((dtpHospitalisationTo.Checked) && (dtpHospitalisationTo.Enabled))
            {
                ...
                lblHospitalisationTo_YY.Text = dtHospitalisationToDate.ToString("yy");
            }
            else
            {
            ...
            // Block 27
            if (chkAcceptAssignment_Yes.Checked) { lblAcceptAssignment_Yes.Text = "X"; } else { lblAcceptAssignment_Yes.Text = string.Empty; }            if (chkAcceptAssignment_Yes.Checked) { lblAcceptAssignment_Yes.Text = "X"; } else { lblAcceptAssignment_Yes.Text = string.Empty; }
            ...
            // Block 30
            lblBalanceDue.Text = txtBalanceDue.Text;
            lblBalanceDue2.Text = txtBalanceDue2.Text;
            ...
            if ((dtpPhysicianSignDate.Checked) && (dtpPhysicianSignDate.Enabled))
            {
                ...
                lblPhysicianSignDate_MM.Text = dtPhysicianSignDate.ToString("MM/dd/yyyy");
                //lblPhysicianSignDate_DD.Text = dtPhysicianSignDate.ToString("dd");
                //lblPhysicianSignDate_YY.Text = dtPhysicianSignDate.ToString("yy");
            }
            else
            {
        ...
        /// <summary>
        /// Added by Pankaj Bedse on 12012010
        ...
        public void FillTransactionOnForm_Old(Int64 TransactionId)
        {
            /*
            // --------------------------------------------------------------------------
            // Code added by pankaj Bedse on 12012010
            ...
            try
            {
                if (TransactionId > 0)
                {
                    ...
                    if (oTransaction != null)
                    {
                        ...
                        if (IsNotesInBox19(_ContactID) == false)
                        {
                            IsNotesInLines = true;
                        }
                        else
                        ...
                        if (_BillingAddressType == AddressType.ProviderAddress)
                        {
                            txtBillingProviderInfo.Text = oTranDetails.HCFA_ProviderFName.Trim() + " "
                                  ...
                                  + Environment.NewLine + oTranDetails.HCFA_ProviderAddress1.Trim() + " " + oTranDetails.HCFA_ProviderAddress2.Trim() + Environment.NewLine +
                        ...
                        {
                            txtBillingProviderInfo.Text = oTranDetails.HCFA_FacilityName.Trim() + Environment.NewLine + oTranDetails.HCFA_FacilityAddress1.Trim() + " " + oTranDetails.HCFA_FacilityAddress2.Trim() + Environment.NewLine +
                                    oTranDetails.HCFA_FacilityCity.Trim() + " " + oTranDetails.HCFA_FacilityState.Trim() + " " +
                                    oTranDetails.HCFA_FacilityZip.Trim();


                            if (oTranDetails.HCFA_FacilityPhone.Trim() != "")
                            {
                                txtBillingProviderPhone1.Text = oTranDetails.HCFA_FacilityPhone.Trim().Substring(0, 3);
                                txtBillingProviderPhone2.Text = oTranDetails.HCFA_FacilityPhone.Trim().Substring(3, oTranDetails.HCFA_FacilityPhone.Trim().Length - 3);
                            }

                        }
                        else if (_BillingAddressType == AddressType.ClinicAddress)
                        {
                            txtBillingProviderInfo.Text = _ClinicName.Trim() + Environment.NewLine + _ClinicAddress.Trim() + Environment.NewLine +
                                    _ClinicCity.Trim() + " " + _ClinicState.Trim() + " " +
                                    _ClinicZip.Trim();

                            if (_ClinicPhone.Trim() != "")
                            {
                                txtBillingProviderPhone1.Text = _ClinicPhone.Trim().Substring(0, 3);
                                txtBillingProviderPhone2.Text = _ClinicPhone.Trim().Substring(3, _ClinicPhone.Trim().Length - 3);
                            }
                        }
                        ...
                        else if (_Billing_A_NPI == NPIType.FacilityNPI)
                        {
                            txtBillingProv_a_NPI.Text = oTranDetails.HCFA_FacilityNPI.Trim();
                        }
                        else if (_Billing_A_NPI == NPIType.ClinicNPI)
                        {
                            txtBillingProv_a_NPI.Text = _ClinicNPI.Trim();
                        }
                        ...
                        //MaheshB 20091224 From gloPM1.1.
                        ...
                        if (_PayerName.Trim() != "")
                        {
                            txtPayerNameAndAddress.Text = _PayerName.Trim() + Environment.NewLine;
                        }
                        if (_PayerAddress.Trim() != "")
                        {
                            txtPayerNameAndAddress.Text += _PayerAddress.Trim() + Environment.NewLine;
                        }
                        if (_PayerAddress2 != "")
                        {
                            txtPayerNameAndAddress.Text += _PayerAddress2.Trim() + Environment.NewLine;
                        }
                        ...
                        if (oTransaction.OutSideLabCharges.ToString().Trim() != "")
                        {
                        ...
                        if (_FacilityAddressType == AddressType.FacilityAddress)
                        {
                            txtFacilityInfo.Text = oTranDetails.HCFA_FacilityName.Trim() + Environment.NewLine + oTranDetails.HCFA_FacilityAddress1.Trim() + " " + oTranDetails.HCFA_FacilityAddress2.Trim() + Environment.NewLine +
                            oTranDetails.HCFA_FacilityCity.Trim() + " " + oTranDetails.HCFA_FacilityState.Trim() + " " +
                            oTranDetails.HCFA_FacilityZip.Trim();

                        }
                        else if (_FacilityAddressType == AddressType.ProviderAddress)
                        {
                            txtFacilityInfo.Text = oTranDetails.HCFA_ProviderFName.Trim() + " "
                                  + oTranDetails.HCFA_ProviderMName.Trim() + " " + oTranDetails.HCFA_ProviderLName.Trim()
                                  + Environment.NewLine + oTranDetails.HCFA_ProviderAddress1.Trim() + " " + oTranDetails.HCFA_ProviderAddress2.Trim() + Environment.NewLine +
                                  oTranDetails.HCFA_ProviderCity.Trim() + " " + oTranDetails.HCFA_ProviderState.Trim() + "   " +
                                  oTranDetails.HCFA_ProviderZip.Trim();
                        ...
                        else if (_FacilityAddressType == AddressType.ClinicAddress)
                        {
                            txtFacilityInfo.Text = _ClinicName.Trim() + Environment.NewLine + _ClinicAddress.Trim() + Environment.NewLine +
                                    _ClinicCity.Trim() + " " + _ClinicState.Trim() + " " +
                                    _ClinicZip.Trim();

                        }

                        if (_Facility_A_NPI == NPIType.FacilityNPI)
                        {
                            txtFacility_a_NPI.Text = oTranDetails.HCFA_FacilityNPI.Trim();
                        }
                        else if (_Facility_A_NPI == NPIType.BillingProviderNPI)
                        {
                            txtFacility_a_NPI.Text = oTranDetails.HCFA_ProviderNPI.Trim();
                        }
                        else if (_Facility_A_NPI == NPIType.ClinicNPI)
                        {
                            txtFacility_a_NPI.Text = _ClinicNPI.Trim();
                        }

                        if (oTranDetails.HCFA_FacilityID != "")
                        {
                            txtFacilityCode.Tag = Convert.ToInt64(oTranDetails.HCFA_FacilityID);
                        }
                        //code Added by Mayuri:20091123
                        //if Insurance Type is medicare then default address shouldn't display
                        ...
                        //}
                        //End code added by Mayuri:20091123

                        Int64 temp = _PatientInsuranceID;
                        Int64 tem1p = Convert.ToInt64(txtInsuredInsurancePlanName.Tag);
                        //Int64 temp = Convert.ToInt64(oTransaction.Insurances[0].InsuranceID);
                        ...
                        try
                        {
                            string _sqlquery1 = "select ISNULL(nPOSID,0) as nPOSID from BL_Facility_MST where sFacilityCode='" + oTransaction.FacilityCode + "'";
                        ...
                        if (_POS.Trim() == "11")
                        { //Check Plan Settings.                
                            string _sqlquery = "Select ISNULL(sIncludeFacilitieswithPOS11onClaim,'') as sIncludeFacilitieswithPOS11onClaim from Contacts_Insurance_DTL  where nContactID='" + _ContactID + "'";
                            //gloDatabaseLayer.DBLayer oDB = null;
                            try
                            {
                                oDB = new gloDatabaseLayer.DBLayer(_databaseconnectionstring);
                                ...
                                if (dt != null && dt.Rows.Count > 0)
                                {
                                    ...
                                    { //If No settings for Plan check Admin Settings.
                                        _sqlquery = "";
                                        _sqlquery = "Select sSettingsValue from settings where sSettingsName='IncludeFacilitieswithPOS11onClaim' and nClinicID='" + _ClinicID + "'";
                        ...
                        {
                            //dtpPatientSignDate.Value = _dtSignatureOnFileDate; //gloDateMaster.gloDate.DateAsDate(oTransaction.TransactionDate);
                        ...
                        {
                            //dtpPatientSignDate.Value = DateTime.Now;
                        ...
                        //txtInsuredPersonSign.Text = _InsuredPersonSign.ToUpper();  //"SIGNATURE ON FILE OR PAY TO SUBSCRIBER";
                        ...
                        GetReferralProvider(oTransaction.PatientID, oTransaction.TransactionID);
                        ...
                        // Else condtion added by Pankaj Bedse on 23012010
                        else
                        {
                        ...
                        if (oTransaction.MaritalStatus!=null && Convert.ToString(oTransaction.MaritalStatus) != "")
                        {
                            GetPatientStatusSettings(oTransaction.MaritalStatus);
                        }

                        if (_strPatientStatus == "Single")
                        {
                            chkPatientStatus_Single.Checked = true;
                        }
                        else if (_strPatientStatus == "Married")
                        {
                        ...
                        {
                            txtPatientAccountNo.Text = oTransaction.ClaimNo.ToString("00000");
                        }
                        else
                        {
                            txtPatientAccountNo.Text = oTranDetails.HCFA_PatientCode.Trim();
                            ...
                            for (int k = 0; k < dtDx.Rows.Count; k++)
                            {
                                ...
                                if (k == 0)
                                {
                                    if (Dx.Length > 0)
                                    {
                                        if (Dx.Length > 1)
                                        {
                                            txtDiagnosisCode11.Text = Dx[0];
                                            txtDiagnosisCode12.Text = Dx[1];
                                        }
                                        else
                                        {
                                            txtDiagnosisCode11.Text = Dx[0];
                                ...
                                if (k == 1)
                                {
                                    if (Dx.Length > 0)
                                    {
                                        if (Dx.Length > 1)
                                        {
                                            txtDiagnosisCode21.Text = Dx[0];
                                            txtDiagnosisCode22.Text = Dx[1];
                                        }
                                        else
                                        {
                                            txtDiagnosisCode21.Text = Dx[0];
                                ...
                                if (k == 2)
                                {
                                    if (Dx.Length > 0)
                                    {
                                        if (Dx.Length > 1)
                                        {
                                            txtDiagnosisCode31.Text = Dx[0];
                                            txtDiagnosisCode32.Text = Dx[1];
                                        }
                                        else
                                        {
                                            txtDiagnosisCode31.Text = Dx[0];
                                ...
                                if (k == 3)
                                {
                                    if (Dx.Length > 0)
                                    {
                                        if (Dx.Length > 1)
                                        {
                                            txtDiagnosisCode41.Text = Dx[0];
                                            txtDiagnosisCode42.Text = Dx[1];
                                        }
                                        else
                                        {
                                            txtDiagnosisCode41.Text = Dx[0];
                        ...
                        if (oTransaction.Lines.Count > 0)
                        {
                            ...
                            for (int j = 0; j < oTransaction.Lines.Count; j++)
                            {
                                ...
                                if (j == 0)
                                {
                                    ...
                                    {
                                        if ((oTransaction.Lines[j].Dx1Code.Equals(sDx)) || (oTransaction.Lines[j].Dx2Code.Equals(sDx)) || (oTransaction.Lines[j].Dx3Code.Equals(sDx)) || (oTransaction.Lines[j].Dx4Code.Equals(sDx))) 
                                        {
                                            int iDxPtr = alDiagnosis.IndexOf(sDx)+1;
                                            sbDxPts = sbDxPts.Append(iDxPtr + ",");
                                        }
                                    }
                                    txtDxPtr1.Text = sbDxPts.ToString().TrimEnd(',');
                                    // --------------------------------------
                                ...
                                else if (j == 1)
                                {
                                    ...
                                    txtDxPtr2.Text = sbDxPts.ToString().TrimEnd(',');
                                    // --------------------------------------
                                    // Old Code for Dxpointers
                                    // --------------------------------------
                                    //
                                ...
                                else if (j == 2)
                                {
                                    ...
                                    txtDxPtr3.Text = sbDxPts.ToString().TrimEnd(',');
                                ...
                                else if (j == 3)
                                {
                                    ...
                                    txtDxPtr4.Text = sbDxPts.ToString().TrimEnd(',');
                                ...
                                else if (j == 4)
                                {
                                    ...
                                    txtDxPtr5.Text = sbDxPts.ToString().TrimEnd(',');
                                ...
                                else if (j == 5)
                                {
                                    ...
                                    txtDxPtr6.Text = sbDxPts.ToString().TrimEnd(',');
                                ...
                                //if (Convert.ToString(oTransaction.Lines[_Count].DateServiceFrom) != "")
                                //    {
                                //        //dtpPhysicianSignDate.Value = oTransaction.Lines[j].DateServiceFrom;
                                //        dtpPatientSignDate.Value = oTransaction.Lines[_Count].DateServiceFrom;
                                //    }
                        ...
                        if (IsNotesInLines == false)
                        {
                            if (_sNotes.Trim() != "")
                            {
                                if (_sNotes.Trim().Length > 161)
                                {
                                    txt19ReservedForLocalUse.Text = _sNotes.Trim().Substring(0, 161);
                                }
                                else
                                {
                                    txt19ReservedForLocalUse.Text = _sNotes.Trim();
                                }
                            }
                        }
                        ...
                        {
                            //    if (oTransaction.WorkersCompPrintonCMS1500 == true)
                            //    {
                            //        if (Convert.ToString(oTransaction.WorkersCompNo.Trim()) != "")
                            //        {
                        ...
                        string _NewQuery = " SELECT     ISNULL(SUM(BL_EOBPayment_DTL.nAmount),0) AS TotalPaid FROM " +
                                                                     " BL_EOBPayment_DTL INNER JOIN BL_Transaction_Lines ON " +
                                                                     " BL_EOBPayment_DTL.nBillingTransactionDetailID = BL_Transaction_Lines.nTransactionDetailID " +
                                                                     " WHERE " +
                                                                     " ((BL_EOBPayment_DTL.nPaymentType = 6 AND BL_EOBPayment_DTL.nPaymentSubType = 8  AND BL_EOBPayment_DTL.nPaySign = 2) " +
                                                                     " OR (nPaymentType = 6 AND nPaymentSubType = 13 AND nPaySign = 1)) " +
                                                                     " AND BL_Transaction_Lines.nTransactionID = " + _trnID + " " +
                                                                     " AND BL_Transaction_Lines.nClinicID = " + _ClinicID + " ";
                        oDB.Connect(false);
        ...
        public void FillTransactionOnForm(Int64 TransactionId, Int64 MstTransactionId)
        {
            ...
            try
            {
                if (TransactionId > 0)
                {
                    oTransaction = ogloBilling.GetHCFATransactionDetails(TransactionId,MstTransactionId,_ClinicID);
                    if (oTransaction != null)
                    {
                        decimal TotCharges = 0;
                     //   decimal Sum = 0;
                        ...
                        //    if (oTranDetails.HCFA_ProviderZip.Trim() != "" && oTranDetails.HCFA_ProviderAreaCode.Trim() != "")
                        //    {
                        //        _billingProviderAddress =
                        //              oTranDetails.HCFA_ProviderFName.Trim() + " "
                        //              + oTranDetails.HCFA_ProviderMName.Trim() + " " + oTranDetails.HCFA_ProviderLName.Trim() + " " + oTranDetails.HCFA_ProviderSuffix.Trim()
                        //              + Environment.NewLine + oTranDetails.HCFA_ProviderAddress1.Trim() + " " + oTranDetails.HCFA_ProviderAddress2.Trim() + Environment.NewLine +
                        //              oTranDetails.HCFA_ProviderCity.Trim() + " " + oTranDetails.HCFA_ProviderState.Trim() + "   " +
                        //              oTranDetails.HCFA_ProviderZip.Trim() +"-"+ oTranDetails.HCFA_ProviderAreaCode.Trim();
                        //    }
                        //    else
                        //    {
                        //        _billingProviderAddress =
                        ...
                        //    txtBillingProviderInfo.Text = _billingProviderAddress;
                        ...
                        //else if (_BillingAddressType == AddressType.FacilityAddress)
                        //{
                        //    if (oTranDetails.HCFA_FacilityZip.Trim() != "" && oTranDetails.HCFA_FacilityAreaCode.Trim() != "")
                        //    {
                        //        _billingProviderAddress = oTranDetails.HCFA_FacilityName.Trim() + Environment.NewLine + oTranDetails.HCFA_FacilityAddress1.Trim() + " " + oTranDetails.HCFA_FacilityAddress2.Trim() + Environment.NewLine +
                        //            oTranDetails.HCFA_FacilityCity.Trim() + " " + oTranDetails.HCFA_FacilityState.Trim() + " " +
                        //            oTranDetails.HCFA_FacilityZip.Trim() + "-" + oTranDetails.HCFA_FacilityAreaCode.Trim();
                        //    }
                        //    else
                        //    {
                        //        _billingProviderAddress = oTranDetails.HCFA_FacilityName.Trim() + Environment.NewLine + oTranDetails.HCFA_FacilityAddress1.Trim() + " " + oTranDetails.HCFA_FacilityAddress2.Trim() + Environment.NewLine +
                        ...
                        //    if (_ClinicZip.Trim() != "" && _ClinicAreaCode.Trim() != "")
                        //    { 
                        //        _billingProviderAddress = _ClinicName.Trim() + Environment.NewLine + _ClinicAddress.Trim() + Environment.NewLine +
                        //            _ClinicCity.Trim() + " " + _ClinicState.Trim() + " " +
                        //            _ClinicZip.Trim() +"-"+ _ClinicAreaCode.Trim();
                        //    }
                        //    else
                        //    {
                        //        _billingProviderAddress = _ClinicName.Trim() + Environment.NewLine + _ClinicAddress.Trim() + Environment.NewLine +
                        ...
                        ////////Apply Midlevel Settings................

                        //if (MidLevelBillingProviderID != oTransaction.ProviderID)
                        //{
                        //    //FillMidlevelBillingProvider(MidLevelBillingProviderID,"Provider");

                        //    FillBillingProviderFacility(Convert.ToInt64(oTransaction.ProviderID), Convert.ToInt64(oTranDetails.HCFA_FacilityID), Convert.ToInt64(oTransaction.ContactID), "Billing Provider Source","Provider");
                        //}
                        ...
                        if (_PayerName.Trim() != "")
                        {
                            ...
                            //{
                            //    txtPayerNameAndAddress.Text = _CompanyName.Trim() + Environment.NewLine;
                            //}
                            //else
                            //{ From 5020.2 Hotfix On 20100325
                                txtPayerNameAndAddress.Text = _PayerName.Trim() + Environment.NewLine;
                            //}
                        }
                        if (_PayerAddress.Trim() != "")
                        ...
                        //    if (oTranDetails.HCFA_FacilityZip.Trim() != "" && oTranDetails.HCFA_FacilityAreaCode.Trim() != "")
                        //    {
                        //        txtFacilityInfo.Text += "-"+oTranDetails.HCFA_FacilityAreaCode.Trim();
                        //    }
                        //}
                        //else if (_FacilityAddressType == AddressType.ProviderAddress)
                        //{
                        ...
                        //    if (oTranDetails.HCFA_ProviderZip.Trim() != "" && oTranDetails.HCFA_ProviderAreaCode.Trim() != "")
                        //    {
                        //        txtFacilityInfo.Text += "-" + oTranDetails.HCFA_ProviderAreaCode.Trim();
                        //    }
                        ...
                        //    if (_ClinicZip.Trim() != "" && _ClinicAreaCode.Trim() != "")
                        //    {
                        //        txtFacilityInfo.Text += "-" + _ClinicAreaCode.Trim();
                        //    }
                        //}
                        ...
                        {
                            //for (Int32 cntr = 0; cntr <= oTransaction.Lines.Count - 1; cntr++)
                            //{
                            //    if (oTransaction.Lines[cntr].TransactionLineId == 1)
                            //    {
                        ...
                        //try
                        //{
                        //    //string _sqlquery1 = "select ISNULL(nPOSID,0) as nPOSID from BL_Facility_MST WITH(NOLOCK) where sFacilityCode='" + oTransaction.FacilityCode + "'";
                        //    string _sqlquery1 = "select ISNULL(sPOSCode,0) AS nPOSID from BL_POS_MST WITH(NOLOCK) LEFT OUTER  join  BL_Facility_MST WITH(NOLOCK) ON BL_Facility_MST.nPOSID=BL_POS_MST.nPOSID  where BL_Facility_MST.sFacilityCode='" + oTransaction.FacilityCode + "'";
                        ...
                        //if (MidLevelBillingProviderID != oTransaction.ProviderID )
                        //{
                        //   // FillMidlevelBillingProvider(MidLevelBillingProviderID, "Facility");
                        //    FillBillingProviderFacility(Convert.ToInt64(oTransaction.ProviderID), Convert.ToInt64(oTranDetails.HCFA_FacilityID), Convert.ToInt64(oTransaction.ContactID), "Service Facility Source", "Facility");
                        //}

                        //Added By Debasish on 27th Nov 2010
                        if (oTranDetails.HCFA_FacilityID == "")
                        {
                        ...
                        #region Referral/Physicain Info
                        //GetReferralProvider_Old(oTransaction.PatientID, oTransaction.TransactionID, oTransaction.TransactionMasterID);
                        ...
                        {
                            if (oTransaction.MaritalStatus != null && Convert.ToString(oTransaction.MaritalStatus).ToUpper().Trim() == "SINGLE")
                            {
                                chkPatientStatus_Single.Checked = true;
                            }
                            else if (oTransaction.MaritalStatus != null && Convert.ToString(oTransaction.MaritalStatus).ToUpper().Trim() == "MARRIED")
                            {
                                chkPatientStatus_Married.Checked = true;
                            }
                            else
                        ...
                        {
                            if (Convert.ToBoolean(IsPaperIncludeReferralCode(_ContactID)))
                            {
                   ...
                   //     txtPriorAuthorizationNumber.Text = oTranDetails.HCFA_PriorAuthorizationNo.Trim();
                        ...
                        if (_PatientAccountCode == "Claim Number")
                        {
                            //if (oTransaction.SubClaimNo.ToString().Trim() != "")
                            //{
                            //    txtPatientAccountNo.Text = oTransaction.ClaimNo.ToString("00000") + "-" + oTransaction.SubClaimNo.ToString().Trim();
                            //}
                            //else
                            //{
                            //    txtPatientAccountNo.Text = oTransaction.ClaimNo.ToString("00000");
                        ...
                        //dtDx = GetDistinctDiagnosis(oTransaction.TransactionID, oTransaction.ClinicID, oTransaction.ClaimNo);
                        //dtDx = GetClaimPrimaryDiagnosis(oTransaction.TransactionID, oTransaction.ClinicID, oTransaction.ClaimNo);
                        //MaheshB 02152010 Dignosis Remains Same.
                        dtDx = GetClaimPrimaryDiagnosis(oTransaction.TransactionID, oTransaction.ClinicID, oTransaction.ClaimNo);
                            ...
                            if (oTransaction.Lines.Count > 0)
                        {
                            ...
                            for (int j = 0; j < oTransaction.Lines.Count; j++)
                            {
                                ...
                                if (oTransaction.Lines[0].POSCode != "11" && oTransaction.Lines[0].POSCode != "12")
                                {
                                    //if (oTransaction.HospitalizationDateFrom > 0 && oTransaction.HospitalizationDateTo > 0)
                                    //{
                                    //    dtpHospitalisationFrom.Value = gloDateMaster.gloDate.DateAsDate(oTransaction.HospitalizationDateFrom);
                                ...
                                if (j == 0)
                                {
                                    ...
                                    if (txtNotes1.Text.Trim() != "")
                                    {
                                        //if (txtNotes1.Text.Trim().Length > 40)
                                        //{
                                        //    txtNotes1.Text = txtNotes1.Text.Trim().Substring(0, 39);
                                        //}
                                        //else
                                        //{
                                        ...
                                        //    txtNotes1.Text = strNotes.Trim().Substring(0, 40);
                                        //else
                                        //    txtNotes1.Text = (strNotes.Trim().Length > 40 ? strNotes.Trim().Substring(0, strNotes.Length - 7) : strNotes.Trim());
                                    }
                                    ...
                                    //foreach (string sDx in alDiagnosis)
                                    //{
                                    //    if ((oTransaction.Lines[j].Dx1Code.Trim().ToUpper().Equals(sDx.Trim().ToUpper())) == true || (oTransaction.Lines[j].Dx2Code.Trim().ToUpper().Equals(sDx.Trim().ToUpper())) == true || (oTransaction.Lines[j].Dx3Code.Trim().ToUpper().Equals(sDx.Trim().ToUpper())) == true || (oTransaction.Lines[j].Dx4Code.Trim().ToUpper().Equals(sDx.Trim().ToUpper())) == true)
                                    //    {
                                    //        int iDxPtr = alDiagnosis.IndexOf(sDx) + 1;
                                    //        sbDxPts = sbDxPts.Append(iDxPtr + ",");
                                    //    }
                                    ...
                                    //if (oTransaction.Lines[j].HCFA_RenderingProviderNPI.Trim() != "")
                                    //{
                                    //    txtRenderingProvider1_NPI.Text = FillRenderingProvider(Convert.ToInt64(oTransaction.Lines[j].RefferingProviderId), Convert.ToInt64(oTranDetails.HCFA_FacilityID), Convert.ToInt64(oTransaction.ContactID), "Paper Rendering Provider ID Type");
                                ...
                                else if (j == 1)
                                {
                                    ...
                                    if (txtNotes2.Text.Trim() != "")
                                    {
                                        //if (txtNotes2.Text.Trim().Length > 40)
                                        //{
                                        //    txtNotes2.Text = txtNotes2.Text.Trim().Substring(0, 39);
                                        //}
                                        //else
                                        //{
                                        //    txtNotes2.Text = txtNotes2.Text.Trim();
                                        //}
                                        string strNotes = getStringFitinTextBox(txtNotes2, txtNotes2.Text.Trim());
                                        txtNotes2.Text = strNotes.Trim().Replace("\r\n", "");
                                        //if (strNotes.Trim().Length >= 40 && strNotes.Trim().Length <= 47)
                                        //    txtNotes2.Text = strNotes.Trim().Substring(0, 40);
                                        //else
                                        //    txtNotes2.Text = (strNotes.Trim().Length > 40 ? strNotes.Trim().Substring(0, strNotes.Length - 7) : strNotes.Trim());
                                    }
                                ...
                                //    txtCPT2.Tag = Convert.ToString(oTransaction.Lines[j].CPTDescription);
                                    ...
                                    //if (oTransaction.Lines[j].HCFA_RenderingProviderNPI.Trim() != "")
                                    //{
                                    //    txtRenderingProvider2_NPI.Text = FillRenderingProvider(Convert.ToInt64(oTransaction.Lines[j].RefferingProviderId),Convert.ToInt64( oTranDetails.HCFA_FacilityID), Convert.ToInt64(oTransaction.ContactID), "Paper Rendering Provider ID Type"); 
                                    //    txtRenderingProvider2_NPI.Tag = Convert.ToString(oTransaction.Lines[j].RefferingProviderId);
                                    //}
                                    if (!Convert.ToBoolean(_dtEpsdt.Rows[0]["bSupressRenderEPSDTClaimOnPaperEDI"])||!oTransaction.bIsEPSDTScreening)
                                    {
                       ...
                       //if (oTransaction.Transaction_Details.HCFA_LastSeenDate != "0")
                            if (oTransaction.sBox15DateQualifier == "304")
                            {
                                _sNote = "LastSeenDate " + oTransaction.ndtBox15Date;
                            }
                            // CMS1500 08/05 Box 19 changes 01032014 Samneer
                            if (oTransaction.Transaction_Details.HCFA_ReferringProviderNPI.Trim() != "" && oTransaction.sProviderQualifier == "DQ")
                        ...
                        //{
                            if (_sNotes.Trim() != "")
                            {
                                //if (_sNotes.Trim().Length > 39)
                                //{
                                   // txt19ReservedForLocalUse.Text = _sNotes.Trim().Substring(0, 38);
                                //}
                                //else
                                //{
                                    //txt19ReservedForLocalUse.Text = _sNotes.Trim();
                               // }
                                ...
                                //if (strNotes.Trim().Length >= 39 && strNotes.Trim().Length <= 46)
                                //    txt19ReservedForLocalUse.Text = txt19ReservedForLocalUse.Text+" "+ strNotes.Trim().Substring(0, 39);
                                //else
                                //    txt19ReservedForLocalUse.Text = txt19ReservedForLocalUse.Text+ " "+(strNotes.Trim().Length > 39 ? strNotes.Trim().Substring(0, strNotes.Length - 7) : strNotes.Trim());
                            }
                        //}
        ...
        private string getStringFitinTextBox(TextBox txt, string str)
        {
            try
            {
                ...
                int width = (int)(MeasureDisplayStringWidth(g, strText.Trim(), txt.Font));
                if (strText.Length >= 1)
                {
        ...
        private bool IsPaperIncludeReferralCode(Int64 ContactID)
        {
            gloDatabaseLayer.DBLayer oDB = new gloDatabaseLayer.DBLayer(_databaseconnectionstring);
            string _strSQL = "";
            object _result = null;
            ...
            {
                oDB.Connect(false);
                _strSQL = "SELECT (CASE  WHEN ISNULL(bBillEPSDTorFamilyPlanning,0)=1 THEN isnull(bPaperIncludeReferralCode,0) ELSE 0  END ) AS  bPaperIncludeReferralCode FROM Contacts_Insurance_DTL   Where nContactID=" + ContactID + "";
                _result = oDB.ExecuteScalar_Query(_strSQL);
                oDB.Disconnect();
                if (_result != DBNull.Value && Convert.ToString(_result) != "")
                {
                    _IsNotes = Convert.ToBoolean(_result);
                }
        ...
        private bool IsNotesInBox19(Int64 ContactID)
        {
            gloDatabaseLayer.DBLayer oDB = new gloDatabaseLayer.DBLayer(_databaseconnectionstring);
            string _strSQL = "";
            object _result = null;
            ...
            {
                oDB.Connect(false);
                _strSQL = "SELECT isnull(bNotesInBox19,'false') AS bNotesInBox19 FROM Contacts_Insurance_DTL WITH(NOLOCK) Where nContactID=" + ContactID + "";
                _result = oDB.ExecuteScalar_Query(_strSQL);
                oDB.Disconnect();
                if (_result != DBNull.Value && Convert.ToString(_result) != "")
                {
            ...
            try
            {
                if (_Transaction != null)
                {
                    if (Convert.ToInt64(_Transaction.ProviderID) != 0 && _Transaction.ProviderID.ToString() != "")
                    {
                        ...
                        FillInsurances(_Transaction.PatientID, _Transaction.TransactionID);
                    ...
                    {
                        //Fill Other Details (Signature on File , Box13)
        ...
        private void FillOtherDetails(Transaction oTransaction)
        {
            ...
            try
            {
                ...
                //Get Is Signature On File
                DataTable dt = new DataTable();
                //_sqlQuery = "select ISNULL(bSignatureOnFile,0) as bSignatureOnFile from Patient_OtherDetails where bSignatureOnFile =1 and nPatientID=" + oTransaction.PatientID;
                _sqlQuery = "select ISNULL(bSignatureOnFile,0) as bSignatureOnFile from Patient_OtherDetails WITH(NOLOCK) where bSignatureOnFile =1 and nPatientID=" + oTransaction.PatientID;
                oDB.Retrive_Query(_sqlQuery, out dt);
                oDB.Disconnect();
                if (dt != null && dt.Rows.Count > 0)
                {
                    _IsSignatureOnFile = Convert.ToBoolean(dt.Rows[0]["bSignatureOnFile"]);
                }
                else
                {
                    _IsSignatureOnFile = false;
                }
                dt = null;
                ...
                if (_IsSignatureOnFile == true)
                {
                    _result = GetPatientSetting(oTransaction.PatientID, "Signature on File Date");
                    if (_result != "")
                    {
                ...
                //txtPhyscianSignature.Text = oTransaction.ProviderName +" "+ oTransaction.ProviderSuffix;
                //Get CMS1500 Box13 Setting
                _InsuredPersonSign = GetPatientSetting(oTransaction.PatientID, "CMS1500 Box13");
                ...
                DataTable dtBox13 = new DataTable();
                string _strsqlQuery = "select nPatientID,bAssignmentofBenifit from dbo.PatientInsurance_DTL PatientSettings WITH(NOLOCK) where nPatientID='" + oTransaction.PatientID + "' and nContactID='" + _ContactID + "'";
                oDB.Connect(false);
                oDB.Retrive_Query(_strsqlQuery, out dtBox13);
                if (dtBox13 != null && dtBox13.Rows.Count > 0)
                {
                    if (Convert.ToBoolean(dtBox13.Rows[0]["bAssignmentofBenifit"]) == true)
                    {
                    ...
                    {
                        //txtInsuredPersonSign.Text = "SIGNATURE NOT ON  FILE";
                ...
                dt = new DataTable();
                _sqlQuery = "select ISNULL(sBox32,'') as sBox32,ISNULL(sBox32A,'') as sBox32A,ISNULL(sBox32B,'') as sBox32B," +
                            ...
                            "isnull(sInsuranceTypeCode,'') as sInsuranceTypeCode," +
                             " isnull(bAccessAssignment,0) as bAccessAssignment,isnull(bPaperDisplayMailingAddress,0) as bPaperDisplayMailingAddress,isnull(bSwap1a9a1aMCare,0) as bSwap1a9a1aMCare ," +
                            "  ISNULL(bEMGAsX,0) as bEMGAsX,ISNULL(bShowClaimNo,0) as  bShowClaimNo from Contacts_Insurance_DTL WITH(NOLOCK) where nContactID = " + _ContactID;
                oDB.Retrive_Query(_sqlQuery, out dt);
                if (dt != null && dt.Rows.Count > 0)
                {
                    //BOX 32
                    ...
                    //Code Added by Mayuri:20091123
                    //If Insurance Type is Medicare then Address shouldn't display
                ...
                //Primary
                _sqlQuery = "";
                _sqlQuery = "SELECT    ISNULL(Contacts_InsuranceCompany_MST.sDescription,'') AS [ComapanyName], Contacts_MST.nContactID, Contacts_MST.sName AS [PlanName] " +
                ...
                // _sqlQuery = "";
                //_sqlQuery = "SELECT    ISNULL(Contacts_InsuranceCompany_MST.sDescription,'') AS [ComapanyName], Contacts_MST.nContactID, Contacts_MST.sName AS [PlanName] " +
                //          " FROM         Contact_InsurancePlan_Association RIGHT OUTER JOIN " +
                //          " Contacts_MST ON Contact_InsurancePlan_Association.nContactId = Contacts_MST.nContactID LEFT OUTER JOIN " +
                //          " Contacts_InsuranceCompany_MST ON Contact_InsurancePlan_Association.nCompanyId = Contacts_InsuranceCompany_MST.nID " +
                //          " WHERE     (Contacts_MST.nContactID = " + _OtherInsuranceContactID + ") ";
                //dt = new DataTable();
                ////oDB.Connect(false);
                //oDB.Retrive_Query(_sqlQuery,out dt);
                //if (dt != null && dt.Rows.Count > 0)
                ...
                //    if (Convert.ToString(dt.Rows[0]["ComapanyName"]).Trim() != "")
                //    {
                //        _OtherInsuranceName = Convert.ToString(dt.Rows[0]["ComapanyName"]);
                //    }
                //}
        ...
        public void FillInsurances(Int64 PatientID, Int64 _nTransactionID)
        {
          ...
          //  clsgloBilling ogloBilling = new clsgloBilling(_databaseconnectionstring);
            try
            {
                ...
                clsgloPatient ogloPatient = new clsgloPatient(_databaseconnectionstring);

                dtPatientInsurances = ogloPatient.getTransactionInsurancesCMS(_nTransactionID, oTransaction.ResponsibilityNo);
                ogloPatient.Dispose();
                ogloPatient = null;
        ...
        public void PrintData(string FormName)
        {
            try
            {
                ...
                gloHCFA1500PaperForm oHCFA1500PaperForm = new gloHCFA1500PaperForm();
                ...
                { _OutputFilePath = oPrintForm.PrintHCFA1500Form(oHCFA1500PaperForm, _InputFilePath, false); }
        ...
        public void PrintForm(string FormName)
        {
            try
            {
                ...
                gloHCFA1500PaperForm oHCFA1500PaperForm = new gloHCFA1500PaperForm(true);
                ...
                if (System.IO.File.Exists(_InputFilePath) == true)
                {
                    ...
                    if (oHCFA1500PaperForm != null)
                    { _OutputFilePath = oPrintForm.PrintHCFA1500Form(oHCFA1500PaperForm, _InputFilePath, true); }
        ...
        private gloHCFA1500PaperForm SetHCFA1500PaperForm()
        {
            gloHCFA1500PaperForm oHCFA1500 = new gloHCFA1500PaperForm();
            ...
            try
            {
                ...
                if (dtpInsuredsDOB.Checked == true)
                {
                    ...
                    oHCFA1500.CF_11_Insureds_DOB_YY.Value = dtpInsuredsDOB.Value.ToString("yy");
                }
                oHCFA1500.CF_11_Insureds_EmployerName.Value = txtInsuredEmployerORSchoolName.Text.Trim();
                ...
                oHCFA1500.CF_3_Patient_DOB_YY.Value = dtpPatientDOB.Value.ToString("yy");
                ...
                {
                    oHCFA1500.CF_12_PatientAuthorizedPersons_Signature_Date.Value = dtpPatientSignDate.Value.ToShortDateString();
                }
                ...
                {
                    oHCFA1500.CF_14_DateOfCurrent_Illness_Injury_Pregnancy_DD.Value = dtpDateOfCurrentIllness.Value.ToString("dd");
                    oHCFA1500.CF_14_DateOfCurrent_Illness_Injury_Pregnancy_MM.Value = dtpDateOfCurrentIllness.Value.ToString("MM");
                    oHCFA1500.CF_14_DateOfCurrent_Illness_Injury_Pregnancy_YY.Value = dtpDateOfCurrentIllness.Value.ToString("yy");
                }

                if (dtpSimilarIllnessFirstDate.Checked == true)
                {
                    oHCFA1500.CF_15_FirstDateOfSimilar_Illness_DD.Value = dtpSimilarIllnessFirstDate.Value.ToString("dd");
                    oHCFA1500.CF_15_FirstDateOfSimilar_Illness_MM.Value = dtpSimilarIllnessFirstDate.Value.ToString("MM");
                    oHCFA1500.CF_15_FirstDateOfSimilar_Illness_YY.Value = dtpSimilarIllnessFirstDate.Value.ToString("yy");
                }
                ...
                if (dtpUnableToWorkFrom.Checked == true)
                {
                    ...
                    oHCFA1500.CF_16_UnableToWorkFromDate_YY.Value = dtpUnableToWorkFrom.Value.ToString("yy");
                }
                if (dtpUnableToWorkTill.Checked == true)
                {
                    ...
                    oHCFA1500.CF_16_UnableToWorkTillDate_YY.Value = dtpUnableToWorkTill.Value.ToString("yy");
                }
                ...
                if (dtpHospitalisationFrom.Checked == true)
                {
                    ...
                    oHCFA1500.CF_18_HospitalizationFromDate_YY.Value = dtpHospitalisationFrom.Value.ToString("yy");
                }
                if (dtpHospitalisationTo.Checked == true)
                {
                    ...
                    oHCFA1500.CF_18_HospitalizationTillDate_YY.Value = dtpHospitalisationTo.Value.ToString("yy");
                }
                ...
                oHCFA1500.CF_21_Diagnosis_1_Principal.Value = txtDiagnosisCode11.Text;
                oHCFA1500.CF_21_Diagnosis_1_Secondary.Value = txtDiagnosisCode12.Text;

                oHCFA1500.CF_21_Diagnosis_2_Principal.Value = txtDiagnosisCode31.Text;
                oHCFA1500.CF_21_Diagnosis_2_Secondary.Value = txtDiagnosisCode32.Text;

                oHCFA1500.CF_21_Diagnosis_3_Principal.Value = txtDiagnosisCode21.Text;
                oHCFA1500.CF_21_Diagnosis_3_Secondary.Value = txtDiagnosisCode22.Text;

                oHCFA1500.CF_21_Diagnosis_4_Principal.Value = txtDiagnosisCode41.Text;
                oHCFA1500.CF_21_Diagnosis_4_Secondary.Value = txtDiagnosisCode42.Text;

                oHCFA1500.CF_22_MecaidResubmission_Code.Value = txtMedicaidResubmissionCode.Text.Trim();
                ...
                oHCFA1500.CF_31_Physician_Supplier_Signature_Date.Value = dtpPhysicianSignDate.Value.ToShortDateString();
        ...
        private gloHCFA1500PaperForm SetHCFA1500PaperForm(gloHCFA1500PaperForm oHCFA1500)
        {
            try
            {
                oHCFA1500.CF_Top_InsuranceHeader.Value = txtPayerNameAndAddress.Text;
                ...
                oHCFA1500.CF_19_LocalUse_Field.Value = txt19ReservedForLocalUse.Text.Trim();
                oHCFA1500.CF_20_OutsideLab_Charges_Principal.Value = txtOutsideLabCharges1.Text.Trim().PadLeft("##########".Length, '#').Replace("#", "  ");
                oHCFA1500.CF_20_OutsideLab_Charges_Secondary.Value = txtOutsideLabCharges2.Text.Trim();
                if (chkOutsideLab_No.Checked == true)
                {
                    oHCFA1500.CF_20_OutsideLab_No.Value = true;
                ...
                oHCFA1500.CF_24F_L1_Charges_Principal.Value = txtCharges1.Text.PadLeft("#######".Length, '#').Replace("#", "  ");
                oHCFA1500.CF_24F_L1_Charges_Secondary.Value = txtCharges11.Text;
                oHCFA1500.CF_24F_L2_Charges_Principal.Value = txtCharges2.Text.PadLeft("#######".Length, '#').Replace("#", "  ");
                oHCFA1500.CF_24F_L2_Charges_Secondary.Value = txtCharges21.Text;
                oHCFA1500.CF_24F_L3_Charges_Principal.Value = txtCharges3.Text.PadLeft("#######".Length, '#').Replace("#", "  ");
                oHCFA1500.CF_24F_L3_Charges_Secondary.Value = txtCharges31.Text;
                oHCFA1500.CF_24F_L4_Charges_Principal.Value = txtCharges4.Text.PadLeft("#######".Length, '#').Replace("#", "  ");
                oHCFA1500.CF_24F_L4_Charges_Secondary.Value = txtCharges41.Text;
                oHCFA1500.CF_24F_L5_Charges_Principal.Value = txtCharges5.Text.PadLeft("#######".Length, '#').Replace("#", "  ");
                oHCFA1500.CF_24F_L5_Charges_Secondary.Value = txtCharges51.Text;
                oHCFA1500.CF_24F_L6_Charges_Principal.Value = txtCharges6.Text.PadLeft("#######".Length, '#').Replace("#", "  ");
                oHCFA1500.CF_24F_L6_Charges_Secondary.Value = txtCharges61.Text;
                ...
                oHCFA1500.CF_28_TotalCharge_Principal.Value = txtTotalCharges.Text.PadLeft("##########".Length, '#').Replace("#", "  ");
                oHCFA1500.CF_28_TotalCharge_Secondary.Value = txtTotalCharges2.Text;
                oHCFA1500.CF_29_AmountPaid_Principal.Value = txtAmountPaid.Text.PadLeft("##########".Length, '#').Replace("#", "  ");
                oHCFA1500.CF_29_AmountPaid_Secondary.Value = txtAmountPaid2.Text;
