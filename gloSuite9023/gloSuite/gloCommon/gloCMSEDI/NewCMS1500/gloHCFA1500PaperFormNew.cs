...
{
    class gloHCFA1500PaperFormNew
    {

        #region "Constructor & Destructor"

        public gloHCFA1500PaperFormNew(string sPrinterName)
        {
        ...
        public gloHCFA1500PaperFormNew()
        {
            _DataBaseConnectionString = Convert.ToString(appSettings["DataBaseConnectionString"]);
            dtSettings = GetPrinterCoordinates("Default", 1); //GetPrinterSettingNew();
            if (dtSettings == null || dtSettings.Rows.Count == 0)
        ...
        public gloHCFA1500PaperFormNew(bool IsForPrint)
        {
            _DataBaseConnectionString = Convert.ToString(appSettings["DataBaseConnectionString"]);
            dtSettings = GetPrinterCoordinates("Default", 1); //GetPrinterSettingNew();
            if (dtSettings == null || dtSettings.Rows.Count == 0)
        ...
        public FormFieldString CF_9_c_Reserved_For_Nucc_Use; // = new FormFieldString(30, 355);
        ...
        //public FormFieldString CF_10_Claim_Codes_Designated_by_NUCC; // = new FormFieldString(332, 370);
        ...
        public FormFieldString CF_11_Other_Claim_ID_Designated_by_NUCC; // = new FormFieldString(1150, 764);
        ...
        public FormFieldString CF_11_Qualifier_No;
        ...
        public FormFieldString CF_14_Date_Of_Current_Illness_Injury_or_Pregnancy_LMP_MM; // = new FormFieldString(189, 1108);
        public FormFieldString CF_14_Date_Of_Current_Illness_Injury_or_Pregnancy_LMP_DD; // = new FormFieldString(248, 1108);
        public FormFieldString CF_14_Date_Of_Current_Illness_Injury_or_Pregnancy_LMP_YY; // = new FormFieldString(322, 1108);
        public FormFieldString CF_14_Qualifier_No;
        // CF_14_Qualifier_No 11272013

        public FormFieldString CF_15_Other_Dates_MM; // = new FormFieldString(884, 1106);
        public FormFieldString CF_15_Other_Date_DD; // = new FormFieldString(948, 1106);
        public FormFieldString CF_15_Other_Date_YY; // = new FormFieldString(1022, 1106);
        
        // CF_15_Qualifier_No = 11272013 
        public FormFieldString CF_15_Qualifier_No; //= new FormFieldString(X + 303, Y + 525);
        ...
        public FormFieldString CF_17_ReferringProvider_Qaulifier; // = new FormFieldString(169, 1162);
        ...
        public FormFieldString CF_21_Icd_Ind_No;//=new FormFieldString(X + 291, Y + 625);
        public FormFieldString CF_21_Icd_Ind;// = new FormFieldString(X + 69, Y + 657);

        public FormFieldString CF_21_Diagnosis_A_Principal; // = new FormFieldString(205, 1308);
        public FormFieldString CF_21_Diagnosis_1_Secondary; // = new FormFieldString(284, 1308);
        public FormFieldString CF_21_Diagnosis_B_Principal; // = new FormFieldString(204, 1374);
        public FormFieldString CF_21_Diagnosis_2_Secondary; // = new FormFieldString(283, 1374);
        public FormFieldString CF_21_Diagnosis_C_Principal; // = new FormFieldString(744, 1308);
        public FormFieldString CF_21_Diagnosis_3_Secondary; // = new FormFieldString(823, 1308);
        public FormFieldString CF_21_Diagnosis_D_Principal; // = new FormFieldString(744, 1374);
        public FormFieldString CF_21_Diagnosis_4_Secondary; // = new FormFieldString(823, 1374);


        public FormFieldString CF_21_Diagnosis_E_Principal;

        public FormFieldString CF_21_Diagnosis_F_Principal;

        public FormFieldString CF_21_Diagnosis_G_Principal;

        public FormFieldString CF_21_Diagnosis_H_Principal;

        public FormFieldString CF_21_Diagnosis_I_Principal;

        public FormFieldString CF_21_Diagnosis_J_Principal;

        public FormFieldString CF_21_Diagnosis_K_Principal;

        public FormFieldString CF_21_Diagnosis_L_Principal;


        public FormFieldString CF_22_Resubmission; // = new FormFieldString(1150, 1307);
        ...
        public FormFieldString CF_30_Rsvd_for_NUCC_Use; // = new FormFieldString(1692, 1901);
        ...
        private void InitializeBoxes()
        {
            ...
            //.Insurance Header
            GetCoordinates("CF_Top_InsuranceHeader", out X, out Y, out CharSize);
            CF_Top_InsuranceHeader = new FormFieldString(X, Y, CharSize);

            //.Insurance Type
            GetCoordinates("CF_1_Insuracne_Type_Medicare", out X, out Y, out CharSize);
            CF_1_Insuracne_Type_Medicare = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_1_Insuracne_Type_Medicaid", out X, out Y, out CharSize);
            CF_1_Insuracne_Type_Medicaid = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_1_Insuracne_Type_Tricare", out X, out Y, out CharSize);
            CF_1_Insuracne_Type_Tricare = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_1_Insuracne_Type_Champva", out X, out Y, out CharSize);
            CF_1_Insuracne_Type_Champva = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_1_Insuracne_Type_GroupHealthPlan", out X, out Y, out CharSize);
            CF_1_Insuracne_Type_GroupHealthPlan = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_1_Insuracne_Type_FECA", out X, out Y, out CharSize);
            CF_1_Insuracne_Type_FECA = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_1_Insuracne_Type_Other", out X, out Y, out CharSize);
            CF_1_Insuracne_Type_Other = new FormFieldBoolean(X, Y);

            //.Insured's ID Number
            GetCoordinates("CF_1a_InsuredsIDNumber", out X, out Y, out CharSize);
            CF_1a_InsuredsIDNumber = new FormFieldString(X, Y, CharSize);

            //.Patient's Name
            //public FormFieldString CF_2_Patient_Name = new FormFieldString(30, 300);
            GetCoordinates("CF_2_Patient_Name", out X, out Y, out CharSize);
            CF_2_Patient_Name = new FormFieldString(X, Y, CharSize);

            //.Patient's Birth Date
            GetCoordinates("CF_3_Patient_DOB_MM", out X, out Y, out CharSize);
            CF_3_Patient_DOB_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_3_Patient_DOB_DD", out X, out Y, out CharSize);
            CF_3_Patient_DOB_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_3_Patient_DOB_YY", out X, out Y, out CharSize);
            CF_3_Patient_DOB_YY = new FormFieldString(X, Y, CharSize);

            //.Patient's Sex
            GetCoordinates("CF_3_Patient_Sex_Male", out X, out Y, out CharSize);
            CF_3_Patient_Sex_Male = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_3_Patient_Sex_Female", out X, out Y, out CharSize);
            CF_3_Patient_Sex_Female = new FormFieldBoolean(X, Y);


            //.Insured's Name
            GetCoordinates("CF_4_Insureds_Name", out X, out Y, out CharSize);
            CF_4_Insureds_Name = new FormFieldString(X, Y, CharSize);

            //.Patient's Address
            GetCoordinates("CF_5_Patient_Address", out X, out Y, out CharSize);
            CF_5_Patient_Address = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_5_Patient_City", out X, out Y, out CharSize);
            CF_5_Patient_City = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_5_Patient_State", out X, out Y, out CharSize);
            CF_5_Patient_State = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_5_Patient_Zip", out X, out Y, out CharSize);
            CF_5_Patient_Zip = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_5_Patient_Tel_AreaCode", out X, out Y, out CharSize);
            CF_5_Patient_Tel_AreaCode = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_5_Patient_Tel_Number", out X, out Y, out CharSize);
            CF_5_Patient_Tel_Number = new FormFieldString(X, Y, CharSize);

            //.Paient Relationship to Insured
            GetCoordinates("CF_6_PatientRelationship_Self", out X, out Y, out CharSize);
            CF_6_PatientRelationship_Self = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_6_PatientRelationship_Spouse", out X, out Y, out CharSize);
            CF_6_PatientRelationship_Spouse = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_6_PatientRelationship_Child", out X, out Y, out CharSize);
            CF_6_PatientRelationship_Child = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_6_PatientRelationship_Other", out X, out Y, out CharSize);
            CF_6_PatientRelationship_Other = new FormFieldBoolean(X, Y);

            //.Insured's Address
            GetCoordinates("CF_7_Insureds_Address", out X, out Y, out CharSize);
            CF_7_Insureds_Address = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_7_Insureds_City", out X, out Y, out CharSize);
            CF_7_Insureds_City = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_7_Insureds_State", out X, out Y, out CharSize);
            CF_7_Insureds_State = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_7_Insureds_Zip", out X, out Y, out CharSize);
            CF_7_Insureds_Zip = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_7_Insureds_Tel_AreaCode", out X, out Y, out CharSize);
            CF_7_Insureds_Tel_AreaCode = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_7_Insureds_Tel_Number", out X, out Y, out CharSize);
            CF_7_Insureds_Tel_Number = new FormFieldString(X, Y, CharSize);

            //.Patient Status
            GetCoordinates("CF_8_PatientStatus_Single", out X, out Y, out CharSize);
            CF_8_PatientStatus_Single = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_8_PatientStatus_Married", out X, out Y, out CharSize);
            CF_8_PatientStatus_Married = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_8_PatientStatus_Other", out X, out Y, out CharSize);
            CF_8_PatientStatus_Other = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_8_PatientStatus_Employed", out X, out Y, out CharSize);
            CF_8_PatientStatus_Employed = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_8_PatientStatus_FullTimeStudent", out X, out Y, out CharSize);
            CF_8_PatientStatus_FullTimeStudent = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_8_PatientStatus_PartTimeStudent", out X, out Y, out CharSize);
            CF_8_PatientStatus_PartTimeStudent = new FormFieldBoolean(X, Y);

            //.Other Insured's Name
            GetCoordinates("CF_9_Other_Insureds_Name", out X, out Y, out CharSize);
            CF_9_Other_Insureds_Name = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_9_Other_Insureds_PolicyGroupNo", out X, out Y, out CharSize);
            CF_9_Other_Insureds_PolicyGroupNo = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_9_Other_Insureds_DOB_MM", out X, out Y, out CharSize);
            CF_9_Other_Insureds_DOB_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_9_Other_Insureds_DOB_DD", out X, out Y, out CharSize);
            CF_9_Other_Insureds_DOB_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_9_Other_Insureds_DOB_YY", out X, out Y, out CharSize);
            CF_9_Other_Insureds_DOB_YY = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_9_Other_Insureds_Sex_Male", out X, out Y, out CharSize);
            CF_9_Other_Insureds_Sex_Male = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_9_Other_Insureds_Sex_Female", out X, out Y, out CharSize);
            CF_9_Other_Insureds_Sex_Female = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_9_c_Reserved_For_Nucc_Use", out X, out Y, out CharSize);
            CF_9_c_Reserved_For_Nucc_Use = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_9_Other_Insureds_InsuracnePlan", out X, out Y, out CharSize);
            CF_9_Other_Insureds_InsuracnePlan = new FormFieldString(X, Y, CharSize);

            //.Patient Condition 
            GetCoordinates("CF_10_PatientConditionTo_Employement_Yes", out X, out Y, out CharSize);
            CF_10_PatientConditionTo_Employement_Yes = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_10_PatientConditionTo_Employement_No", out X, out Y, out CharSize);
            CF_10_PatientConditionTo_Employement_No = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_10_PatientConditionTo_AutoAccident_Yes", out X, out Y, out CharSize);
            CF_10_PatientConditionTo_AutoAccident_Yes = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_10_PatientConditionTo_AutoAccident_No", out X, out Y, out CharSize);
            CF_10_PatientConditionTo_AutoAccident_No = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_10_PatientConditionTo_AutoAccident_State", out X, out Y, out CharSize);
            CF_10_PatientConditionTo_AutoAccident_State = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_10_PatientConditionTo_OtherAccident_Yes", out X, out Y, out CharSize);
            CF_10_PatientConditionTo_OtherAccident_Yes = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_10_PatientConditionTo_OtherAccident_No", out X, out Y, out CharSize);
            CF_10_PatientConditionTo_OtherAccident_No = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_10_PatientConditionTo_ResForLocaluse", out X, out Y, out CharSize);
            CF_10_PatientConditionTo_ResForLocaluse = new FormFieldString(X, Y, CharSize);

            //.Insured's Information
            GetCoordinates("CF_11_Insureds_PolicyGroupNo", out X, out Y, out CharSize);
            CF_11_Insureds_PolicyGroupNo = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_11_Insureds_DOB_MM", out X, out Y, out CharSize);
            CF_11_Insureds_DOB_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_11_Insureds_DOB_DD", out X, out Y, out CharSize);
            CF_11_Insureds_DOB_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_11_Insureds_DOB_YY", out X, out Y, out CharSize);
            CF_11_Insureds_DOB_YY = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_11_Insureds_Sex_Male", out X, out Y, out CharSize);
            CF_11_Insureds_Sex_Male = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_11_Insureds_Sex_Female", out X, out Y, out CharSize);
            CF_11_Insureds_Sex_Female = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_11_Other_Claim_ID_Designated_by_NUCC", out X, out Y, out CharSize);
            CF_11_Other_Claim_ID_Designated_by_NUCC = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_11_Insureds_InsuracnePlan", out X, out Y, out CharSize);
            CF_11_Insureds_InsuracnePlan = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_11_Insureds_OtherHealthPlan_Yes", out X, out Y, out CharSize);
            CF_11_Insureds_OtherHealthPlan_Yes = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_11_Insureds_OtherHealthPlan_No", out X, out Y, out CharSize);
            CF_11_Insureds_OtherHealthPlan_No = new FormFieldBoolean(X, Y);

            //CF_11_Qualifier_No 11272013
            GetCoordinates("CF_11_Qualifier_No", out X, out Y, out CharSize);
            CF_11_Qualifier_No = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_12_PatientAuthorizedPersons_Signature", out X, out Y, out CharSize);
            CF_12_PatientAuthorizedPersons_Signature = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_12_PatientAuthorizedPersons_Signature_Date", out X, out Y, out CharSize);
            CF_12_PatientAuthorizedPersons_Signature_Date = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_13_InsuredsAuthorizedPersons_Signature", out X, out Y, out CharSize);
            CF_13_InsuredsAuthorizedPersons_Signature = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_14_Date_Of_Current_Illness_Injury_or_Pregnancy_LMP_MM", out X, out Y, out CharSize);
            CF_14_Date_Of_Current_Illness_Injury_or_Pregnancy_LMP_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_14_Date_Of_Current_Illness_Injury_or_Pregnancy_LMP_DD", out X, out Y, out CharSize);
            CF_14_Date_Of_Current_Illness_Injury_or_Pregnancy_LMP_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_14_Date_Of_Current_Illness_Injury_or_Pregnancy_LMP_YY", out X, out Y, out CharSize);
            CF_14_Date_Of_Current_Illness_Injury_or_Pregnancy_LMP_YY = new FormFieldString(X, Y, CharSize);

            //CF_14_Qualifier_No 11272013 
            GetCoordinates("CF_14_Qualifier_No", out X, out Y, out CharSize);
            CF_14_Qualifier_No = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_15_Other_Dates_MM", out X, out Y, out CharSize);
            CF_15_Other_Dates_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_15_Other_Date_DD", out X, out Y, out CharSize);
            CF_15_Other_Date_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_15_Other_Date_YY", out X, out Y, out CharSize);
            CF_15_Other_Date_YY = new FormFieldString(X, Y, CharSize);

            //CF_15_Qualifier_No
            GetCoordinates("CF_15_Qualifier_No", out X, out Y, out CharSize);
            CF_15_Qualifier_No = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_16_UnableToWorkFromDate_MM", out X, out Y, out CharSize);
            CF_16_UnableToWorkFromDate_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_16_UnableToWorkFromDate_DD", out X, out Y, out CharSize);
            CF_16_UnableToWorkFromDate_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_16_UnableToWorkFromDate_YY", out X, out Y, out CharSize);
            CF_16_UnableToWorkFromDate_YY = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_16_UnableToWorkTillDate_MM", out X, out Y, out CharSize);
            CF_16_UnableToWorkTillDate_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_16_UnableToWorkTillDate_DD", out X, out Y, out CharSize);
            CF_16_UnableToWorkTillDate_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_16_UnableToWorkTillDate_YY", out X, out Y, out CharSize);
            CF_16_UnableToWorkTillDate_YY = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_17_ReferringProvider_Name", out X, out Y, out CharSize);
            CF_17_ReferringProvider_Name = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_17_Qualifier_No", out X, out Y, out CharSize);
            CF_17_ReferringProvider_Qaulifier = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_17a_ReferringProvider_OtherQualifier", out X, out Y, out CharSize);
            CF_17a_ReferringProvider_OtherQualifier = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_17a_ReferringProvider_OtherID", out X, out Y, out CharSize);
            CF_17a_ReferringProvider_OtherID = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_17b_ReferringProvider_NPI", out X, out Y, out CharSize);
            CF_17b_ReferringProvider_NPI = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_18_HospitalizationFromDate_MM", out X, out Y, out CharSize);
            CF_18_HospitalizationFromDate_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_18_HospitalizationFromDate_DD", out X, out Y, out CharSize);
            CF_18_HospitalizationFromDate_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_18_HospitalizationFromDate_YY", out X, out Y, out CharSize);
            CF_18_HospitalizationFromDate_YY = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_18_HospitalizationTillDate_MM", out X, out Y, out CharSize);
            CF_18_HospitalizationTillDate_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_18_HospitalizationTillDate_DD", out X, out Y, out CharSize);
            CF_18_HospitalizationTillDate_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_18_HospitalizationTillDate_YY", out X, out Y, out CharSize);
            CF_18_HospitalizationTillDate_YY = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_19_Additional_Claim_Information_Designated_by_NUCC", out X, out Y, out CharSize);
            CF_19_LocalUse_Field = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_20_OutsideLab_Yes", out X, out Y, out CharSize);
            CF_20_OutsideLab_Yes = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_20_OutsideLab_No", out X, out Y, out CharSize);
            CF_20_OutsideLab_No = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_20_OutsideLab_Charges_Principal", out X, out Y, out CharSize);
            CF_20_OutsideLab_Charges_Principal = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_20_OutsideLab_Charges_Secondary", out X, out Y, out CharSize);
            CF_20_OutsideLab_Charges_Secondary = new FormFieldString(X, Y, CharSize);

            //CF_21_Icd_Ind_No
            //CF_21_Icd_Ind     11282013

            GetCoordinates("CF_21_Icd_Ind_No", out X, out Y, out CharSize);
            CF_21_Icd_Ind_No = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_21_Icd_Ind", out X, out Y, out CharSize);
            CF_21_Icd_Ind = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_21_Diagnosis_A_Principal", out X, out Y, out CharSize);
            CF_21_Diagnosis_A_Principal = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_21_Diagnosis_1_Secondary", out X, out Y, out CharSize);
            CF_21_Diagnosis_1_Secondary = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_21_Diagnosis_B_Principal", out X, out Y, out CharSize);
            CF_21_Diagnosis_B_Principal = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_21_Diagnosis_2_Secondary", out X, out Y, out CharSize);
            CF_21_Diagnosis_2_Secondary = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_21_Diagnosis_C_Principal", out X, out Y, out CharSize);
            CF_21_Diagnosis_C_Principal = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_21_Diagnosis_3_Secondary", out X, out Y, out CharSize);
            CF_21_Diagnosis_3_Secondary = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_21_Diagnosis_D_Principal", out X, out Y, out CharSize);
            CF_21_Diagnosis_D_Principal = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_21_Diagnosis_4_Secondary", out X, out Y, out CharSize);
            CF_21_Diagnosis_4_Secondary = new FormFieldString(X, Y, CharSize);


            GetCoordinates("CF_21_Diagnosis_E_Principal", out X, out Y, out CharSize);
            CF_21_Diagnosis_E_Principal = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_21_Diagnosis_F_Principal", out X, out Y, out CharSize);
            CF_21_Diagnosis_F_Principal = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_21_Diagnosis_G_Principal", out X, out Y, out CharSize);
            CF_21_Diagnosis_G_Principal = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_21_Diagnosis_H_Principal", out X, out Y, out CharSize);
            CF_21_Diagnosis_H_Principal = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_21_Diagnosis_I_Principal", out X, out Y, out CharSize);
            CF_21_Diagnosis_I_Principal = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_21_Diagnosis_J_Principal", out X, out Y, out CharSize);
            CF_21_Diagnosis_J_Principal = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_21_Diagnosis_K_Principal", out X, out Y, out CharSize);
            CF_21_Diagnosis_K_Principal = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_21_Diagnosis_L_Principal", out X, out Y, out CharSize);
            CF_21_Diagnosis_L_Principal = new FormFieldString(X, Y, CharSize);



            GetCoordinates("CF_22_Resubmission", out X, out Y, out CharSize);
            CF_22_Resubmission = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_22_Original_Refrence_No", out X, out Y, out CharSize);
            CF_22_Original_Refrence_No = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_23_PriorAuthorization_No", out X, out Y, out CharSize);
            ...
            //From Date.
            GetCoordinates("CF_24A_L1_DOS_From_MM", out X, out Y, out CharSize);
            CF_24A_L1_DOS_From_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L1_DOS_From_DD", out X, out Y, out CharSize);
            CF_24A_L1_DOS_From_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L1_DOS_From_YY", out X, out Y, out CharSize);
            CF_24A_L1_DOS_From_YY = new FormFieldString(X, Y, CharSize);

            //To Date
            GetCoordinates("CF_24A_L1_DOS_To_MM", out X, out Y, out CharSize);
            CF_24A_L1_DOS_To_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L1_DOS_To_DD", out X, out Y, out CharSize);
            CF_24A_L1_DOS_To_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L1_DOS_To_YY", out X, out Y, out CharSize);
            CF_24A_L1_DOS_To_YY = new FormFieldString(X, Y, CharSize);

            //Place Of Service
            GetCoordinates("CF_24B_L1_POS_Code", out X, out Y, out CharSize);
            CF_24B_L1_POS_Code = new FormFieldString(X, Y, CharSize);

            //EMG - Emergency
            GetCoordinates("CF_24C_L1_EMG_Code", out X, out Y, out CharSize);
            CF_24C_L1_EMG_Code = new FormFieldString(X, Y, CharSize);

            //CPT/HCPCS 
            GetCoordinates("CF_24D_L1_CPT_HCPCS_Code", out X, out Y, out CharSize);
            CF_24D_L1_CPT_HCPCS_Code = new FormFieldString(X, Y, CharSize);

            //Modifiers
            GetCoordinates("CF_24D_L1_Modifier_1_Code", out X, out Y, out CharSize);
            CF_24D_L1_Modifier_1_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L1_Modifier_2_Code", out X, out Y, out CharSize);
            CF_24D_L1_Modifier_2_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L1_Modifier_3_Code", out X, out Y, out CharSize);
            CF_24D_L1_Modifier_3_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L1_Modifier_4_Code", out X, out Y, out CharSize);
            CF_24D_L1_Modifier_4_Code = new FormFieldString(X, Y, CharSize);

            //Diagnosis Pointers 
            GetCoordinates("CF_24E_L1_Diagnosis_Pointers", out X, out Y, out CharSize);
            CF_24E_L1_Diagnosis_Pointers = new FormFieldString(X, Y, CharSize);

            //Charges
            GetCoordinates("CF_24F_L1_Charges_Principal", out X, out Y, out CharSize);
            CF_24F_L1_Charges_Principal = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24F_L1_Charges_Secondary", out X, out Y, out CharSize);
            CF_24F_L1_Charges_Secondary = new FormFieldString(X, Y, CharSize);

            //Days or Units
            GetCoordinates("CF_24G_L1_Days_Units", out X, out Y, out CharSize);
            CF_24G_L1_Days_Units = new FormFieldString(X, Y, CharSize);

            //EPSDT Family Plan
            GetCoordinates("CF_24H_L1_EPSDT_FamilyPlan_Shaded", out X, out Y, out CharSize);
            CF_24H_L1_EPSDT_FamilyPlan_Shaded = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_24H_L1_EPSDT_FamilyPlan", out X, out Y, out CharSize);
            CF_24H_L1_EPSDT_FamilyPlan = new FormFieldString(X, Y, CharSize);

            //Rendering Provider ID (NPI)
            GetCoordinates("CF_24J_L1_RenderingProvider_NPI", out X, out Y, out CharSize);
            CF_24J_L1_RenderingProvider_NPI = new FormFieldString(X, Y, CharSize);

            //Rendering Provider Other ID (Qualifier)
            GetCoordinates("CF_24J_L1_RenderingProvider_OtherQualifier", out X, out Y, out CharSize);
            CF_24J_L1_RenderingProvider_OtherQualifier = new FormFieldString(X, Y, CharSize);

            //Rendering Provider Other ID (Qualifier value)
            GetCoordinates("CF_24J_L1_RenderingProvider_OtherQualifiervalue", out X, out Y, out CharSize);
            CF_24J_L1_RenderingProvider_OtherQualifiervalue = new FormFieldString(X, Y, CharSize);

            //Line Note
            GetCoordinates("CF_24A_L1_Note", out X, out Y, out CharSize);
            ...
            //From Date.
            GetCoordinates("CF_24A_L2_DOS_From_MM", out X, out Y, out CharSize);
            CF_24A_L2_DOS_From_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L2_DOS_From_DD", out X, out Y, out CharSize);
            CF_24A_L2_DOS_From_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L2_DOS_From_YY", out X, out Y, out CharSize);
            CF_24A_L2_DOS_From_YY = new FormFieldString(X, Y, CharSize);

            //To Date
            GetCoordinates("CF_24A_L2_DOS_To_MM", out X, out Y, out CharSize);
            CF_24A_L2_DOS_To_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L2_DOS_To_DD", out X, out Y, out CharSize);
            CF_24A_L2_DOS_To_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L2_DOS_To_YY", out X, out Y, out CharSize);
            CF_24A_L2_DOS_To_YY = new FormFieldString(X, Y, CharSize);

            //Place Of Service
            GetCoordinates("CF_24B_L2_POS_Code", out X, out Y, out CharSize);
            CF_24B_L2_POS_Code = new FormFieldString(X, Y, CharSize);

            //EMG - Emergency
            GetCoordinates("CF_24C_L2_EMG_Code", out X, out Y, out CharSize);
            CF_24C_L2_EMG_Code = new FormFieldString(X, Y, CharSize);

            //CPT/HCPCS 
            GetCoordinates("CF_24D_L2_CPT_HCPCS_Code", out X, out Y, out CharSize);
            CF_24D_L2_CPT_HCPCS_Code = new FormFieldString(X, Y, CharSize);

            //Modifiers
            GetCoordinates("CF_24D_L2_Modifier_1_Code", out X, out Y, out CharSize);
            CF_24D_L2_Modifier_1_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L2_Modifier_2_Code", out X, out Y, out CharSize);
            CF_24D_L2_Modifier_2_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L2_Modifier_3_Code", out X, out Y, out CharSize);
            CF_24D_L2_Modifier_3_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L2_Modifier_4_Code", out X, out Y, out CharSize);
            CF_24D_L2_Modifier_4_Code = new FormFieldString(X, Y, CharSize);

            //Diagnosis Pointers 
            GetCoordinates("CF_24E_L2_Diagnosis_Pointers", out X, out Y, out CharSize);
            CF_24E_L2_Diagnosis_Pointers = new FormFieldString(X, Y, CharSize);

            //Charges
            GetCoordinates("CF_24F_L2_Charges_Principal", out X, out Y, out CharSize);
            CF_24F_L2_Charges_Principal = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24F_L2_Charges_Secondary", out X, out Y, out CharSize);
            CF_24F_L2_Charges_Secondary = new FormFieldString(X, Y, CharSize);

            //Days or Units
            GetCoordinates("CF_24G_L2_Days_Units", out X, out Y, out CharSize);
            CF_24G_L2_Days_Units = new FormFieldString(X, Y, CharSize);

            //EPSDT Family Plan

            GetCoordinates("CF_24H_L2_EPSDT_FamilyPlan_Shaded", out X, out Y, out CharSize);
            CF_24H_L2_EPSDT_FamilyPlan_Shaded = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_24H_L2_EPSDT_FamilyPlan", out X, out Y, out CharSize);
            CF_24H_L2_EPSDT_FamilyPlan = new FormFieldString(X, Y, CharSize);
            //Rendering Provider ID (NPI)
            GetCoordinates("CF_24J_L2_RenderingProvider_NPI", out X, out Y, out CharSize);
            CF_24J_L2_RenderingProvider_NPI = new FormFieldString(X, Y, CharSize);

            //Line Note
            GetCoordinates("CF_24A_L2_Note", out X, out Y, out CharSize);
            CF_24A_L2_Note = new FormFieldString(X, Y, CharSize);

            //Rendering Provider Other ID (Qualifier)
            GetCoordinates("CF_24J_L2_RenderingProvider_OtherQualifier", out X, out Y, out CharSize);
            CF_24J_L2_RenderingProvider_OtherQualifier = new FormFieldString(X, Y, CharSize);

            //Rendering Provider Other ID (Qualifier value)
            GetCoordinates("CF_24J_L2_RenderingProvider_OtherQualifiervalue", out X, out Y, out CharSize);
            CF_24J_L2_RenderingProvider_OtherQualifiervalue = new FormFieldString(X, Y, CharSize);
            ...
            //From Date.
            GetCoordinates("CF_24A_L3_DOS_From_MM", out X, out Y, out CharSize);
            CF_24A_L3_DOS_From_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L3_DOS_From_DD", out X, out Y, out CharSize);
            CF_24A_L3_DOS_From_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L3_DOS_From_YY", out X, out Y, out CharSize);
            CF_24A_L3_DOS_From_YY = new FormFieldString(X, Y, CharSize);

            //To Date
            GetCoordinates("CF_24A_L3_DOS_To_MM", out X, out Y, out CharSize);
            CF_24A_L3_DOS_To_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L3_DOS_To_DD", out X, out Y, out CharSize);
            CF_24A_L3_DOS_To_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L3_DOS_To_YY", out X, out Y, out CharSize);
            CF_24A_L3_DOS_To_YY = new FormFieldString(X, Y, CharSize);

            //Place Of Service
            GetCoordinates("CF_24B_L3_POS_Code", out X, out Y, out CharSize);
            CF_24B_L3_POS_Code = new FormFieldString(X, Y, CharSize);

            //EMG - Emergency
            GetCoordinates("CF_24C_L3_EMG_Code", out X, out Y, out CharSize);
            CF_24C_L3_EMG_Code = new FormFieldString(X, Y, CharSize);

            //CPT/HCPCS 
            GetCoordinates("CF_24D_L3_CPT_HCPCS_Code", out X, out Y, out CharSize);
            CF_24D_L3_CPT_HCPCS_Code = new FormFieldString(X, Y, CharSize);

            //Modifiers
            GetCoordinates("CF_24D_L3_Modifier_1_Code", out X, out Y, out CharSize);
            CF_24D_L3_Modifier_1_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L3_Modifier_2_Code", out X, out Y, out CharSize);
            CF_24D_L3_Modifier_2_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L3_Modifier_3_Code", out X, out Y, out CharSize);
            CF_24D_L3_Modifier_3_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L3_Modifier_4_Code", out X, out Y, out CharSize);
            CF_24D_L3_Modifier_4_Code = new FormFieldString(X, Y, CharSize);

            //Diagnosis Pointers 
            GetCoordinates("CF_24E_L3_Diagnosis_Pointers", out X, out Y, out CharSize);
            CF_24E_L3_Diagnosis_Pointers = new FormFieldString(X, Y, CharSize);

            //Charges
            GetCoordinates("CF_24F_L3_Charges_Principal", out X, out Y, out CharSize);
            CF_24F_L3_Charges_Principal = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24F_L3_Charges_Secondary", out X, out Y, out CharSize);
            CF_24F_L3_Charges_Secondary = new FormFieldString(X, Y, CharSize);

            //Days or Units
            GetCoordinates("CF_24G_L3_Days_Units", out X, out Y, out CharSize);
            CF_24G_L3_Days_Units = new FormFieldString(X, Y, CharSize);

            //EPSDT Family Plan
            GetCoordinates("CF_24H_L3_EPSDT_FamilyPlan_Shaded", out X, out Y, out CharSize);
            CF_24H_L3_EPSDT_FamilyPlan_Shaded = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_24H_L3_EPSDT_FamilyPlan", out X, out Y, out CharSize);
            CF_24H_L3_EPSDT_FamilyPlan = new FormFieldString(X, Y, CharSize);

            //Rendering Provider ID (NPI)
            GetCoordinates("CF_24J_L3_RenderingProvider_NPI", out X, out Y, out CharSize);
            CF_24J_L3_RenderingProvider_NPI = new FormFieldString(X, Y, CharSize);

            //Line Note
            GetCoordinates("CF_24A_L3_Note", out X, out Y, out CharSize);
            CF_24A_L3_Note = new FormFieldString(X, Y, CharSize);

            //Rendering Provider Other ID (Qualifier)
            GetCoordinates("CF_24J_L3_RenderingProvider_OtherQualifier", out X, out Y, out CharSize);
            CF_24J_L3_RenderingProvider_OtherQualifier = new FormFieldString(X, Y, CharSize);

            //Rendering Provider Other ID (Qualifier value)
            GetCoordinates("CF_24J_L3_RenderingProvider_OtherQualifiervalue", out X, out Y, out CharSize);
            CF_24J_L3_RenderingProvider_OtherQualifiervalue = new FormFieldString(X, Y, CharSize);
            ...
            //From Date.
            GetCoordinates("CF_24A_L4_DOS_From_MM", out X, out Y, out CharSize);
            CF_24A_L4_DOS_From_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L4_DOS_From_DD", out X, out Y, out CharSize);
            CF_24A_L4_DOS_From_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L4_DOS_From_YY", out X, out Y, out CharSize);
            CF_24A_L4_DOS_From_YY = new FormFieldString(X, Y, CharSize);

            //To Date
            GetCoordinates("CF_24A_L4_DOS_To_MM", out X, out Y, out CharSize);
            CF_24A_L4_DOS_To_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L4_DOS_To_DD", out X, out Y, out CharSize);
            CF_24A_L4_DOS_To_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L4_DOS_To_YY", out X, out Y, out CharSize);
            CF_24A_L4_DOS_To_YY = new FormFieldString(X, Y, CharSize);

            //Place Of Service
            GetCoordinates("CF_24B_L4_POS_Code", out X, out Y, out CharSize);
            CF_24B_L4_POS_Code = new FormFieldString(X, Y, CharSize);

            //EMG - Emergency
            GetCoordinates("CF_24C_L4_EMG_Code", out X, out Y, out CharSize);
            CF_24C_L4_EMG_Code = new FormFieldString(X, Y, CharSize);

            //CPT/HCPCS 
            GetCoordinates("CF_24D_L4_CPT_HCPCS_Code", out X, out Y, out CharSize);
            CF_24D_L4_CPT_HCPCS_Code = new FormFieldString(X, Y, CharSize);

            //Modifiers
            GetCoordinates("CF_24D_L4_Modifier_1_Code", out X, out Y, out CharSize);
            CF_24D_L4_Modifier_1_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L4_Modifier_2_Code", out X, out Y, out CharSize);
            CF_24D_L4_Modifier_2_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L4_Modifier_3_Code", out X, out Y, out CharSize);
            CF_24D_L4_Modifier_3_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L4_Modifier_4_Code", out X, out Y, out CharSize);
            CF_24D_L4_Modifier_4_Code = new FormFieldString(X, Y, CharSize);

            //Diagnosis Pointers 
            GetCoordinates("CF_24E_L4_Diagnosis_Pointers", out X, out Y, out CharSize);
            CF_24E_L4_Diagnosis_Pointers = new FormFieldString(X, Y, CharSize);

            //Charges
            GetCoordinates("CF_24F_L4_Charges_Principal", out X, out Y, out CharSize);
            CF_24F_L4_Charges_Principal = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24F_L4_Charges_Secondary", out X, out Y, out CharSize);
            CF_24F_L4_Charges_Secondary = new FormFieldString(X, Y, CharSize);

            //Days or Units
            GetCoordinates("CF_24G_L4_Days_Units", out X, out Y, out CharSize);
            CF_24G_L4_Days_Units = new FormFieldString(X, Y, CharSize);

            //EPSDT Family Plan
            GetCoordinates("CF_24H_L4_EPSDT_FamilyPlan_Shaded", out X, out Y, out CharSize);
            CF_24H_L4_EPSDT_FamilyPlan_Shaded = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24H_L4_EPSDT_FamilyPlan", out X, out Y, out CharSize);
            CF_24H_L4_EPSDT_FamilyPlan = new FormFieldString(X, Y, CharSize);

            //Rendering Provider ID (NPI)
            GetCoordinates("CF_24J_L4_RenderingProvider_NPI", out X, out Y, out CharSize);
            CF_24J_L4_RenderingProvider_NPI = new FormFieldString(X, Y, CharSize);

            //Line Note
            GetCoordinates("CF_24A_L4_Note", out X, out Y, out CharSize);
            CF_24A_L4_Note = new FormFieldString(X, Y, CharSize);

            //Rendering Provider Other ID (Qualifier)
            GetCoordinates("CF_24J_L4_RenderingProvider_OtherQualifier", out X, out Y, out CharSize);
            CF_24J_L4_RenderingProvider_OtherQualifier = new FormFieldString(X, Y, CharSize);

            //Rendering Provider Other ID (Qualifier value)
            GetCoordinates("CF_24J_L4_RenderingProvider_OtherQualifiervalue", out X, out Y, out CharSize);
            CF_24J_L4_RenderingProvider_OtherQualifiervalue = new FormFieldString(X, Y, CharSize);
            ...
            //From Date.
            GetCoordinates("CF_24A_L5_DOS_From_MM", out X, out Y, out CharSize);
            CF_24A_L5_DOS_From_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L5_DOS_From_DD", out X, out Y, out CharSize);
            CF_24A_L5_DOS_From_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L5_DOS_From_YY", out X, out Y, out CharSize);
            CF_24A_L5_DOS_From_YY = new FormFieldString(X, Y, CharSize);

            //To Date
            GetCoordinates("CF_24A_L5_DOS_To_MM", out X, out Y, out CharSize);
            CF_24A_L5_DOS_To_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L5_DOS_To_DD", out X, out Y, out CharSize);
            CF_24A_L5_DOS_To_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L5_DOS_To_YY", out X, out Y, out CharSize);
            CF_24A_L5_DOS_To_YY = new FormFieldString(X, Y, CharSize);

            //Place Of Service
            GetCoordinates("CF_24B_L5_POS_Code", out X, out Y, out CharSize);
            CF_24B_L5_POS_Code = new FormFieldString(X, Y, CharSize);

            //EMG - Emergency
            GetCoordinates("CF_24C_L5_EMG_Code", out X, out Y, out CharSize);
            CF_24C_L5_EMG_Code = new FormFieldString(X, Y, CharSize);

            //CPT/HCPCS 
            GetCoordinates("CF_24D_L5_CPT_HCPCS_Code", out X, out Y, out CharSize);
            CF_24D_L5_CPT_HCPCS_Code = new FormFieldString(X, Y, CharSize);

            //Modifiers
            GetCoordinates("CF_24D_L5_Modifier_1_Code", out X, out Y, out CharSize);
            CF_24D_L5_Modifier_1_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L5_Modifier_2_Code", out X, out Y, out CharSize);
            CF_24D_L5_Modifier_2_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L5_Modifier_3_Code", out X, out Y, out CharSize);
            CF_24D_L5_Modifier_3_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L5_Modifier_4_Code", out X, out Y, out CharSize);
            CF_24D_L5_Modifier_4_Code = new FormFieldString(X, Y, CharSize);

            //Diagnosis Pointers 
            GetCoordinates("CF_24E_L5_Diagnosis_Pointers", out X, out Y, out CharSize);
            CF_24E_L5_Diagnosis_Pointers = new FormFieldString(X, Y, CharSize);

            //Charges
            GetCoordinates("CF_24F_L5_Charges_Principal", out X, out Y, out CharSize);
            CF_24F_L5_Charges_Principal = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24F_L5_Charges_Secondary", out X, out Y, out CharSize);
            CF_24F_L5_Charges_Secondary = new FormFieldString(X, Y, CharSize);

            //Days or Units
            GetCoordinates("CF_24G_L5_Days_Units", out X, out Y, out CharSize);
            CF_24G_L5_Days_Units = new FormFieldString(X, Y, CharSize);

            //EPSDT Family Plan
            GetCoordinates("CF_24H_L5_EPSDT_FamilyPlan_Shaded", out X, out Y, out CharSize);
            CF_24H_L5_EPSDT_FamilyPlan_Shaded = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24H_L5_EPSDT_FamilyPlan", out X, out Y, out CharSize);
            CF_24H_L5_EPSDT_FamilyPlan = new FormFieldString(X, Y, CharSize);

            //Rendering Provider ID (NPI)
            GetCoordinates("CF_24J_L5_RenderingProvider_NPI", out X, out Y, out CharSize);
            CF_24J_L5_RenderingProvider_NPI = new FormFieldString(X, Y, CharSize);

            //Rendering Provider Other ID (Qualifier)
            GetCoordinates("CF_24J_L5_RenderingProvider_OtherQualifier", out X, out Y, out CharSize);
            CF_24J_L5_RenderingProvider_OtherQualifier = new FormFieldString(X, Y, CharSize);

            //Rendering Provider Other ID (Qualifier value)
            GetCoordinates("CF_24J_L5_RenderingProvider_OtherQualifiervalue", out X, out Y, out CharSize);
            CF_24J_L5_RenderingProvider_OtherQualifiervalue = new FormFieldString(X, Y, CharSize);


            //Line Note
            GetCoordinates("CF_24A_L5_Note", out X, out Y, out CharSize);
            ...
            //From Date.
            GetCoordinates("CF_24A_L6_DOS_From_MM", out X, out Y, out CharSize);
            CF_24A_L6_DOS_From_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L6_DOS_From_DD", out X, out Y, out CharSize);
            CF_24A_L6_DOS_From_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L6_DOS_From_YY", out X, out Y, out CharSize);
            CF_24A_L6_DOS_From_YY = new FormFieldString(X, Y, CharSize);

            //To Date
            GetCoordinates("CF_24A_L6_DOS_To_MM", out X, out Y, out CharSize);
            CF_24A_L6_DOS_To_MM = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L6_DOS_To_DD", out X, out Y, out CharSize);
            CF_24A_L6_DOS_To_DD = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24A_L6_DOS_To_YY", out X, out Y, out CharSize);
            CF_24A_L6_DOS_To_YY = new FormFieldString(X, Y, CharSize);

            //Place Of Service
            GetCoordinates("CF_24B_L6_POS_Code", out X, out Y, out CharSize);
            CF_24B_L6_POS_Code = new FormFieldString(X, Y, CharSize);

            //EMG - Emergency
            GetCoordinates("CF_24C_L6_EMG_Code", out X, out Y, out CharSize);
            CF_24C_L6_EMG_Code = new FormFieldString(X, Y, CharSize);

            //CPT/HCPCS 
            GetCoordinates("CF_24D_L6_CPT_HCPCS_Code", out X, out Y, out CharSize);
            CF_24D_L6_CPT_HCPCS_Code = new FormFieldString(X, Y, CharSize);

            //Modifiers
            GetCoordinates("CF_24D_L6_Modifier_1_Code", out X, out Y, out CharSize);
            CF_24D_L6_Modifier_1_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L6_Modifier_2_Code", out X, out Y, out CharSize);
            CF_24D_L6_Modifier_2_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L6_Modifier_3_Code", out X, out Y, out CharSize);
            CF_24D_L6_Modifier_3_Code = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24D_L6_Modifier_4_Code", out X, out Y, out CharSize);
            CF_24D_L6_Modifier_4_Code = new FormFieldString(X, Y, CharSize);

            //Diagnosis Pointers 
            GetCoordinates("CF_24E_L6_Diagnosis_Pointers", out X, out Y, out CharSize);
            CF_24E_L6_Diagnosis_Pointers = new FormFieldString(X, Y, CharSize);

            //Charges
            GetCoordinates("CF_24F_L6_Charges_Principal", out X, out Y, out CharSize);
            CF_24F_L6_Charges_Principal = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24F_L6_Charges_Secondary", out X, out Y, out CharSize);
            CF_24F_L6_Charges_Secondary = new FormFieldString(X, Y, CharSize);

            //Days or Units
            GetCoordinates("CF_24G_L6_Days_Units", out X, out Y, out CharSize);
            CF_24G_L6_Days_Units = new FormFieldString(X, Y, CharSize);

            //EPSDT Family Plan
            GetCoordinates("CF_24H_L6_EPSDT_FamilyPlan_Shaded", out X, out Y, out CharSize);
            CF_24H_L6_EPSDT_FamilyPlan_Shaded = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_24H_L6_EPSDT_FamilyPlan", out X, out Y, out CharSize);
            CF_24H_L6_EPSDT_FamilyPlan = new FormFieldString(X, Y, CharSize);

            //Rendering Provider ID (NPI)
            GetCoordinates("CF_24J_L6_RenderingProvider_NPI", out X, out Y, out CharSize);
            CF_24J_L6_RenderingProvider_NPI = new FormFieldString(X, Y, CharSize);

            //Rendering Provider Other ID (Qualifier)
            GetCoordinates("CF_24J_L6_RenderingProvider_OtherQualifier", out X, out Y, out CharSize);
            CF_24J_L6_RenderingProvider_OtherQualifier = new FormFieldString(X, Y, CharSize);

            //Rendering Provider Other ID (Qualifier value)
            GetCoordinates("CF_24J_L6_RenderingProvider_OtherQualifiervalue", out X, out Y, out CharSize);
            CF_24J_L6_RenderingProvider_OtherQualifiervalue = new FormFieldString(X, Y, CharSize);



            //Line Note
            GetCoordinates("CF_24A_L6_Note", out X, out Y, out CharSize);
            CF_24A_L6_Note = new FormFieldString(X, Y, CharSize);

            #endregion

            GetCoordinates("CF_25_FederalTax_ID_No", out X, out Y, out CharSize);
            CF_25_FederalTax_ID_No = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_25_FederalTaxID_Qualifier_SSN", out X, out Y, out CharSize);
            CF_25_FederalTaxID_Qualifier_SSN = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_25_FederalTaxID_Qualifier_EIN", out X, out Y, out CharSize);
            CF_25_FederalTaxID_Qualifier_EIN = new FormFieldBoolean(X, Y);

            GetCoordinates("CF_26_PatientAccount_No", out X, out Y, out CharSize);
            CF_26_PatientAccount_No = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_27_AcceptAssignment_YES", out X, out Y, out CharSize);
            CF_27_AcceptAssignment_YES = new FormFieldBoolean(X, Y);
            GetCoordinates("CF_27_AcceptAssignment_NO", out X, out Y, out CharSize);
            CF_27_AcceptAssignment_NO = new FormFieldBoolean(X, Y);

            GetCoordinates("CF_28_TotalCharge_Principal", out X, out Y, out CharSize);
            CF_28_TotalCharge_Principal = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_28_TotalCharge_Secondary", out X, out Y, out CharSize);
            CF_28_TotalCharge_Secondary = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_29_AmountPaid_Principal", out X, out Y, out CharSize);
            CF_29_AmountPaid_Principal = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_29_AmountPaid_Secondary", out X, out Y, out CharSize);
            CF_29_AmountPaid_Secondary = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_30_BalanceDue_Principal", out X, out Y, out CharSize);
            CF_30_BalanceDue_Principal = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_30_Rsvd_for_NUCC_Use", out X, out Y, out CharSize);
            CF_30_Rsvd_for_NUCC_Use = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_31_Physician_Supplier_Signature", out X, out Y, out CharSize);
            CF_31_Physician_Supplier_Signature = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_31_Physician_Supplier_Signature_Date", out X, out Y, out CharSize);
            CF_31_Physician_Supplier_Signature_Date = new FormFieldString(X, Y, CharSize); //(519, 2078);
            GetCoordinates("CF_31_Physician_Supplier_QualifierValue", out X, out Y, out CharSize);
            CF_31_Physician_Supplier_QualifierValue = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_32_Service_Facility_Name", out X, out Y, out CharSize);
            CF_32_Service_Facility_Name = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_32_Service_Facility_Address_Line1", out X, out Y, out CharSize);
            CF_32_Service_Facility_Address_Line1 = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_32_Service_Facility_Address_Line2", out X, out Y, out CharSize);
            CF_32_Service_Facility_Address_Line2 = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_32_Service_Facility_City", out X, out Y, out CharSize);
            CF_32_Service_Facility_City = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_32_Service_Facility_State", out X, out Y, out CharSize);
            CF_32_Service_Facility_State = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_32_Service_Facility_Zip", out X, out Y, out CharSize);
            CF_32_Service_Facility_Zip = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_32a_Service_Facility_NPI", out X, out Y, out CharSize);
            CF_32a_Service_Facility_NPI = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_32b_Service_Facility_UPIN_OtherID", out X, out Y, out CharSize);
            CF_32b_Service_Facility_UPIN_OtherID = new FormFieldString(X, Y, CharSize);

            GetCoordinates("CF_33_BillingProvider_Name", out X, out Y, out CharSize);
            CF_33_BillingProvider_Name = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_33_BillingProvider_Address_Line1", out X, out Y, out CharSize);
            CF_33_BillingProvider_Address_Line1 = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_33_BillingProvider_Address_Line2", out X, out Y, out CharSize);
            CF_33_BillingProvider_Address_Line2 = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_33_BillingProvider_City", out X, out Y, out CharSize);
            CF_33_BillingProvider_City = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_33_BillingProvider_State", out X, out Y, out CharSize);
            CF_33_BillingProvider_State = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_33_BillingProvider_Zip", out X, out Y, out CharSize);
            CF_33_BillingProvider_Zip = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_33a_BillingProvider_NPI", out X, out Y, out CharSize);
            CF_33a_BillingProvider_NPI = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_33b_BillingProvider_UPIN_OtherID", out X, out Y, out CharSize);
            CF_33b_BillingProvider_UPIN_OtherID = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_33_BillingProvider_Tel_AreaCode", out X, out Y, out CharSize);
            CF_33_BillingProvider_Tel_AreaCode = new FormFieldString(X, Y, CharSize);
            GetCoordinates("CF_33_BillingProvider_Tel_Number", out X, out Y, out CharSize);
        ...
        public void InitializeBoxesForPrintForm()
        {
            ...
            //.Insurance Type
            CF_1_Insuracne_Type_Medicare = new FormFieldBoolean(X + 5, Y + 122);
            CF_1_Insuracne_Type_Medicaid = new FormFieldBoolean(X + 73, Y + 122);
            CF_1_Insuracne_Type_Tricare = new FormFieldBoolean(X + 143, Y + 122);
            CF_1_Insuracne_Type_Champva = new FormFieldBoolean(X + 234, Y + 122);
            CF_1_Insuracne_Type_GroupHealthPlan = new FormFieldBoolean(X + 304, Y + 122);
            CF_1_Insuracne_Type_FECA = new FormFieldBoolean(X + 385, Y + 125);
            CF_1_Insuracne_Type_Other = new FormFieldBoolean(X + 444, Y + 122);
            ...
            //.Patient's Sex
            CF_3_Patient_Sex_Male = new FormFieldBoolean(X + 414, Y + 155);
            CF_3_Patient_Sex_Female = new FormFieldBoolean(X + 464, Y + 155);
            ...
            //.Paient Relationship to Insured
            CF_6_PatientRelationship_Self = new FormFieldBoolean(X + 324, Y + 189);
            CF_6_PatientRelationship_Spouse = new FormFieldBoolean(X + 375, Y + 189);
            CF_6_PatientRelationship_Child = new FormFieldBoolean(X + 415, Y + 189);
            CF_6_PatientRelationship_Other = new FormFieldBoolean(X + 464, Y + 189);
            ...
            CF_9_c_Reserved_For_Nucc_Use = new FormFieldString(X + 14, Y + 390);
            CF_9_Other_Insureds_InsuracnePlan = new FormFieldString(X + 14, Y + 424);

            //.Patient Condition 
            CF_10_PatientConditionTo_Employement_Yes = new FormFieldBoolean(X + 345, Y + 323);
            CF_10_PatientConditionTo_Employement_No = new FormFieldBoolean(X + 404, Y + 323);
            CF_10_PatientConditionTo_AutoAccident_Yes = new FormFieldBoolean(X + 345, Y + 357);
            CF_10_PatientConditionTo_AutoAccident_No = new FormFieldBoolean(X + 405, Y + 357);
            CF_10_PatientConditionTo_AutoAccident_State = new FormFieldString(X + 450, Y + 358);
            CF_10_PatientConditionTo_OtherAccident_Yes = new FormFieldBoolean(X + 345, Y + 389);
            CF_10_PatientConditionTo_OtherAccident_No = new FormFieldBoolean(X + 404, Y + 389);
            ...
            CF_11_Insureds_Sex_Male = new FormFieldBoolean(X + 674, Y + 322);
            CF_11_Insureds_Sex_Female = new FormFieldBoolean(X + 745, Y + 322);
            CF_11_Other_Claim_ID_Designated_by_NUCC = new FormFieldString(X + 520, Y + 356);
            CF_11_Insureds_InsuracnePlan = new FormFieldString(X + 502, Y + 390);
            CF_11_Insureds_OtherHealthPlan_Yes = new FormFieldBoolean(X + 514, Y + 423);
            CF_11_Insureds_OtherHealthPlan_No = new FormFieldBoolean(X + 566, Y + 423);
           //CF_11_Qualifier_No 11272013

            CF_11_Qualifier_No = new FormFieldString(X + 498, Y + 356);
            ...
            CF_14_Date_Of_Current_Illness_Injury_or_Pregnancy_LMP_MM = new FormFieldString(X + 18, Y + 525);//gloPM5040
            CF_14_Date_Of_Current_Illness_Injury_or_Pregnancy_LMP_DD = new FormFieldString(X + 48, Y + 525);
            CF_14_Date_Of_Current_Illness_Injury_or_Pregnancy_LMP_YY = new FormFieldString(X + 82, Y + 525);
            //CF_14_Qualifier_No 11272013
            CF_14_Qualifier_No = new FormFieldString(X + 158, Y + 525);

            CF_15_Other_Dates_MM = new FormFieldString(X + 370, Y + 525);
            CF_15_Other_Date_DD = new FormFieldString(X + 397, Y + 525);
            CF_15_Other_Date_YY = new FormFieldString(X + 428, Y + 525);

            CF_15_Qualifier_No = new FormFieldString(X + 303, Y + 525);
            ...
            CF_17_ReferringProvider_Name = new FormFieldString(X + 40, Y + 557);
            CF_17_ReferringProvider_Qaulifier = new FormFieldString(X +10, Y + 557);
            ...
            CF_21_Icd_Ind_No = new FormFieldString(X + 416, Y + 608);
            CF_21_Icd_Ind = new FormFieldString(X + 437, Y + 608);
            
            CF_21_Diagnosis_A_Principal = new FormFieldString(X + 29, Y + 625);
            CF_21_Diagnosis_1_Secondary = new FormFieldString(X + 69, Y + 625);

            CF_21_Diagnosis_B_Principal = new FormFieldString(X + 160, Y + 625);
            CF_21_Diagnosis_2_Secondary = new FormFieldString(X + 340, Y + 625);

            CF_21_Diagnosis_C_Principal = new FormFieldString(X + 291, Y + 625);
            CF_21_Diagnosis_3_Secondary = new FormFieldString(X + 69, Y + 657);

            CF_21_Diagnosis_D_Principal = new FormFieldString(X + 422, Y + 625);
            CF_21_Diagnosis_4_Secondary = new FormFieldString(X + 340, Y + 657);



            CF_21_Diagnosis_E_Principal = new FormFieldString(X + 29, Y + 641);
            CF_21_Diagnosis_F_Principal = new FormFieldString(X + 160, Y + 641);
            CF_21_Diagnosis_G_Principal = new FormFieldString(X + 291, Y + 641);
            CF_21_Diagnosis_H_Principal = new FormFieldString(X + 422, Y + 641);
            CF_21_Diagnosis_I_Principal = new FormFieldString(X + 29, Y + 657);
            CF_21_Diagnosis_J_Principal = new FormFieldString(X + 160, Y + 657);
            CF_21_Diagnosis_K_Principal = new FormFieldString(X + 291, Y + 657);
            CF_21_Diagnosis_L_Principal = new FormFieldString(X + 422, Y + 657);


            CF_22_Resubmission = new FormFieldString(X + 511, Y + 625);
       ...
       //     bool CF_IsPresent_Line1 = false;
            ...
            //Diagnosis Pointers 
            CF_24E_L1_Diagnosis_Pointers = new FormFieldString(X + 444, Y + 725);
       ...
       //     bool CF_IsPresent_Line2 = false;
            ...
            //Diagnosis Pointers 
            CF_24E_L2_Diagnosis_Pointers = new FormFieldString(X + 444, Y + 758);
     ...
     //       bool CF_IsPresent_Line3 = false;
            ...
            //Diagnosis Pointers 
            CF_24E_L3_Diagnosis_Pointers = new FormFieldString(X + 444, Y + 791);
       ...
       //     bool CF_IsPresent_Line4 = false;
            ...
            //Diagnosis Pointers 
            CF_24E_L4_Diagnosis_Pointers = new FormFieldString(X + 444, Y + 824);
        ...
        //    bool CF_IsPresent_Line5 = false;
            ...
            //Diagnosis Pointers 
            CF_24E_L5_Diagnosis_Pointers = new FormFieldString(X + 444, Y + 857);
   ...
   //         bool CF_IsPresent_Line6 = false;
            ...
            //Diagnosis Pointers 
            CF_24E_L6_Diagnosis_Pointers = new FormFieldString(X + 444, Y + 890);
            ...
            CF_30_Rsvd_for_NUCC_Use = new FormFieldString(X + 768, Y + 923);
        ...
        private DataTable GetPrinterSettingNew( string  sPrinterName ="Default")
        {
            try
            {
                ...
                gloDatabaseLayer.DBLayer oDB = new gloDatabaseLayer.DBLayer(_DataBaseConnectionString);
                _Query = " SELECT ISNULL(sBoxName,'') AS sBoxName, ISNULL(nXCoordinate,0) AS nXCoordinate, ISNULL(nYCoordinate,0) AS nYCoordinate, ISNULL(sPrinterName,'') AS sPrinterName " +
                        " FROM BL_NewCMS1500PrintSettings WHERE nClinicID = 1 AND nFormType = 1 and UPPER(RTRIM(LTRIM(sPrinterName)))='" + sPrinterName.Trim().ToUpper()  + "'";
                oDB.Connect(false);
                oDB.Retrive_Query(_Query, out dtSettings);
                oDB.Disconnect();
                oDB.Dispose();
        ...
        private DataTable GetDefaultPrinterSettingNew(string sPrinterName = "Default")
        {
            try
            {
                ...
                gloDatabaseLayer.DBLayer oDB = new gloDatabaseLayer.DBLayer(_DataBaseConnectionString);
                _Query = " SELECT ISNULL(sBoxName,'') AS sBoxName, ISNULL(nXCoordinate,0) AS nXCoordinate, ISNULL(nYCoordinate,0) AS nYCoordinate, ISNULL(sPrinterName,'') AS sPrinterName " +
                        " FROM BL_NewCMS1500PrintSettings WHERE nClinicID = 1 AND nFormType = 0  and UPPER(RTRIM(LTRIM(sPrinterName)))='" + sPrinterName.Trim().ToUpper() + "'";
                oDB.Connect(false);
                oDB.Retrive_Query(_Query, out dtSettings);
                oDB.Disconnect();
                oDB.Dispose();
        ...
        private DataTable GetPrinterCoordinates(string sPrinterName = "Default", Int16 FormType = 0)
        {
            ...
            try
            {
                oDB.Connect(false);
                oParameters.Clear();
                oParameters.Add("@PaperForm", "CMS1500", ParameterDirection.Input, SqlDbType.VarChar);
