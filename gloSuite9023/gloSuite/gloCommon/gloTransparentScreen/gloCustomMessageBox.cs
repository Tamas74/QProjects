 ...
 * Usage examples:
 * 
 *  gloCustomMessageBox.Show("Just a text");
 * 
 *  gloCustomMessageBox.Show("A text", 
 *                          "A caption"); 
 *  
 *  gloCustomMessageBox.Show("Some text with a link: www.google.com", 
 *                          "Some caption",
 *                          MessageBoxButtons.AbortRetryIgnore, 
 *                          MessageBoxIcon.Information,
 *                          MessageBoxDefaultButton.Button2);
 *  
 *  var dialogResult = gloCustomMessageBox.Show("Do you know the answer to life the universe and everything?", 
 *                                             "One short question",
...
{
    public class gloCustomMessageBox
    {
        ...
        public static DialogResult Show(string text, string[] buttonTexts = null)
        {
            return gloCustomMessageBoxForm.Show(null, text, string.Empty, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1, buttonTexts);
        }
        ...
        /// <param name="text">The text.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(IWin32Window owner, string text, string[] buttonTexts = null)
        {
            return gloCustomMessageBoxForm.Show(owner, text, string.Empty, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1, buttonTexts);
        }
        ...
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(string text, string caption, string[] buttonTexts = null)
        {
            return gloCustomMessageBoxForm.Show(null, text, caption, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1, buttonTexts);
        }
        ...
        /// <param name="caption">The caption.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(IWin32Window owner, string text, string caption, string[] buttonTexts = null)
        {
            return gloCustomMessageBoxForm.Show(owner, text, caption, MessageBoxButtons.OK, MessageBoxIcon.None, MessageBoxDefaultButton.Button1, buttonTexts);
        }
        ...
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(string text, string caption, MessageBoxButtons buttons, string[] buttonTexts = null)
        {
            return gloCustomMessageBoxForm.Show(null, text, caption, buttons, MessageBoxIcon.None, MessageBoxDefaultButton.Button1, buttonTexts);
        }
        ...
        /// <param name="buttons">The buttons.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, string[] buttonTexts = null)
        {
            return gloCustomMessageBoxForm.Show(owner, text, caption, buttons, MessageBoxIcon.None, MessageBoxDefaultButton.Button1, buttonTexts);
        }
        ...
        /// <returns></returns>
        public static DialogResult Show(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, string[] buttonTexts = null)
        {
            return gloCustomMessageBoxForm.Show(null, text, caption, buttons, icon, MessageBoxDefaultButton.Button1, buttonTexts);
        }
        ...
        /// <param name="icon">The icon.</param>
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(IWin32Window owner, string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, string[] buttonTexts = null)
        {
            return gloCustomMessageBoxForm.Show(owner, text, caption, buttons, icon, MessageBoxDefaultButton.Button1, buttonTexts);
        }
        ...
        /// <returns>The dialog result.</returns>
        public static DialogResult Show(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton, string[] buttonTexts = null)
        {
            return gloCustomMessageBoxForm.Show(null, text, caption, buttons, icon, defaultButton, buttonTexts);
        }
        ...
        {
            return gloCustomMessageBoxForm.Show(owner, text, caption, buttons, icon, defaultButton, buttonTexts);
        }
        ...
        ///// It is defined as an internal class to keep the public interface of the gloCustomMessageBox clean.
        ///// </summary>
        //class gloCustomMessageBoxForm : Form
        //{
