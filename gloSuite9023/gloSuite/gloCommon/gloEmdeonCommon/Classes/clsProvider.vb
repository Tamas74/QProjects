...
#Region "   Private Variables"
    ...
    Dim _sZIP As String
    Dim _sPhone As String
    Dim _sFAX As String
    Dim _sMobile As String
    Dim _sPager As String
...
#Region "   Public Functions"
    ...
    Public Function GetProviderImageWidth(ByVal ProviderID As Int64) As Integer
        ...
        Dim objConnMain As SqlConnection = Nothing
        Dim cmdMain As SqlCommand = Nothing
        Dim intWidth As Integer

        Try

            strSQL = "SELECT imgSignature from Provider_MST Where nProviderID=" & ProviderID
            objConnMain = New SqlConnection(GetConnectionString())
            cmdMain = New SqlCommand(strSQL, objConnMain)
            objConnMain.Open()

            Dim arrImage As Byte() = cmdMain.ExecuteScalar()
    ...
    Public Function GetPatientProvider(ByVal nPatientID As Long) As Int64
        ...
        Try
            ...
            Dim strResult As String = oDB.GetRecord_Query(strSQL)
            If Not IsDBNull(strResult) Then
                Dim nProviderId As Int64 = CType(strResult, Int64)
    ...
    Public Function ChangeProvider(ByVal nVisitId As Long, ByVal nPatientID As Long, ByVal strProviderName As String, Optional ByVal blnChangevisit As Boolean = True) As Boolean
        Dim blnChangePatient As Boolean
        Try
    ...
    Public Function CheckSignDelegateStatus() As Boolean
        ...
        Dim strSQL As String
        Try
            strSQL = "SELECT sSettingsValue from settings where sSettingsName Like '%USESIGNATUREDELEGATES%'"
            Dim strResult As String = oDB.GetRecord_Query(strSQL)
            If Not IsDBNull(strResult) Then
    ...
    Public Function AddUserNameInProviderSignature() As Integer
        ...
        Try
            ...
            End If
        Catch ex As Exception
            AddUserNameInProviderSignature = Nothing
            Throw ex
        Finally
            oDB.Dispose()
            oDB = Nothing
    ...
    Public Sub SaveProviderAssociation(ByVal nProviderID As Int64, ByVal arrSeniorProvider As ArrayList)
        ...
        Dim oTranactionBegiined As Boolean = False
