...
Public Class frmAddDicom_Acknowledgement
    ...
    Public Sub New(ByVal DICOMID As Long, ByVal DICOMDetID As Long, ByVal IsAck As Boolean, ByVal nPatientId As Long)
    ...
    Private Sub tlb_Ok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tlb_Ok.Click
        Try
            ...
            machineid = GetPrefixTransactionID(_nPatientID)
