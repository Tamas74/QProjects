Public Class myTreeNode
    ...
    Sub New(ByVal DrugID As Long, ByVal drugName As String)
        MyBase.New(drugName)
        MyBase.Tag = drugName
        mykey = DrugID
    End Sub
    ...
    Public Property TemplateName() As String
        ...
        End Set
    End Property
    Public Property sCVXCode() As String = String.Empty


    Public Property sCVXDesc() As String = String.Empty

    ''loinc code and desc added
    Public Property sLoincCode() As String = String.Empty


    Public Property sLoincDescr() As String = String.Empty

    ''reason  code added 
    'Public Property sReasonCode() As String = String.Empty


    'Public Property sReasonDescr() As String = String.Empty

    Public Property ReasonConceptCode() As String= String.Empty



    Public Property ReasonConceptDesc() As String= String.Empty
    ...
    Public Property CQMId() As String
        Get
            Return _CQMId
        End Get
        Set(ByVal Value As String)
