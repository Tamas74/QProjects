...
Public Class gloLabUC_LabHistory
    ...
    Public Event gUC_gloLabRightClick(ByVal OrderID As Int64)
...
#End Region
    ...
    Private Sub trvHistory_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles trvHistory.MouseDown
        ...
        Try
            trvHistory.SelectedNode = trvHistory.GetNodeAt(e.X, e.Y)

            If e.Button = Windows.Forms.MouseButtons.Right Then
                If Not trvHistory.SelectedNode Is Nothing Then
                    If Mid(trvHistory.SelectedNode.Tag, 1, 1) <> "R" Then
                        RaiseEvent gUC_gloLabRightClick(Convert.ToInt64(trvHistory.SelectedNode.Tag))
                    End If
                End If
                Try
