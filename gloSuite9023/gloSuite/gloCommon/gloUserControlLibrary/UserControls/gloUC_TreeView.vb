...
#Region " Private Variables "
    ...
    Private _MaxNode As Int32 = 1100
    ...
    Private _AllergyClassID As String ''added for 2015 certification
    Private _RxNormCode As String ''added for 2015 certification
...
#Region " Public Properties "
    ...
    Public Property EducationMappingSearchType() As Integer
        ...
        End Set
    End Property
    Public Property DisplayContextMenuStrip() As ContextMenuStrip
        Get
            Return bDisplayContextMenuStrip
        End Get
        Set(ByVal value As ContextMenuStrip)
            bDisplayContextMenuStrip = value
        End Set
    End Property
    ...
    Public Property CodeMember() As String
        ...
        End Set
    End Property
    Public Property RowOrderMember() As String
        Get
            Return _RowOrderMember
        End Get
        Set(ByVal value As String)
            _RowOrderMember = value
        End Set
    End Property
    ''' <summary>
    ...
    ''' <summary>
    ''' Gets or sets the Allergy Class ID to the control.
    ''' </summary>
    Public Property AllergyClassID() As String ''added for 2015 certification
        Get
            Return _AllergyClassID
        End Get
        Set(ByVal value As String)
            _AllergyClassID = value
        End Set
    End Property
    ...
    ''' Gets or sets the Allergy Class ID to the control.
    ''' </summary>
    Public Property RxNormCode() As String ''added for 2015 certification
        Get
            Return _RxNormCode
        End Get
        Set(ByVal value As String)
    ...
    Public Property CQMID() As String ''added for 2015 certification
        Get
            Return _CqmId
        End Get
        Set(ByVal value As String)
        ...
        End Set
    End Property
    Public Property CQMDESC() As String ''added for 2015 certification
        Get
            Return _CqmDesc
        End Get
        Set(ByVal value As String)
    ...
    Public Property DDIDMember() As String
        ...
        End Set
    End Property
    Public Property mpidmember() As String
        Get
            Return _mpidMember
        End Get
        Set(ByVal value As String)
...
#Region " Control Events "
    ...
    Public Event MouseUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs)
    ...
    Private Sub txtsearch_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtsearch.KeyPress
        ...
        txtsearch.Tag = ""  ''added for bugid 82931
    ...
    'Bug #82429: 00000905: DxCPT Search issue 
...
#Region " Public Methods "
    ...
    Public Sub FillTreeView()
        ...
        Try
            ...
            Select Case _SortType
                ...
                Case enumSortType.RowOrder
                    dvSort.Sort = RowOrderMember
            End Select
    ...
    Public Function SelectNode(ByVal _selectedNodeID As Long) As myTreeNode
        If trvMain.Nodes.Count > 0 Then
            If _selectedNodeID <> 0 Then
                For iTree As Integer = 0 To trvMain.Nodes.Count - 1
                    Dim _id As Long = CType(trvMain.Nodes(iTree), myTreeNode).ID
                    If (_selectedNodeID = _id) Then
                        trvMain.SelectedNode = trvMain.Nodes(iTree)
                        Return trvMain.SelectedNode
                    End If
                Next
            End If
...
#Region " Private Methods "
    ...
    Public Sub FillTree(Optional ByVal searchText As String = "")
        Try
            Dim blnCptDesc As Boolean = False
            If bIsDiagnosisSearch = False Then
                If searchText <> "" Then
                    ...
                    ''code change for bugid 86582
                    If dvSort.Table.Columns.Contains(col_DisplayText) And dvSort.Table.Columns.Contains("sCPTCode") And dvSort.Table.Columns.Contains("sDescription") Then
                        If _SearchType = enumSearchType.Simple Then
                            dvSort.RowFilter = col_DisplayText & " LIKE '" & searchText.Trim() & "%'" & " OR " & "sCPTCode LIKE '" & searchText.Trim() & "%'" & " OR " & "sdescription LIKE '" & searchText.Trim() & "%'"
            ...
            If blnCptDesc = True Then
                If Me.ColonAsSeparator Then
                    For Each dr As DataRow In dtSort.Select(col_DisplayText & " is null")
                        dr(col_DisplayText) = dr("sCPTCode") & " : " & Convert.ToString(dr("sDescription")).Trim()
    ...
    Private Sub FillLevelZeroTree()
        ...
        For index As Integer = 0 To dtSort.Rows.Count - 1
            ...
            '' BIND mpid ''
            If _mpidMember <> "" Then
                oNode.mpid = CType(dtSort.Rows(index)(_mpidMember), Int32)
            End If
            ...
            Else
                oNode.Text = ""
            End If
            If (_AllergyClassID <> "") AndAlso (dtSort.Columns.Contains(_AllergyClassID)) Then
                oNode.AllergyClassID = dtSort.Rows(index)(_AllergyClassID)
            End If

            If (_RxNormCode <> "") AndAlso (dtSort.Columns.Contains(_RxNormCode)) Then
                oNode.RxNormCode = dtSort.Rows(index)(_RxNormCode)
            End If

            If dtSort.Columns.Contains("sLoincCode") Then
                oNode.sLoincCode = Convert.ToString(dtSort.Rows(index)("sLoincCode"))
                If dtSort.Columns.Contains("sLoincDescr") Then
                    oNode.sLoincDescr = Convert.ToString(dtSort.Rows(index)("sLoincDescr"))
                End If
            End If

            ''to change here
            If dtSort.Columns.Contains("ReasonConceptCode") Then
                oNode.ReasonConceptCode = Convert.ToString(dtSort.Rows(index)("ReasonConceptCode"))
                If dtSort.Columns.Contains("ReasonConceptDesc") Then
                    oNode.ReasonConceptDesc = Convert.ToString(dtSort.Rows(index)("ReasonConceptDesc"))
                End If
            End If


            If (_SmartTreatmentId <> "") AndAlso (dtSort.Columns.Contains("SmartTreatmentId")) Then
            ...
            If IsNothing(dtParent) = False Then
                For iParent As Integer = 0 To dtParent.Rows.Count - 1
                    ...
                    For index As Integer = 0 To dtChild.Rows.Count - 1
                        ...
                        '' BIND mpid ''
                        If _mpidMember <> "" Then
                            oChildNode.mpid = CType(dtChild.Rows(index)(_mpidMember), Int32)
                        End If
                        ...
                        Else
                            oChildNode.Text = ""
                        End If
                        If dtChild.Columns.Contains("sLoincCode") Then
                            oChildNode.sLoincCode = Convert.ToString(dtChild.Rows(index)("sLoincCode"))
                            If dtChild.Columns.Contains("sLoincDescr") Then
                                oChildNode.sLoincDescr = Convert.ToString(dtChild.Rows(index)("sLoincDescr"))
                            End If
                        End If

                        If (_AllergyClassID <> "") AndAlso dtSort.Columns.Contains(_AllergyClassID) Then
                            oChildNode.AllergyClassID = dtSort.Rows(index)(_AllergyClassID)
                        End If

                        If _RxNormCode <> "" AndAlso dtSort.Columns.Contains(_RxNormCode) Then
                            oChildNode.RxNormCode = dtSort.Rows(index)(_RxNormCode)
                        End If
                        ...
                        oChildNode = Nothing
                    Next
                    If (IsNothing(dtChild) = False) Then
                        dtChild.Dispose()
                        dtChild = Nothing
                    End If
...
#End Region
    ...
    Private Sub trvMain_MouseUp(sender As Object, e As System.Windows.Forms.MouseEventArgs) Handles trvMain.MouseUp
