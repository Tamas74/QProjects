...
Partial Class gloUC_TreeView
    ...
    Protected Overrides Sub Dispose(ByVal disposing As Boolean)
        Try
            ...
            End If
            Try
                If disposing AndAlso dvSort IsNot Nothing Then
                    dvSort.Dispose()
                End If
            ...
            Try
                If disposing AndAlso oColSelectedNodes IsNot Nothing Then
            ...
            End Try
            Try
                If disposing AndAlso arrSelectedNodeIDs IsNot Nothing Then
