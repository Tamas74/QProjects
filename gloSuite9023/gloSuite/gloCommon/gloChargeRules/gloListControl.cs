...
namespace ChargeRules
{
    ...
    public partial class gloListControl : UserControl
    {
       ...
       // gloDatabaseLayer.DBParameters oParameters = new gloDatabaseLayer.DBParameters();
        ...
        public gloListControl(gloGridListControlType ControlType, bool IsMultiSelect, int ControlWidth, int ParentRowIndex, int ParentColIndex)
        {
        ...
        public gloListControl(gloGridListControlType ControlType, string ControlHeader,bool IsMultiSelect, int ControlWidth, int ParentRowIndex, int ParentColIndex)
        {
