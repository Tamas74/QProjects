...
namespace ChargeRules
{
    public partial class frmRuleEditor : Form 
    {
       ...
       #region "Constructor"
            ...
            public frmRuleEditor(Int64 RuleID)
            {
                InitializeComponent();
       ...
       #region "Form Load Event"
            ...
            private void frmRuleEditor_Load(object sender, EventArgs e)
            {
    ...
    //End Sub
        ...
        private bool OpenInternalControl(gloGridListControlType ControlType, string ControlHeader, bool IsMultiSelect, int RowIndex, int ColIndex, string SearchText, int pnlwidth)
        {
            ...
            try
            {
                ...
                ogloGridListControl = new gloListControl(ControlType, ControlHeader, true, pnlInternalControl.Width, RowIndex, ColIndex);
                //ogloGridListControl2.ItemSelected += new gloListControl.Item_Selected(ogloGridListControl2_ItemSelected);
