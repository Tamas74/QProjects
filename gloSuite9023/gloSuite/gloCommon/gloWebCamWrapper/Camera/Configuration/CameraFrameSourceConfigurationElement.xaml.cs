...
using gloStreamWebCamera.Shared.Extensions;

namespace gloStreamWebCamera.Camera.Configuration
{
    /// <summary>
    ...
    public partial class CameraFrameSourceConfigurationElement : UserControl
    {
        ...
        private void NewFrame(gloStreamWebCamera.Contracts.IFrameSource frameSource, gloStreamWebCamera.Contracts.Frame frame, double fps)
        {
