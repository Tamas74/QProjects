...
{
    public partial class gloPAGuarantorControl : UserControl
    {

        #region "Constructor And Destructor"

        public gloPAGuarantorControl(string ConnectionString)
        {
            InitializeComponent();
        ...
        private bool ValidateData()
        {
            ...
            //date of birth            
            if (mskGIDOB.Text != "" && mskGIDOB.Text != "  /  /")
            {
                if (mskGIDOB.MaskCompleted == false)
                {
                ...
                {
                    mskGIDOB.TextMaskFormat = MaskFormat.IncludeLiterals;
                    Convert.ToDateTime(mskGIDOB.Text.Trim()).ToString("MM/dd/yyyy");
                    long year = Convert.ToInt64(mskGIDOB.Text.Trim().Substring(6, 4));
                    if (1754 > year || year > 9999)
                        throw new Exception();
                }
                catch
                {
                    //Please enter a valid date of birth for the guarantor(MM/DD/YYYY).
                    MessageBox.Show("Enter a valid date of birth.  ", _messageboxcaption, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    mskGIDOB.Focus();
                    return false;
                }
        ...
        private bool IsModified(PatientOtherContact oGuarantor)
        {
            ...
            try
            {
                ...
                if (txtGIPatFName.Text == oGuarantor.FirstName
                    ...
                    && txtGIFax.Text == oGuarantor.Fax.Replace(" ", "")
        ...
        private void gloPatientGuarantor_Load(object sender, EventArgs e)
        {
            ...
            oAddresscontrol.Name = "GuarantorAddressControl";
            ...
            {
                //gloCommon.Cls_TabIndexSettings.TabScheme scheme = gloCommon.Cls_TabIndexSettings.TabScheme.AcrossFirst;
                //gloCommon.Cls_TabIndexSettings tom = new gloCommon.Cls_TabIndexSettings(this);
                    ...
                    case "Save":
                        {
                            ...
                            if (proceedSave)
                            {
                                ...
                                if (GetData())
                                {
                                    oAddresscontrol.ControlClosing = true;
        ...
        private void chkCommercialGuarantor_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (chkCommercialGuarantor.Checked == true)
            {
                pnlCommercialGuarantor.Visible = true;
                pnlPersonalGuarantor.Visible = false;
                pnlGIPersonalDetails.Height = 82;  //107 height for pnlstatus//
            }
            else //Indicates Personal Guarantor
            {
                pnlPersonalGuarantor.Visible = true;
                pnlCommercialGuarantor.Visible = false;
                pnlGIPersonalDetails.Height = 183;
