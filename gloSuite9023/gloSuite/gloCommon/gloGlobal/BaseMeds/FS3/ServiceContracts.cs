...
namespace gloGlobal.FS3
{
    ...
    public class DrugFormularyInfo : IDisposable
    {
        ...
        [DataMember]
        public PayerAlternativeInfo alt { get; set; }
    ...
    [DataContract()]
    public class PayerAlternativeInfo
    {
        [DataMember()]
        public List<AlternativeDrug> AlternativeList { get; set; }

        [DataMember()]
        public Boolean IsAltFileAvailable { get; set; }

        public PayerAlternativeInfo()
        {
            this.AlternativeList = new List<AlternativeDrug>();
            this.IsAltFileAvailable = false;
        }
    }
    ...
    public class AlternativeDrug
    {
        ...
        //[DataMember()]
        //public string cp { get; set; }//Abbreviated Copay      
    }

    public class AlternativeDrugDetails : AlternativeDrug
    {
