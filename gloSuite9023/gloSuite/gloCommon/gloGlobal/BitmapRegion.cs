...
namespace gloGlobal
{
    ...
    public class BitmapRegion
    {
        ...
        private static bool bInRecursion = false;
        /// <summary>
        ...
        public static void CreateControlRegion(Control control, Bitmap bitmap)
        {
            ...
            if (control is System.Windows.Forms.Form)
            {
                ...
                //form.Width += 15;
                //form.Height += 35;
                //form.Size = new Size(bitmap.Width + 15, bitmap.Height + 35);
                // No border
                ...
                if (newRegion == null)
                {
                    ...
                    newRegion = new Region(graphicsPath);
                }
                // Apply new region
